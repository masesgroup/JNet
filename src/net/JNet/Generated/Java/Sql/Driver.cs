...
namespace Java.Sql
{
    #region IDriver
    /// <summary>
    /// .NET interface for <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/java/sql/Driver.html"/>
    /// </summary>
    public partial interface IDriver
    {
        ...
        /// <exception cref="Java.Sql.SQLException"/>
        Java.Sql.Connection Connect(string arg0, Java.Util.Properties arg1);
        /// <summary>
        ...
        /// <exception cref="Java.Sql.SQLException"/>
        Java.Sql.DriverPropertyInfo[] GetPropertyInfo(string arg0, Java.Util.Properties arg1);
