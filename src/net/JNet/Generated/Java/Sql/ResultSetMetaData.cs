...
namespace Java.Sql
{
    ...
    public partial class ResultSetMetaData : Java.Sql.Wrapper
    {
        ...
        public ResultSetMetaData(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/java/sql/ResultSetMetaData.html"/>
    /// </summary>
