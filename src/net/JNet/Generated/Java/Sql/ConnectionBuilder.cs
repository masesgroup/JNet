...
namespace Java.Sql
{
    ...
    public partial class ConnectionBuilder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ConnectionBuilder>
    {
        ...
        public ConnectionBuilder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/java/sql/ConnectionBuilder.html"/>
    /// </summary>
