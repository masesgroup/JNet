...
namespace Java.Sql
{
    ...
    public partial class ParameterMetaData : Java.Sql.Wrapper
    {
        ...
        public ParameterMetaData(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/java/sql/ParameterMetaData.html"/>
    /// </summary>
