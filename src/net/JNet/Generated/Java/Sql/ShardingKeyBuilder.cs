...
namespace Java.Sql
{
    ...
    public partial class ShardingKeyBuilder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ShardingKeyBuilder>
    {
        ...
        public ShardingKeyBuilder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/java/sql/ShardingKeyBuilder.html"/>
    /// </summary>
