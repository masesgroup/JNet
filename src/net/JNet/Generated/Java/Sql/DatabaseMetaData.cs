...
namespace Java.Sql
{
    ...
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/java/sql/DatabaseMetaData.html"/>
    /// </summary>
