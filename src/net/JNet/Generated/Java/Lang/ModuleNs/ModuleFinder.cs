...
namespace Java.Lang.ModuleNs
{
    ...
    public partial class ModuleFinder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ModuleFinder>
    {
        ...
        public ModuleFinder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    public partial class ModuleFinder : Java.Lang.ModuleNs.IModuleFinder
    {
        ...
        {
            return SExecuteWithSignature<Java.Lang.ModuleNs.ModuleFinder>(LocalBridgeClazz, "compose", "([Ljava/lang/module/ModuleFinder;)Ljava/lang/module/ModuleFinder;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
        ...
        {
            return SExecuteWithSignature<Java.Lang.ModuleNs.ModuleFinder>(LocalBridgeClazz, "of", "([Ljava/nio/file/Path;)Ljava/lang/module/ModuleFinder;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
