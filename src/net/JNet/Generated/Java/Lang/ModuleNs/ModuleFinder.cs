...
namespace Java.Lang.ModuleNs
{
    ...
    public partial class ModuleFinder
    {
        ...
        {
            if (arg0.Length == 0) return SExecute<Java.Lang.ModuleNs.ModuleFinder>("compose", new object[] { arg0 }); else return SExecute<Java.Lang.ModuleNs.ModuleFinder>("compose", new object[] { arg0 }, arg0);
        }
        /// <summary>
        ...
        {
            if (arg0.Length == 0) return SExecute<Java.Lang.ModuleNs.ModuleFinder>("of", new object[] { arg0 }); else return SExecute<Java.Lang.ModuleNs.ModuleFinder>("of", new object[] { arg0 }, arg0);
        }
