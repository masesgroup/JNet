...
namespace Java.Lang.ModuleNs
{
    ...
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/module/ModuleReader.html"/>
    /// </summary>
