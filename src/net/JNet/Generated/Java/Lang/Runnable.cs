...
namespace Java.Lang
{
    ...
    public partial class Runnable : Java.Lang.IRunnable
    {
        ...
        {
            _RunEventHandlerIndex = AddEventHandler("run", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(RunEventHandler));
        ...
        void RunEventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
