...
namespace Java.Lang
{
    ...
    public partial class Runnable : Java.Lang.IRunnable
    {
        ...
        {
            _RunEventHandlerIndex = AddEventHandler("run", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(RunEventHandler));
