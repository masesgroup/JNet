...
namespace Java.Lang.Management
{
    ...
    public partial class MemoryNotificationInfo
    {
        ...
        /// </summary>
        public static string MEMORY_COLLECTION_THRESHOLD_EXCEEDED { get { if (!_MEMORY_COLLECTION_THRESHOLD_EXCEEDEDReady) { _MEMORY_COLLECTION_THRESHOLD_EXCEEDEDContent = SGetField<string>(LocalBridgeClazz, "MEMORY_COLLECTION_THRESHOLD_EXCEEDED"); _MEMORY_COLLECTION_THRESHOLD_EXCEEDEDReady = true; } return _MEMORY_COLLECTION_THRESHOLD_EXCEEDEDContent; } }
        ...
        /// </summary>
        public static string MEMORY_THRESHOLD_EXCEEDED { get { if (!_MEMORY_THRESHOLD_EXCEEDEDReady) { _MEMORY_THRESHOLD_EXCEEDEDContent = SGetField<string>(LocalBridgeClazz, "MEMORY_THRESHOLD_EXCEEDED"); _MEMORY_THRESHOLD_EXCEEDEDReady = true; } return _MEMORY_THRESHOLD_EXCEEDEDContent; } }
        private static string _MEMORY_THRESHOLD_EXCEEDEDContent = default;
