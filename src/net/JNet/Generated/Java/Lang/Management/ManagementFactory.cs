...
namespace Java.Lang.Management
{
    ...
    public partial class ManagementFactory
    {
        ...
        /// </summary>
        public static string CLASS_LOADING_MXBEAN_NAME { get { if (!_CLASS_LOADING_MXBEAN_NAMEReady) { _CLASS_LOADING_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "CLASS_LOADING_MXBEAN_NAME"); _CLASS_LOADING_MXBEAN_NAMEReady = true; } return _CLASS_LOADING_MXBEAN_NAMEContent; } }
        private static string _CLASS_LOADING_MXBEAN_NAMEContent = default;
        ...
        /// </summary>
        public static string COMPILATION_MXBEAN_NAME { get { if (!_COMPILATION_MXBEAN_NAMEReady) { _COMPILATION_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "COMPILATION_MXBEAN_NAME"); _COMPILATION_MXBEAN_NAMEReady = true; } return _COMPILATION_MXBEAN_NAMEContent; } }
        private static string _COMPILATION_MXBEAN_NAMEContent = default;
        ...
        /// </summary>
        public static string GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPE { get { if (!_GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPEReady) { _GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPEContent = SGetField<string>(LocalBridgeClazz, "GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPE"); _GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPEReady = true; } return _GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPEContent; } }
        private static string _GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPEContent = default;
        ...
        /// </summary>
        public static string MEMORY_MANAGER_MXBEAN_DOMAIN_TYPE { get { if (!_MEMORY_MANAGER_MXBEAN_DOMAIN_TYPEReady) { _MEMORY_MANAGER_MXBEAN_DOMAIN_TYPEContent = SGetField<string>(LocalBridgeClazz, "MEMORY_MANAGER_MXBEAN_DOMAIN_TYPE"); _MEMORY_MANAGER_MXBEAN_DOMAIN_TYPEReady = true; } return _MEMORY_MANAGER_MXBEAN_DOMAIN_TYPEContent; } }
        private static string _MEMORY_MANAGER_MXBEAN_DOMAIN_TYPEContent = default;
        ...
        /// </summary>
        public static string MEMORY_MXBEAN_NAME { get { if (!_MEMORY_MXBEAN_NAMEReady) { _MEMORY_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "MEMORY_MXBEAN_NAME"); _MEMORY_MXBEAN_NAMEReady = true; } return _MEMORY_MXBEAN_NAMEContent; } }
        private static string _MEMORY_MXBEAN_NAMEContent = default;
        ...
        /// </summary>
        public static string MEMORY_POOL_MXBEAN_DOMAIN_TYPE { get { if (!_MEMORY_POOL_MXBEAN_DOMAIN_TYPEReady) { _MEMORY_POOL_MXBEAN_DOMAIN_TYPEContent = SGetField<string>(LocalBridgeClazz, "MEMORY_POOL_MXBEAN_DOMAIN_TYPE"); _MEMORY_POOL_MXBEAN_DOMAIN_TYPEReady = true; } return _MEMORY_POOL_MXBEAN_DOMAIN_TYPEContent; } }
        private static string _MEMORY_POOL_MXBEAN_DOMAIN_TYPEContent = default;
        ...
        /// </summary>
        public static string OPERATING_SYSTEM_MXBEAN_NAME { get { if (!_OPERATING_SYSTEM_MXBEAN_NAMEReady) { _OPERATING_SYSTEM_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "OPERATING_SYSTEM_MXBEAN_NAME"); _OPERATING_SYSTEM_MXBEAN_NAMEReady = true; } return _OPERATING_SYSTEM_MXBEAN_NAMEContent; } }
        private static string _OPERATING_SYSTEM_MXBEAN_NAMEContent = default;
        ...
        /// </summary>
        public static string RUNTIME_MXBEAN_NAME { get { if (!_RUNTIME_MXBEAN_NAMEReady) { _RUNTIME_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "RUNTIME_MXBEAN_NAME"); _RUNTIME_MXBEAN_NAMEReady = true; } return _RUNTIME_MXBEAN_NAMEContent; } }
        private static string _RUNTIME_MXBEAN_NAMEContent = default;
        ...
        /// </summary>
        public static string THREAD_MXBEAN_NAME { get { if (!_THREAD_MXBEAN_NAMEReady) { _THREAD_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "THREAD_MXBEAN_NAME"); _THREAD_MXBEAN_NAMEReady = true; } return _THREAD_MXBEAN_NAMEContent; } }
        private static string _THREAD_MXBEAN_NAMEContent = default;
