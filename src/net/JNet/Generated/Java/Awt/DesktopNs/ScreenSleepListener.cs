...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class ScreenSleepListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("ScreenSleepListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public ScreenSleepListener(params object[] args) { }
