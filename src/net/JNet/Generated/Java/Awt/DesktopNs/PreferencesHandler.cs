...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class PreferencesHandler : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PreferencesHandler>
    {
        ...
        public PreferencesHandler(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/desktop/PreferencesHandler.html"/>
    /// </summary>
