...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class PrintFilesHandler : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PrintFilesHandler>
    {
        ...
        public PrintFilesHandler(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/desktop/PrintFilesHandler.html"/>
    /// </summary>
