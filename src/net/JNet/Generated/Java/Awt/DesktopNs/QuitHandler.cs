...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class QuitHandler : MASES.JCOBridge.C2JBridge.JVMBridgeBase<QuitHandler>
    {
        ...
        public QuitHandler(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region IQuitHandler
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/desktop/QuitHandler.html"/>
    /// </summary>
