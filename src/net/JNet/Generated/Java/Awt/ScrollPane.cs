...
namespace Java.Awt
{
    ...
    public partial class ScrollPane
    {
        ...
        /// </summary>
        public static int SCROLLBARS_ALWAYS => LocalClazz.GetField<int>("SCROLLBARS_ALWAYS");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/ScrollPane.html#SCROLLBARS_AS_NEEDED"/>
        /// </summary>
        public static int SCROLLBARS_AS_NEEDED => LocalClazz.GetField<int>("SCROLLBARS_AS_NEEDED");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/ScrollPane.html#SCROLLBARS_NEVER"/>
        /// </summary>
        public static int SCROLLBARS_NEVER => LocalClazz.GetField<int>("SCROLLBARS_NEVER");
