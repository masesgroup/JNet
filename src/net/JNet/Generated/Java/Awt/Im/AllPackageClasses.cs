...
namespace Java.Awt.Im
{
    ...
    public partial class InputMethodRequests : MASES.JCOBridge.C2JBridge.JVMBridgeBase<InputMethodRequests>
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("InputMethodRequests class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
