...
namespace Java.Awt.Datatransfer
{
    ...
    #region IFlavorMap
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.datatransfer/java/awt/datatransfer/FlavorMap.html"/>
    /// </summary>
    public partial interface IFlavorMap
    {
        ...
        Java.Util.Map<, > GetNativesForFlavors(Java.Awt.Datatransfer.DataFlavor[] arg0);
        /// <summary>
        ...
        /// <param name="arg0"><see cref=""/></param>
        /// <returns><see cref=""/></returns>
        Java.Util.Map<, > GetFlavorsForNatives(Java.Lang.String[] arg0);
    ...
    public partial class FlavorMap : Java.Awt.Datatransfer.IFlavorMap
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Map<, >>("getNativesForFlavors", "([Ljava/awt/datatransfer/DataFlavor;)Ljava/util/Map;", new object[] { arg0 });
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.datatransfer/java/awt/datatransfer/FlavorMap.html#getFlavorsForNatives(java.lang.String[])"/>
        /// </summary>
        /// <param name="arg0"><see cref=""/></param>
        /// <returns><see cref=""/></returns>
        public Java.Util.Map<, > GetFlavorsForNatives(Java.Lang.String[] arg0)
        {
            return IExecuteWithSignature<Java.Util.Map<, >>("getFlavorsForNatives", "([Ljava/lang/String;)Ljava/util/Map;", new object[] { arg0 });
        }
