...
namespace Java.Awt.Datatransfer
{
    ...
    public partial class FlavorListener : Java.Util.EventListener
    {
        ...
        public FlavorListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasFlavorListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public FlavorListener(params object[] args) : base(args)
        {
            ...
            _hasFlavorListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class FlavorListener : Java.Awt.Datatransfer.IFlavorListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideFlavorsChanged = GetMethodIsOverridden(listenerRuntimeType, nameof(FlavorsChanged), typeof(Java.Awt.Datatransfer.FlavorEvent));
        ...
        {
            if (!FlavorsChangedEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
            {
            ...
            data.EventData.TypedEventData.HasOverride = _hasOverrideFlavorsChanged;
        }
