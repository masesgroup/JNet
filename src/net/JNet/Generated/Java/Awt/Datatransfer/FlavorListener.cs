...
namespace Java.Awt.Datatransfer
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/datatransfer/FlavorListener.html"/>
    /// </summary>
    public partial class FlavorListener : Java.Util.EventListener
    {
        ...
        public FlavorListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public FlavorListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasFlavorListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasFlavorListenerSecondGate;
        ...
        /// <item><see cref="_hasFlavorListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasFlavorListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="FlavorListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="FlavorListener"/> instead.</para>
    /// </remarks>
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.java.awt.datatransfer.FlavorListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/datatransfer/FlavorListener.html"/>
    /// </summary>
    public partial interface IFlavorListener
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/datatransfer/FlavorListener.html#flavorsChanged-java.awt.datatransfer.FlavorEvent-"/>
        /// </summary>
    ...
    public partial class FlavorListener : Java.Awt.Datatransfer.IFlavorListener
    {
        ...
        {
            _FlavorsChangedEventHandlerIndex = AddEventHandler("flavorsChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(FlavorsChangedEventHandler));
            _hasOverrideFlavorsChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(FlavorsChanged), typeof(Java.Awt.Datatransfer.FlavorEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _FlavorsChangedEventHandlerIndex) return FlavorsChangedEventOverridden();

            return false; // no one can manage event, continues to caller
        }

        /// <summary>
        /// Handler for <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/datatransfer/FlavorListener.html#flavorsChanged-java.awt.datatransfer.FlavorEvent-"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="FlavorsChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _FlavorsChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="FlavorsChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideFlavorsChanged;
        ...
        bool FlavorsChangedEventOverridden() => _hasOverrideFlavorsChanged || OnFlavorsChanged != null;

        void FlavorsChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!FlavorsChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = FlavorsChangedEventOverridden();
        }
