...
namespace Java.Awt.Geom
{
    ...
    public partial class AffineTransform
    {
        ...
        /// </summary>
        public static int TYPE_FLIP => LocalClazz.GetField<int>("TYPE_FLIP");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_GENERAL_ROTATION => LocalClazz.GetField<int>("TYPE_GENERAL_ROTATION");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_GENERAL_SCALE => LocalClazz.GetField<int>("TYPE_GENERAL_SCALE");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_GENERAL_TRANSFORM => LocalClazz.GetField<int>("TYPE_GENERAL_TRANSFORM");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/geom/AffineTransform.html#TYPE_IDENTITY"/>
        /// </summary>
        public static int TYPE_IDENTITY => LocalClazz.GetField<int>("TYPE_IDENTITY");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_MASK_ROTATION => LocalClazz.GetField<int>("TYPE_MASK_ROTATION");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_MASK_SCALE => LocalClazz.GetField<int>("TYPE_MASK_SCALE");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_QUADRANT_ROTATION => LocalClazz.GetField<int>("TYPE_QUADRANT_ROTATION");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_TRANSLATION => LocalClazz.GetField<int>("TYPE_TRANSLATION");
        /// <summary>
        ...
        /// </summary>
        public static int TYPE_UNIFORM_SCALE => LocalClazz.GetField<int>("TYPE_UNIFORM_SCALE");
