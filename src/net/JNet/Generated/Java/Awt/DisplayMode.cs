...
namespace Java.Awt
{
    ...
    public partial class DisplayMode
    {
        ...
        /// </summary>
        public static int BIT_DEPTH_MULTI { get { return SGetField<int>(LocalClazz, "BIT_DEPTH_MULTI"); } }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/DisplayMode.html#REFRESH_RATE_UNKNOWN"/>
        /// </summary>
        public static int REFRESH_RATE_UNKNOWN { get { return SGetField<int>(LocalClazz, "REFRESH_RATE_UNKNOWN"); } }
