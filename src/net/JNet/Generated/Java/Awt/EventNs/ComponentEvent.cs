...
namespace Java.Awt.EventNs
{
    ...
    public partial class ComponentEvent
    {
        ...
        /// </summary>
        public static int COMPONENT_FIRST => LocalClazz.GetField<int>("COMPONENT_FIRST");
        /// <summary>
        ...
        /// </summary>
        public static int COMPONENT_HIDDEN => LocalClazz.GetField<int>("COMPONENT_HIDDEN");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/event/ComponentEvent.html#COMPONENT_LAST"/>
        /// </summary>
        public static int COMPONENT_LAST => LocalClazz.GetField<int>("COMPONENT_LAST");
        /// <summary>
        ...
        /// </summary>
        public static int COMPONENT_MOVED => LocalClazz.GetField<int>("COMPONENT_MOVED");
        /// <summary>
        ...
        /// </summary>
        public static int COMPONENT_RESIZED => LocalClazz.GetField<int>("COMPONENT_RESIZED");
        /// <summary>
        ...
        /// </summary>
        public static int COMPONENT_SHOWN => LocalClazz.GetField<int>("COMPONENT_SHOWN");
