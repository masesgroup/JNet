...
namespace Java.Awt.EventNs
{
    ...
    public partial class HierarchyBoundsListener : Java.Util.EventListener
    {
        ...
        /// <item><see cref="_hasHierarchyBoundsListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasHierarchyBoundsListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="HierarchyBoundsListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="HierarchyBoundsListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class HierarchyBoundsListener : Java.Awt.EventNs.IHierarchyBoundsListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _AncestorResizedEventHandlerIndex = AddEventHandler("ancestorResized", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(AncestorResizedEventHandler));
        ...
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            ...
            if (eventIndex == _AncestorResizedEventHandlerIndex) return AncestorResizedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="AncestorResized"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _AncestorResizedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="AncestorResized"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void AncestorResizedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!AncestorResizedEventOverridden()) // guard: no handler registered — return without reading data.
                                                                                  // Normally unreachable if ListenerShallManageEvent filtered correctly,
                                                                                  // but protects against user overrides of ListenerShallManageEvent that bypass the check.
            {
                // data.EventData.TypedEventData.HasOverride is false by default — JVM receives no return value.
