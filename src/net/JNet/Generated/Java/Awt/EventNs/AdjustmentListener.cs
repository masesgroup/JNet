...
namespace Java.Awt.EventNs
{
    ...
    public partial class AdjustmentListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public AdjustmentListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasAdjustmentListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasAdjustmentListenerSecondGate;
        ...
        /// <item><see cref="_hasAdjustmentListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasAdjustmentListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="AdjustmentListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="AdjustmentListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class AdjustmentListener : Java.Awt.EventNs.IAdjustmentListener
    {
        ...
        {
            _AdjustmentValueChangedEventHandlerIndex = AddEventHandler("adjustmentValueChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(AdjustmentValueChangedEventHandler));
            _hasOverrideAdjustmentValueChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(AdjustmentValueChanged), typeof(Java.Awt.EventNs.AdjustmentEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _AdjustmentValueChangedEventHandlerIndex) return AdjustmentValueChangedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="AdjustmentValueChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _AdjustmentValueChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="AdjustmentValueChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideAdjustmentValueChanged;
        ...
        void AdjustmentValueChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!AdjustmentValueChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = AdjustmentValueChangedEventOverridden();
        }
