...
namespace Java.Awt.EventNs
{
    ...
    public partial class HierarchyListener : Java.Util.EventListener
    {
        ...
        public HierarchyListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public HierarchyListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasHierarchyListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasHierarchyListenerSecondGate;
        ...
        /// <item><see cref="_hasHierarchyListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasHierarchyListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="HierarchyListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="HierarchyListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class HierarchyListener : Java.Awt.EventNs.IHierarchyListener
    {
        ...
        {
            _HierarchyChangedEventHandlerIndex = AddEventHandler("hierarchyChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(HierarchyChangedEventHandler));
            _hasOverrideHierarchyChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(HierarchyChanged), typeof(Java.Awt.EventNs.HierarchyEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _HierarchyChangedEventHandlerIndex) return HierarchyChangedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="HierarchyChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _HierarchyChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="HierarchyChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideHierarchyChanged;
        ...
        void HierarchyChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!HierarchyChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = HierarchyChangedEventOverridden();
        }
