...
namespace Java.Awt.EventNs
{
    ...
    public partial class MouseWheelListener : Java.Util.EventListener
    {
        ...
        /// <item><see cref="_hasMouseWheelListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        /// </list>
        /// </remarks>
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="MouseWheelListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="MouseWheelListener"/> instead.</para>
    /// </remarks>
