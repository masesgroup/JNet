...
namespace Java.Awt.EventNs
{
    ...
    public partial class FocusListener : Java.Util.EventListener
    {
        ...
        public FocusListener(IJVMBridgeBaseInitializer initializer) : base(initializer)
        {
            ...
            _hasFocusListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        }
        ...
        /// <item><see cref="_hasFocusListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        /// </list>
        /// </remarks>
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="FocusListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="FocusListener"/> instead.</para>
    /// </remarks>
