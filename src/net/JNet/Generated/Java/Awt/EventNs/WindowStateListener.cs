...
namespace Java.Awt.EventNs
{
    ...
    public partial class WindowStateListener : Java.Util.EventListener
    {
        ...
        public WindowStateListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasWindowStateListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public WindowStateListener(params object[] args) : base(args)
        {
            ...
            _hasWindowStateListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
