...
namespace Java.Awt.EventNs
{
    ...
    public partial class TextListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public TextListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasTextListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasTextListenerSecondGate;
        ...
        /// <item><see cref="_hasTextListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasTextListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="TextListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="TextListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class TextListener : Java.Awt.EventNs.ITextListener
    {
        ...
        {
            _TextValueChangedEventHandlerIndex = AddEventHandler("textValueChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(TextValueChangedEventHandler));
            _hasOverrideTextValueChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(TextValueChanged), typeof(Java.Awt.EventNs.TextEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _TextValueChangedEventHandlerIndex) return TextValueChangedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="TextValueChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _TextValueChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="TextValueChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideTextValueChanged;
        ...
        void TextValueChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!TextValueChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = TextValueChangedEventOverridden();
        }
