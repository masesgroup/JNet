...
namespace Java.Awt.EventNs
{
    ...
    public partial class WindowFocusListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public WindowFocusListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasWindowFocusListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasWindowFocusListenerSecondGate;
        ...
        /// <item><see cref="_hasWindowFocusListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasWindowFocusListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="WindowFocusListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="WindowFocusListener"/> instead.</para>
    /// </remarks>
