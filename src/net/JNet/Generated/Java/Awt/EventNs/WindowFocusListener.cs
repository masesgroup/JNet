...
namespace Java.Awt.EventNs
{
    ...
    public partial class WindowFocusListener : Java.Util.EventListener
    {
        ...
        public WindowFocusListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasWindowFocusListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public WindowFocusListener(params object[] args) : base(args)
        {
            ...
            _hasWindowFocusListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
