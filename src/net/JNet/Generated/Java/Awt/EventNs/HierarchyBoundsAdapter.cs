...
namespace Java.Awt.EventNs
{
    ...
    public partial class HierarchyBoundsAdapter : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public HierarchyBoundsAdapter(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public HierarchyBoundsAdapter(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasHierarchyBoundsAdapterSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasHierarchyBoundsAdapterSecondGate;
        ...
        /// <item><see cref="_hasHierarchyBoundsAdapterSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasHierarchyBoundsAdapterSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="HierarchyBoundsAdapter"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="HierarchyBoundsAdapter"/> instead.</para>
    /// </remarks>
    ...
    public partial class HierarchyBoundsAdapter
    {
        ...
        /// </summary>
        public HierarchyBoundsAdapter() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
