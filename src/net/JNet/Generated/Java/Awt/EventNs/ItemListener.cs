...
namespace Java.Awt.EventNs
{
    ...
    public partial class ItemListener : Java.Util.EventListener
    {
        ...
        /// <item><see cref="_hasItemListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasItemListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ItemListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ItemListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class ItemListener : Java.Awt.EventNs.IItemListener
    {
        ...
        {
            _ItemStateChangedEventHandlerIndex = AddEventHandler("itemStateChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ItemStateChangedEventHandler));
        ...
        {
            if (eventIndex == _ItemStateChangedEventHandlerIndex) return ItemStateChangedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="ItemStateChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _ItemStateChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="ItemStateChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void ItemStateChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!ItemStateChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = ItemStateChangedEventOverridden();
        }
