...
namespace Java.Awt.EventNs
{
    ...
    public partial class ContainerAdapter : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ContainerAdapter(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasContainerAdapterSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public ContainerAdapter(params object[] args) : base(args)
        {
            ...
            _hasContainerAdapterSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
