...
namespace Java.Awt.Dnd
{
    ...
    public partial class DragSourceMotionListener : Java.Util.EventListener
    {
        ...
        global::System.Type _DragSourceMotionListenerRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _DragSourceMotionListenerRuntimeType ?? GetType();
            var method = _DragSourceMotionListenerRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasDragSourceMotionListenerSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
