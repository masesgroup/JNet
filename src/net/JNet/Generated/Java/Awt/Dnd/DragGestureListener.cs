...
namespace Java.Awt.Dnd
{
    ...
    public partial class DragGestureListener : Java.Util.EventListener
    {
        ...
        public DragGestureListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasDragGestureListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public DragGestureListener(params object[] args) : base(args)
        {
            ...
            _hasDragGestureListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class DragGestureListener : Java.Awt.Dnd.IDragGestureListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideDragGestureRecognized = GetMethodIsOverridden(listenerRuntimeType, nameof(DragGestureRecognized), typeof(Java.Awt.Dnd.DragGestureEvent));
        ...
        {
            if (!DragGestureRecognizedEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
            {
            ...
            data.EventData.TypedEventData.HasOverride = _hasOverrideDragGestureRecognized;
        }
