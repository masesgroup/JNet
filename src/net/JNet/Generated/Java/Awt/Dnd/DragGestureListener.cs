...
namespace Java.Awt.Dnd
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/dnd/DragGestureListener.html"/>
    /// </summary>
    public partial class DragGestureListener : Java.Util.EventListener
    {
        ...
        public DragGestureListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public DragGestureListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasDragGestureListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasDragGestureListenerSecondGate;
        ...
        /// <item><see cref="_hasDragGestureListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDragGestureListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DragGestureListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DragGestureListener"/> instead.</para>
    /// </remarks>
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.java.awt.dnd.DragGestureListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/dnd/DragGestureListener.html"/>
    /// </summary>
    public partial interface IDragGestureListener
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/dnd/DragGestureListener.html#dragGestureRecognized-java.awt.dnd.DragGestureEvent-"/>
        /// </summary>
    ...
    public partial class DragGestureListener : Java.Awt.Dnd.IDragGestureListener
    {
        ...
        {
            _DragGestureRecognizedEventHandlerIndex = AddEventHandler("dragGestureRecognized", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(DragGestureRecognizedEventHandler));
            _hasOverrideDragGestureRecognized = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(DragGestureRecognized), typeof(Java.Awt.Dnd.DragGestureEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _DragGestureRecognizedEventHandlerIndex) return DragGestureRecognizedEventOverridden();

            return false; // no one can manage event, continues to caller
        }

        /// <summary>
        /// Handler for <see href="https://docs.oracle.com/javase/8/docs/api/java/awt/dnd/DragGestureListener.html#dragGestureRecognized-java.awt.dnd.DragGestureEvent-"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="DragGestureRecognized"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _DragGestureRecognizedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="DragGestureRecognized"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideDragGestureRecognized;
        ...
        bool DragGestureRecognizedEventOverridden() => _hasOverrideDragGestureRecognized || OnDragGestureRecognized != null;

        void DragGestureRecognizedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!DragGestureRecognizedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = DragGestureRecognizedEventOverridden();
        }
