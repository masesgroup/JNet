...
namespace Java.Awt
{
    ...
    public partial class BorderLayout
    {
        ...
        /// </summary>
        public static string AFTER_LAST_LINE { get { if (!_AFTER_LAST_LINEReady) { _AFTER_LAST_LINEContent = SGetField<string>(LocalBridgeClazz, "AFTER_LAST_LINE"); _AFTER_LAST_LINEReady = true; } return _AFTER_LAST_LINEContent; } }
        ...
        /// </summary>
        public static string AFTER_LINE_ENDS { get { if (!_AFTER_LINE_ENDSReady) { _AFTER_LINE_ENDSContent = SGetField<string>(LocalBridgeClazz, "AFTER_LINE_ENDS"); _AFTER_LINE_ENDSReady = true; } return _AFTER_LINE_ENDSContent; } }
        ...
        /// </summary>
        public static string BEFORE_FIRST_LINE { get { if (!_BEFORE_FIRST_LINEReady) { _BEFORE_FIRST_LINEContent = SGetField<string>(LocalBridgeClazz, "BEFORE_FIRST_LINE"); _BEFORE_FIRST_LINEReady = true; } return _BEFORE_FIRST_LINEContent; } }
        ...
        /// </summary>
        public static string BEFORE_LINE_BEGINS { get { if (!_BEFORE_LINE_BEGINSReady) { _BEFORE_LINE_BEGINSContent = SGetField<string>(LocalBridgeClazz, "BEFORE_LINE_BEGINS"); _BEFORE_LINE_BEGINSReady = true; } return _BEFORE_LINE_BEGINSContent; } }
        ...
        /// </summary>
        public static string CENTER { get { if (!_CENTERReady) { _CENTERContent = SGetField<string>(LocalBridgeClazz, "CENTER"); _CENTERReady = true; } return _CENTERContent; } }
        ...
        /// </summary>
        public static string LINE_END { get { if (!_LINE_ENDReady) { _LINE_ENDContent = SGetField<string>(LocalBridgeClazz, "LINE_END"); _LINE_ENDReady = true; } return _LINE_ENDContent; } }
        ...
        /// </summary>
        public static string LINE_START { get { if (!_LINE_STARTReady) { _LINE_STARTContent = SGetField<string>(LocalBridgeClazz, "LINE_START"); _LINE_STARTReady = true; } return _LINE_STARTContent; } }
        ...
        /// </summary>
        public static string PAGE_END { get { if (!_PAGE_ENDReady) { _PAGE_ENDContent = SGetField<string>(LocalBridgeClazz, "PAGE_END"); _PAGE_ENDReady = true; } return _PAGE_ENDContent; } }
        ...
        /// </summary>
        public static string PAGE_START { get { if (!_PAGE_STARTReady) { _PAGE_STARTContent = SGetField<string>(LocalBridgeClazz, "PAGE_START"); _PAGE_STARTReady = true; } return _PAGE_STARTContent; } }
