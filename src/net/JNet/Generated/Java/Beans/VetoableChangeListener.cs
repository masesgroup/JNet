...
namespace Java.Beans
{
    ...
    public partial class VetoableChangeListener : Java.Util.EventListener
    {
        ...
        public VetoableChangeListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public VetoableChangeListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasVetoableChangeListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasVetoableChangeListenerSecondGate;
        ...
        /// <item><see cref="_hasVetoableChangeListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasVetoableChangeListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="VetoableChangeListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="VetoableChangeListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class VetoableChangeListener : Java.Beans.IVetoableChangeListener
    {
        ...
        {
            _VetoableChangeEventHandlerIndex = AddEventHandler("vetoableChange", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(VetoableChangeEventHandler));
            _hasOverrideVetoableChange = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(VetoableChange), typeof(Java.Beans.PropertyChangeEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _VetoableChangeEventHandlerIndex) return VetoableChangeEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="VetoableChange"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _VetoableChangeEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="VetoableChange"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideVetoableChange;
        ...
        void VetoableChangeEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!VetoableChangeEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = VetoableChangeEventOverridden();
        }
