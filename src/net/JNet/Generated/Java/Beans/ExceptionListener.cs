...
namespace Java.Beans
{
    ...
    public partial class ExceptionListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ExceptionListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); }
        /// <summary>
        /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
        /// </summary>
        public ExceptionListener(params object[] args) : base(args) { InitializeHandlers(); _ListenerRuntimeType = GetType(); }
        ...
        bool _hasExceptionListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        /// <inheritdoc/>
    ...
    public partial class ExceptionListener : Java.Beans.IExceptionListener
    {
        ...
        bool _hasOverrideExceptionThrown = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ExceptionThrown), typeof(MASES.JCOBridge.C2JBridge.JVMBridgeException));
