...
namespace Java.Beans
{
    ...
    public partial class ExceptionListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ExceptionListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public ExceptionListener(params object[] args) : base(args)
        {
            ...
            _hasExceptionListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// <item><see cref="_hasExceptionListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasExceptionListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ExceptionListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ExceptionListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class ExceptionListener : Java.Beans.IExceptionListener
    {
        ...
        {
            _ExceptionThrownEventHandlerIndex = AddEventHandler("exceptionThrown", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ExceptionThrownEventHandler));
            _hasOverrideExceptionThrown = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ExceptionThrown), typeof(MASES.JCOBridge.C2JBridge.JVMBridgeException));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _ExceptionThrownEventHandlerIndex) return ExceptionThrownEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="ExceptionThrown"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _ExceptionThrownEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="ExceptionThrown"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void ExceptionThrownEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!ExceptionThrownEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = ExceptionThrownEventOverridden();
        }
