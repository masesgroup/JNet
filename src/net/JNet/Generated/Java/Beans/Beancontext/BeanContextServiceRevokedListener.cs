...
namespace Java.Beans.Beancontext
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/java/beans/beancontext/BeanContextServiceRevokedListener.html"/>
    /// </summary>
    public partial class BeanContextServiceRevokedListener : Java.Util.EventListener
    {
        ...
        public BeanContextServiceRevokedListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public BeanContextServiceRevokedListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasBeanContextServiceRevokedListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasBeanContextServiceRevokedListenerSecondGate;
        ...
        /// <item><see cref="_hasBeanContextServiceRevokedListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasBeanContextServiceRevokedListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="BeanContextServiceRevokedListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="BeanContextServiceRevokedListener"/> instead.</para>
    /// </remarks>
    public partial class BeanContextServiceRevokedListenerDirect : BeanContextServiceRevokedListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public BeanContextServiceRevokedListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public BeanContextServiceRevokedListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.java.beans.beancontext.BeanContextServiceRevokedListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/java/beans/beancontext/BeanContextServiceRevokedListener.html"/>
    /// </summary>
    ...
    public partial class BeanContextServiceRevokedListener : Java.Beans.Beancontext.IBeanContextServiceRevokedListener
    {
        ...
        {
            _ServiceRevokedEventHandlerIndex = AddEventHandler("serviceRevoked", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ServiceRevokedEventHandler));
        ...
        void ServiceRevokedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.HasOverride = ServiceRevokedEventOverridden();
        }
