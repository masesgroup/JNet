...
namespace Java.Io
{
    ...
    public partial class File
    {
        ...
        /// </summary>
        public static string pathSeparator { get { if (!_pathSeparatorReady) { _pathSeparatorContent = SGetField<string>(LocalBridgeClazz, "pathSeparator"); _pathSeparatorReady = true; } return _pathSeparatorContent; } }
        private static string _pathSeparatorContent = default;
        ...
        /// </summary>
        public static string separator { get { if (!_separatorReady) { _separatorContent = SGetField<string>(LocalBridgeClazz, "separator"); _separatorReady = true; } return _separatorContent; } }
        private static string _separatorContent = default;
