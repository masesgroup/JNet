...
namespace Java.Net
{
    ...
    public partial class URLConnection
    {
        ...
        {
            get { return IExecuteWithSignature<Java.Util.Map<, >>("getHeaderFields", "()Ljava/util/Map;"); }
        }
        /// <summary>
        ...
        {
            get { return IExecuteWithSignature<Java.Util.Map<, >>("getRequestProperties", "()Ljava/util/Map;"); }
        }
        /// <summary>
