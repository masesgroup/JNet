...
namespace Java.Net.Http
{
    ...
    public partial class HttpRequest : MASES.JCOBridge.C2JBridge.JVMBridgeBase<HttpRequest>
    {
        ...
        public HttpRequest(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
        ...
        public partial class BodyPublisher : Java.Util.Concurrent.Flow.Publisher
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public BodyPublisher(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
            /// <summary>
            /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
            /// </summary>
            [global::System.Obsolete("BodyPublisher class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        ...
        public partial class BodyPublishers : MASES.JCOBridge.C2JBridge.JVMBridgeBase<BodyPublishers>
        {
            ...
            /// </summary>
            [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
            public BodyPublishers(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
            /// <summary>
            /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
            /// </summary>
    ...
    public partial class HttpRequest
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Optional>("bodyPublisher", "()Ljava/util/Optional;");
        }
        /// <summary>
        ...
        {
            return IExecuteWithSignature<Java.Util.Optional>("timeout", "()Ljava/util/Optional;");
        }
        ...
        public partial class BodyPublishers
        {
            ...
            /// <typeparam name="Arg0ExtendsJava_Nio_ByteBuffer"><see cref=""/></typeparam>
            /// <returns><see cref=""/></returns>
            public static Java.Net.Http.HttpRequest.BodyPublisher FromPublisher(Java.Util.Concurrent.Flow.Publisher arg0, long arg1) where Arg0ExtendsJava_Nio_ByteBuffer : Java.Nio.ByteBuffer
            {
            ...
            /// <typeparam name="Arg0ExtendsJava_Nio_ByteBuffer"><see cref=""/></typeparam>
            /// <returns><see cref=""/></returns>
            public static Java.Net.Http.HttpRequest.BodyPublisher FromPublisher(Java.Util.Concurrent.Flow.Publisher arg0) where Arg0ExtendsJava_Nio_ByteBuffer : Java.Nio.ByteBuffer
            {
            ...
            /// </summary>
            /// <param name="arg0"><see cref=""/></param>
            /// <typeparam name="Arg0ExtendsJava_Io_InputStream"><see cref=""/></typeparam>
            /// <returns><see cref=""/></returns>
            public static Java.Net.Http.HttpRequest.BodyPublisher OfInputStream(Java.Util.Function.Supplier arg0) where Arg0ExtendsJava_Io_InputStream : Java.Io.InputStream
            {
