...
namespace Java.Security.Interfaces
{
    ...
    #region IDSAParams
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/interfaces/DSAParams.html"/>
    /// </summary>
