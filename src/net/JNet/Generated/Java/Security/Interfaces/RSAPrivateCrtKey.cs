...
namespace Java.Security.Interfaces
{
    ...
    public partial class RSAPrivateCrtKey : Java.Security.Interfaces.RSAPrivateKey
    {
        ...
        public RSAPrivateCrtKey(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/interfaces/RSAPrivateCrtKey.html"/>
    /// </summary>
