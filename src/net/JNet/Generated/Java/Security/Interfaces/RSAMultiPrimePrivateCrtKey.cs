...
namespace Java.Security.Interfaces
{
    ...
    public partial class RSAMultiPrimePrivateCrtKey : Java.Security.Interfaces.RSAPrivateKey
    {
        ...
        public RSAMultiPrimePrivateCrtKey(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/interfaces/RSAMultiPrimePrivateCrtKey.html"/>
    /// </summary>
