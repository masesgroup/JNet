...
namespace Java.Security.Interfaces
{
    ...
    public partial class XECKey : MASES.JCOBridge.C2JBridge.JVMBridgeBase<XECKey>
    {
        ...
        public XECKey(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region IXECKey
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/interfaces/XECKey.html"/>
    /// </summary>
