...
namespace Java.Security.Spec
{
    ...
    #region IECField
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/spec/ECField.html"/>
    /// </summary>
