...
namespace Java.Security.Cert
{
    ...
    public partial class CRLReason
    {
        ...
        /// </summary>
        public static Java.Security.Cert.CRLReason AA_COMPROMISE => LocalClazz.GetField<Java.Security.Cert.CRLReason>("AA_COMPROMISE");
        /// <summary>
        ...
        /// </summary>
        public static Java.Security.Cert.CRLReason AFFILIATION_CHANGED => LocalClazz.GetField<Java.Security.Cert.CRLReason>("AFFILIATION_CHANGED");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#CA_COMPROMISE"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason CA_COMPROMISE => LocalClazz.GetField<Java.Security.Cert.CRLReason>("CA_COMPROMISE");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#CERTIFICATE_HOLD"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason CERTIFICATE_HOLD => LocalClazz.GetField<Java.Security.Cert.CRLReason>("CERTIFICATE_HOLD");
        /// <summary>
        ...
        /// </summary>
        public static Java.Security.Cert.CRLReason CESSATION_OF_OPERATION => LocalClazz.GetField<Java.Security.Cert.CRLReason>("CESSATION_OF_OPERATION");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#KEY_COMPROMISE"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason KEY_COMPROMISE => LocalClazz.GetField<Java.Security.Cert.CRLReason>("KEY_COMPROMISE");
        /// <summary>
        ...
        /// </summary>
        public static Java.Security.Cert.CRLReason PRIVILEGE_WITHDRAWN => LocalClazz.GetField<Java.Security.Cert.CRLReason>("PRIVILEGE_WITHDRAWN");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#REMOVE_FROM_CRL"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason REMOVE_FROM_CRL => LocalClazz.GetField<Java.Security.Cert.CRLReason>("REMOVE_FROM_CRL");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#SUPERSEDED"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason SUPERSEDED => LocalClazz.GetField<Java.Security.Cert.CRLReason>("SUPERSEDED");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#UNSPECIFIED"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason UNSPECIFIED => LocalClazz.GetField<Java.Security.Cert.CRLReason>("UNSPECIFIED");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/CRLReason.html#UNUSED"/>
        /// </summary>
        public static Java.Security.Cert.CRLReason UNUSED => LocalClazz.GetField<Java.Security.Cert.CRLReason>("UNUSED");
