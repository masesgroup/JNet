...
namespace Java.Security.Cert
{
    ...
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/cert/X509Extension.html"/>
    /// </summary>
