...
namespace Java.Security.Cert
{
    ...
    public partial class CertificateFactory
    {
        ...
        {
            get { return IExecuteWithSignature<Java.Util.Iterator>("getCertPathEncodings", "()Ljava/util/Iterator;"); }
        }
        /// <summary>
        ...
        /// <returns><see cref=""/></returns>
        /// <exception cref=""/>
        public Java.Security.Cert.CertPath GenerateCertPath(Java.Util.List arg0) where Arg0ExtendsJava_Security_Cert_Certificate : Java.Security.Cert.Certificate
        {
        ...
        /// <returns><see cref=""/></returns>
        /// <exception cref=""/>
        public Java.Util.Collection GenerateCertificates(Java.Io.InputStream arg0) where ReturnExtendsJava_Security_Cert_Certificate : Java.Security.Cert.Certificate
        {
            return IExecuteWithSignature<Java.Util.Collection>("generateCertificates", "(Ljava/io/InputStream;)Ljava/util/Collection;", arg0);
        }
        /// <summary>
        ...
        /// <returns><see cref=""/></returns>
        /// <exception cref=""/>
        public Java.Util.Collection GenerateCRLs(Java.Io.InputStream arg0) where ReturnExtendsJava_Security_Cert_CRL : Java.Security.Cert.CRL
        {
            return IExecuteWithSignature<Java.Util.Collection>("generateCRLs", "(Ljava/io/InputStream;)Ljava/util/Collection;", arg0);
        }
