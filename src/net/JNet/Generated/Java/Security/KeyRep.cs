...
namespace Java.Security
{
    ...
    public partial class KeyRep
    {
        ...
        public partial class Type
        {
            ...
            /// </summary>
            public static Java.Security.KeyRep.Type PRIVATE => LocalClazz.GetField<Java.Security.KeyRep.Type>("PRIVATE");
            /// <summary>
            /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/KeyRep.Type.html#PUBLIC"/>
            /// </summary>
            public static Java.Security.KeyRep.Type PUBLIC => LocalClazz.GetField<Java.Security.KeyRep.Type>("PUBLIC");
            /// <summary>
            /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/security/KeyRep.Type.html#SECRET"/>
            /// </summary>
            public static Java.Security.KeyRep.Type SECRET => LocalClazz.GetField<Java.Security.KeyRep.Type>("SECRET");
