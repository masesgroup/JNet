...
namespace Java.Security
{
    ...
    /// </summary>
    public partial class PrivilegedAction : MASES.JCOBridge.C2JBridge.JVMBridgeBaseCore<PrivilegedAction>
    {
    ...
    public partial class PrivilegedAction<T> : MASES.JCOBridge.C2JBridge.JVMBridgeBaseCore<PrivilegedAction<T>>
    {
        const string _bridgeClassName = "java.security.PrivilegedAction";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge
