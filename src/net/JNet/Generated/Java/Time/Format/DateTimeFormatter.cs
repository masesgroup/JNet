...
namespace Java.Time.Format
{
    ...
    public partial class DateTimeFormatter
    {
        ...
        {
            return IExecuteWithSignature<Java.Time.Format.DateTimeFormatter>("withResolverFields", "([Ljava/time/temporal/TemporalField;)Ljava/time/format/DateTimeFormatter;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
