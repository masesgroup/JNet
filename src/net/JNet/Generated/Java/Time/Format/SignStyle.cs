...
namespace Java.Time.Format
{
    ...
    public partial class SignStyle
    {
        ...
        /// </summary>
        public static Java.Time.Format.SignStyle ALWAYS => LocalClazz.GetField<Java.Time.Format.SignStyle>("ALWAYS");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/format/SignStyle.html#EXCEEDS_PAD"/>
        /// </summary>
        public static Java.Time.Format.SignStyle EXCEEDS_PAD => LocalClazz.GetField<Java.Time.Format.SignStyle>("EXCEEDS_PAD");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/format/SignStyle.html#NEVER"/>
        /// </summary>
        public static Java.Time.Format.SignStyle NEVER => LocalClazz.GetField<Java.Time.Format.SignStyle>("NEVER");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/format/SignStyle.html#NORMAL"/>
        /// </summary>
        public static Java.Time.Format.SignStyle NORMAL => LocalClazz.GetField<Java.Time.Format.SignStyle>("NORMAL");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/time/format/SignStyle.html#NOT_NEGATIVE"/>
        /// </summary>
        public static Java.Time.Format.SignStyle NOT_NEGATIVE => LocalClazz.GetField<Java.Time.Format.SignStyle>("NOT_NEGATIVE");
