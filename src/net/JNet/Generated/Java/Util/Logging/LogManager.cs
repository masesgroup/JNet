...
namespace Java.Util.Logging
{
    ...
    public partial class LogManager
    {
        ...
        /// </summary>
        public static string LOGGING_MXBEAN_NAME { get { if (!_LOGGING_MXBEAN_NAMEReady) { _LOGGING_MXBEAN_NAMEContent = SGetField<string>(LocalBridgeClazz, "LOGGING_MXBEAN_NAME"); _LOGGING_MXBEAN_NAMEReady = true; } return _LOGGING_MXBEAN_NAMEContent; } }
        private static string _LOGGING_MXBEAN_NAMEContent = default;
