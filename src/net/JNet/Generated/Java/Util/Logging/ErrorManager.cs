...
namespace Java.Util.Logging
{
    ...
    public partial class ErrorManager
    {
        ...
        /// </summary>
        public static int CLOSE_FAILURE => LocalClazz.GetField<int>("CLOSE_FAILURE");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.logging/java/util/logging/ErrorManager.html#FLUSH_FAILURE"/>
        /// </summary>
        public static int FLUSH_FAILURE => LocalClazz.GetField<int>("FLUSH_FAILURE");
        /// <summary>
        ...
        /// </summary>
        public static int FORMAT_FAILURE => LocalClazz.GetField<int>("FORMAT_FAILURE");
        /// <summary>
