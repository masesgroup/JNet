...
namespace Java.Util.Prefs
{
    ...
    /// <summary>
    /// .NET interface for <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.prefs/java/util/prefs/PreferencesFactory.html"/>
    /// </summary>
    ...
    public partial class PreferencesFactory : Java.Util.Prefs.IPreferencesFactory
    {
        ...
        {
            get { return IExecute<Java.Util.Prefs.Preferences>("systemRoot"); }
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.prefs/java/util/prefs/PreferencesFactory.html#userRoot()"/> 
        /// </summary>
