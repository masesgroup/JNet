...
namespace Java.Util.Stream
{
    ...
    public partial class IntStream : Java.Util.Stream.IIntStream
    {
        ...
        {
            return SExecuteWithSignature<Java.Util.Stream.IntStream>(LocalBridgeClazz, "of", "([I)Ljava/util/stream/IntStream;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/stream/IntStream.html#of(int)"/>
        /// </summary>
