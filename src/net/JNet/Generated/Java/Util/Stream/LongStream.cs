...
namespace Java.Util.Stream
{
    ...
    public partial class LongStream : Java.Util.Stream.ILongStream
    {
        ...
        {
            return SExecuteWithSignature<Java.Util.Stream.LongStream>(LocalBridgeClazz, "of", "([J)Ljava/util/stream/LongStream;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/stream/LongStream.html#of(long)"/>
        /// </summary>
