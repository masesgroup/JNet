...
namespace Java.Util.Stream
{
    ...
    public partial class LongStream
    {
        ...
        {
            if (arg0.Length == 0) return SExecute<Java.Util.Stream.LongStream>(LocalClazz, "of", new object[] { arg0 }); else return SExecute<Java.Util.Stream.LongStream>(LocalClazz, "of", new object[] { arg0 }, arg0);
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/stream/LongStream.html#of(long)"/>
        /// </summary>
