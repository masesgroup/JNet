...
namespace Java.Util.Stream
{
    ...
    public partial class Collector<T, A, R>
    {
        ...
        {
            if (arg4.Length == 0) return SExecute<Java.Util.Stream.Collector<T, A, R>>("of", arg0, arg1, arg2, arg3); else return SExecute<Java.Util.Stream.Collector<T, A, R>>("of", arg0, arg1, arg2, arg3, arg4);
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/stream/Collector.html#of(java.util.function.Supplier,java.util.function.BiConsumer,java.util.function.BinaryOperator,java.util.stream.Collector.Characteristics[])"/>
        /// </summary>
        ...
        {
            if (arg3.Length == 0) return SExecute<Java.Util.Stream.Collector<T, R, R>>("of", arg0, arg1, arg2); else return SExecute<Java.Util.Stream.Collector<T, R, R>>("of", arg0, arg1, arg2, arg3);
        }
