...
namespace Java.Util
{
    ...
    public partial class Spliterator
    {
        ...
        /// </summary>
        public static int CONCURRENT => LocalClazz.GetField<int>("CONCURRENT");
        /// <summary>
