...
namespace Java.Util.Concurrent
{
    ...
    /// </summary>
    public partial class RunnableScheduledFuture : MASES.JCOBridge.C2JBridge.JVMBridgeCore<RunnableScheduledFuture>
    {
    ...
    public partial class RunnableScheduledFuture<V> : MASES.JCOBridge.C2JBridge.JVMBridgeCore<RunnableScheduledFuture<V>>
    {
        const string _bridgeClassName = "java.util.concurrent.RunnableScheduledFuture";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge
