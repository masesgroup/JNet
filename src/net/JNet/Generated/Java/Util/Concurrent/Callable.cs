...
namespace Java.Util.Concurrent
{
    ...
    public partial class Callable : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public Callable(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasCallableSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public Callable(params object[] args) : base(args)
        {
            ...
            _hasCallableSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class Callable
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideCall = GetMethodIsOverridden(listenerRuntimeType, nameof(Call));
