...
namespace Java.Util.Concurrent
{
    ...
    #region ICallable<V>
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/Callable.html"/>
    /// </summary>
