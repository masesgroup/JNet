...
namespace Java.Util.Concurrent
{
    ...
    #region IConcurrentNavigableMap<, >
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ConcurrentNavigableMap.html"/>
    /// </summary>
    public partial interface IConcurrentNavigableMap<, >
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/ConcurrentNavigableMap.html#descendingKeySet()"/>
    ...
    #region ConcurrentNavigableMap<, > implementation
    public partial class ConcurrentNavigableMap<, > : Java.Util.Concurrent.IConcurrentNavigableMap<, >
    {
        #region Constructors
        ...
        /// Converter from <see cref=""/> to <see cref=""/>
        /// </summary>
        public static implicit operator Java.Util.Concurrent.ConcurrentNavigableMap(Java.Util.Concurrent.ConcurrentNavigableMap<, > t) => t.Cast<Java.Util.Concurrent.ConcurrentNavigableMap>();
