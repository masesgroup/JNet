...
namespace Java.Util.Concurrent
{
    ...
    public partial class ForkJoinTask
    {
        ...
        {
            SExecuteWithSignature(LocalBridgeClazz, "invokeAll", "([Ljava/util/concurrent/ForkJoinTask;)V", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
