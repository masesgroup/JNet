...
namespace Java.Util
{
    ...
    public partial class FormattableFlags
    {
        ...
        /// </summary>
        public static int ALTERNATE { get { return SGetField<int>(LocalBridgeClazz, "ALTERNATE"); } }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/FormattableFlags.html#LEFT_JUSTIFY"/>
        /// </summary>
        public static int LEFT_JUSTIFY { get { return SGetField<int>(LocalBridgeClazz, "LEFT_JUSTIFY"); } }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/FormattableFlags.html#UPPERCASE"/>
        /// </summary>
        public static int UPPERCASE { get { return SGetField<int>(LocalBridgeClazz, "UPPERCASE"); } }
