...
namespace Java.Util
{
    ...
    public partial class Arrays
    {
        ...
        {
            return SExecuteWithSignature<Java.Util.List<T>>(LocalBridgeClazz, "asList", "([Ljava/lang/Object;)Ljava/util/List;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
