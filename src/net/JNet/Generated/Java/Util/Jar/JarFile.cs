...
namespace Java.Util.Jar
{
    ...
    public partial class JarFile
    {
        ...
        /// </summary>
        public static string MANIFEST_NAME { get { if (!_MANIFEST_NAMEReady) { _MANIFEST_NAMEContent = SGetField<string>(LocalBridgeClazz, "MANIFEST_NAME"); _MANIFEST_NAMEReady = true; } return _MANIFEST_NAMEContent; } }
        private static string _MANIFEST_NAMEContent = default;
