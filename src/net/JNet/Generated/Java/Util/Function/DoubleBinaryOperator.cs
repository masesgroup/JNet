...
namespace Java.Util.Function
{
    ...
    public partial class DoubleBinaryOperator : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DoubleBinaryOperator(params object[] args) : base(args)
        {
            ...
            _hasDoubleBinaryOperatorSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// <item><see cref="_hasDoubleBinaryOperatorSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasDoubleBinaryOperatorSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="DoubleBinaryOperator"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="DoubleBinaryOperator"/> instead.</para>
    /// </remarks>
    ...
    public partial class DoubleBinaryOperator : Java.Util.Function.IDoubleBinaryOperator
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsDouble = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsDouble), typeof(double), typeof(double));
