...
namespace Java.Util.Function
{
    ...
    public partial class DoubleConsumer : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _DoubleConsumerRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _DoubleConsumerRuntimeType ?? GetType();
            var method = _DoubleConsumerRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasDoubleConsumerSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class DoubleConsumer : Java.Util.Function.IDoubleConsumer
    {
        ...
        readonly bool _hasOverrideAccept = GetMethodIsOverridden(nameof(Accept), typeof(double));
        ...
        readonly bool _hasOverrideAndThen = GetMethodIsOverridden(nameof(AndThen), typeof(Java.Util.Function.DoubleConsumer));
