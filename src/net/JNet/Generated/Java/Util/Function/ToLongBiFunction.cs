...
namespace Java.Util.Function
{
    ...
    public partial class ToLongBiFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public ToLongBiFunction(params object[] args) : base(args) { InitializeHandlers(); }

        global::System.Type _ToLongBiFunctionRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _ToLongBiFunctionRuntimeType ?? GetType();
            var method = _ToLongBiFunctionRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasToLongBiFunctionSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class ToLongBiFunction<T, U> : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _ToLongBiFunction<T, U>RuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _ToLongBiFunction<T, U>RuntimeType ?? GetType();
            var method = _ToLongBiFunction<T, U>RuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasToLongBiFunction<T, U>SecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class ToLongBiFunction
    {
        ...
        readonly bool _hasOverrideApplyAsLong = GetMethodIsOverridden(nameof(ApplyAsLong), typeof(object), typeof(object));
    ...
    public partial class ToLongBiFunction<T, U> : Java.Util.Function.IToLongBiFunction<T, U>
    {
        ...
        int ApplyAsLongEventHandlerIndex = 0;
        readonly bool _hasOverrideApplyAsLong = GetMethodIsOverridden(nameof(ApplyAsLong), typeof(T), typeof(U));
        bool ApplyAsLongEventOverridden() => _hasOverrideApplyAsLong || OnApplyAsLong != null;
        void ApplyAsLongEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            if (!ApplyAsLongEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
