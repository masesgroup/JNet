...
namespace Java.Util.Function
{
    ...
    public partial class Supplier : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public Supplier(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); }
        /// <summary>
        /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
        /// </summary>
        public Supplier(params object[] args) : base(args) { InitializeHandlers(); _ListenerRuntimeType = GetType(); }
        ...
        bool _hasSupplierSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        /// <inheritdoc/>
    ...
    public partial class Supplier
    {
        ...
        bool _hasOverrideGet = GetMethodIsOverridden(_ListenerRuntimeType, nameof(Get));
