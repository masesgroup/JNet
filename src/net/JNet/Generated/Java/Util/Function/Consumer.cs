...
namespace Java.Util.Function
{
    ...
    public partial class Consumer<T> : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _Consumer<T>RuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _Consumer<T>RuntimeType ?? GetType();
            var method = _Consumer<T>RuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasConsumer<T>SecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
