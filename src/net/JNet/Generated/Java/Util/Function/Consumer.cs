...
namespace Java.Util.Function
{
    ...
    public partial class Consumer<T> : Java.Util.Function.IConsumer<T>
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _AndThen<Arg0objectSuperT>EventHandlerIndex = AddEventHandler("andThen", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(AndThen<Arg0objectSuperT>EventHandler));
        ...
        void AndThen<Arg0objectSuperT>EventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
            ...
            data.EventData.TypedEventData.SetReturnData(AndThen<Arg0objectSuperT>EventOverridden(), executionResult);
