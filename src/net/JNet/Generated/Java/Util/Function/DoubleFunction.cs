...
namespace Java.Util.Function
{
    ...
    public partial class DoubleFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public DoubleFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); }
        /// <summary>
        /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
        /// </summary>
        public DoubleFunction(params object[] args) : base(args) { InitializeHandlers(); _ListenerRuntimeType = GetType(); }
        ...
        bool _hasDoubleFunctionSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        /// <inheritdoc/>
    ...
    public partial class DoubleFunction
    {
        ...
        bool _hasOverrideApply = GetMethodIsOverridden(_ListenerRuntimeType, nameof(Apply), typeof(double));
