...
namespace Java.Util.Function
{
    ...
    public partial class LongPredicate : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public LongPredicate(params object[] args) : base(args)
        {
            ...
            _hasLongPredicateSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// <item><see cref="_hasLongPredicateSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasLongPredicateSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="LongPredicate"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="LongPredicate"/> instead.</para>
    /// </remarks>
    ...
    public partial class LongPredicate : Java.Util.Function.ILongPredicate
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideTest = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Test), typeof(long));
            ...
            _hasOverrideAnd = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(And), typeof(Java.Util.Function.LongPredicate));
            ...
            _hasOverrideOr = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Or), typeof(Java.Util.Function.LongPredicate));
        ...
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.LongPredicate> OnAndDispose { get; set; } = null;
        ...
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.LongPredicate> OnNegateDispose { get; set; } = null;
        ...
        /// instead of waiting for the .NET garbage collector to finalize it.
        /// If not set, the return value is not disposed automatically.</remarks>
        public global::System.Action<Java.Util.Function.LongPredicate> OnOrDispose { get; set; } = null;
