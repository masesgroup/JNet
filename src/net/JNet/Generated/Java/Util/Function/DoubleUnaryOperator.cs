...
namespace Java.Util.Function
{
    ...
    public partial class DoubleUnaryOperator : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public DoubleUnaryOperator(params object[] args) : base(args) { InitializeHandlers(); }

        global::System.Type _DoubleUnaryOperatorRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _DoubleUnaryOperatorRuntimeType ?? GetType();
            var method = _DoubleUnaryOperatorRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasDoubleUnaryOperatorSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class DoubleUnaryOperator : Java.Util.Function.IDoubleUnaryOperator
    {
        ...
        readonly bool _hasOverrideApplyAsDouble = GetMethodIsOverridden(nameof(ApplyAsDouble), typeof(double));
        ...
        readonly bool _hasOverrideAndThen = GetMethodIsOverridden(nameof(AndThen), typeof(Java.Util.Function.DoubleUnaryOperator));
        ...
        readonly bool _hasOverrideCompose = GetMethodIsOverridden(nameof(Compose), typeof(Java.Util.Function.DoubleUnaryOperator));
