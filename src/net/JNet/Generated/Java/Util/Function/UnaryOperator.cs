...
namespace Java.Util.Function
{
    ...
    public partial class UnaryOperator<T> : Java.Util.Function.IUnaryOperator<T>
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            _Apply<R>EventHandlerIndex = AddEventHandler("apply", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(Apply<R>EventHandler));
            ...
            _AndThen<V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandlerIndex = AddEventHandler("andThen", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(AndThen<V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandler));
            ...
            _Compose<V, R, Arg0objectSuperV, Arg0ExtendsT>EventHandlerIndex = AddEventHandler("compose", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(Compose<V, R, Arg0objectSuperV, Arg0ExtendsT>EventHandler));
        ...
        void Apply<R>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.SetReturnData(Apply<R>EventOverridden(), executionResult);
        ...
        void AndThen<V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.SetReturnData(AndThen<V, Arg0objectSuperR, R, Arg0ExtendsV>EventOverridden(), executionResult);
        ...
        void Compose<V, R, Arg0objectSuperV, Arg0ExtendsT>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.SetReturnData(Compose<V, R, Arg0objectSuperV, Arg0ExtendsT>EventOverridden(), executionResult);
