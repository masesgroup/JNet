...
namespace Java.Util.Function
{
    ...
    public partial class UnaryOperator : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public UnaryOperator(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasUnaryOperatorSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public UnaryOperator(params object[] args) : base(args)
        {
            ...
            _hasUnaryOperatorSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class UnaryOperator<T> : Java.Util.Function.IUnaryOperator<T>
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApply<R> = GetMethodIsOverridden(listenerRuntimeType, nameof(Apply<R>), typeof(T));
            ...
            _hasOverrideAndThen<V, Arg0objectSuperR, R, Arg0ExtendsV> = GetMethodIsOverridden(listenerRuntimeType, nameof(AndThen<V, Arg0objectSuperR, R, Arg0ExtendsV>), typeof(Java.Util.Function.Function<Arg0objectSuperR, Arg0ExtendsV>));
            ...
            _hasOverrideCompose<V, R, Arg0objectSuperV, Arg0ExtendsT> = GetMethodIsOverridden(listenerRuntimeType, nameof(Compose<V, R, Arg0objectSuperV, Arg0ExtendsT>), typeof(Java.Util.Function.Function<Arg0objectSuperV, Arg0ExtendsT>));
