...
namespace Java.Util.Function
{
    ...
    public partial class BiFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _BiFunctionRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _BiFunctionRuntimeType ?? GetType();
            var method = _BiFunctionRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasBiFunctionSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BiFunction<T, U, R> : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _BiFunction<T, U, R>RuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _BiFunction<T, U, R>RuntimeType ?? GetType();
            var method = _BiFunction<T, U, R>RuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasBiFunction<T, U, R>SecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BiFunction
    {
        ...
        readonly bool _hasOverrideApply = GetMethodIsOverridden(nameof(Apply), typeof(object), typeof(object));
    ...
    public partial class BiFunction<T, U, R> : Java.Util.Function.IBiFunction<T, U, R>
    {
        ...
        int ApplyEventHandlerIndex = 0;
        readonly bool _hasOverrideApply = GetMethodIsOverridden(nameof(Apply), typeof(T), typeof(U));
        bool ApplyEventOverridden() => _hasOverrideApply || OnApply != null;
        void ApplyEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            if (!ApplyEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
        ...
        readonly bool _hasOverrideAndThen<V, Arg0objectSuperR, Arg0ExtendsV> = GetMethodIsOverridden(nameof(AndThen<V, Arg0objectSuperR, Arg0ExtendsV>), typeof(Java.Util.Function.Function<Arg0objectSuperR, Arg0ExtendsV>));
