...
namespace Java.Util.Function
{
    ...
    public partial class Function : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _FunctionRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _FunctionRuntimeType ?? GetType();
            var method = _FunctionRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasFunctionSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class Function<T, R> : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _Function<T, R>RuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _Function<T, R>RuntimeType ?? GetType();
            var method = _Function<T, R>RuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasFunction<T, R>SecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class Function<T, R> : Java.Util.Function.IFunction<T, R>
    {
        ...
        int ApplyEventHandlerIndex = 0;
        readonly bool _hasOverrideApply = GetMethodIsOverridden(nameof(Apply), typeof(T));
        bool ApplyEventOverridden() => _hasOverrideApply || OnApply != null;
        void ApplyEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            if (!ApplyEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
        ...
        readonly bool _hasOverrideCompose<V, Arg0objectSuperV, Arg0ExtendsT> = GetMethodIsOverridden(nameof(Compose<V, Arg0objectSuperV, Arg0ExtendsT>), typeof(Java.Util.Function.Function<Arg0objectSuperV, Arg0ExtendsT>));
