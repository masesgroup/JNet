...
namespace Java.Util.Function
{
    ...
    public partial class BiConsumer : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _BiConsumerRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _BiConsumerRuntimeType ?? GetType();
            var method = _BiConsumerRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasBiConsumerSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BiConsumer<T, U> : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _BiConsumer<T, U>RuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _BiConsumer<T, U>RuntimeType ?? GetType();
            var method = _BiConsumer<T, U>RuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasBiConsumer<T, U>SecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BiConsumer
    {
        ...
        readonly bool _hasOverrideAccept = GetMethodIsOverridden(nameof(Accept), typeof(object), typeof(object));
        ...
        readonly bool _hasOverrideAndThen = GetMethodIsOverridden(nameof(AndThen), typeof(Java.Util.Function.BiConsumer));
    ...
    public partial class BiConsumer<T, U> : Java.Util.Function.IBiConsumer<T, U>
    {
        ...
        int AcceptEventHandlerIndex = 0;
        readonly bool _hasOverrideAccept = GetMethodIsOverridden(nameof(Accept), typeof(T), typeof(U));
        bool AcceptEventOverridden() => _hasOverrideAccept || OnAccept != null;
        void AcceptEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            if (!AcceptEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
        ...
        readonly bool _hasOverrideAndThen<Arg0objectSuperT, Arg0objectSuperU> = GetMethodIsOverridden(nameof(AndThen<Arg0objectSuperT, Arg0objectSuperU>), typeof(Java.Util.Function.BiConsumer<Arg0objectSuperT, Arg0objectSuperU>));
