...
namespace Java.Util.Function
{
    ...
    public partial class BiPredicate<T, U> : Java.Util.Function.IBiPredicate<T, U>
    {
        ...
        void And<Arg0objectSuperT, Arg0objectSuperU>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.TypedEventData.SetReturnData(And<Arg0objectSuperT, Arg0objectSuperU>EventOverridden(), executionResult);
        ...
        void Or<Arg0objectSuperT, Arg0objectSuperU>EventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            var executionResult = methodToExecute.Invoke(data.EventData.GetAt<Java.Util.Function.BiPredicate<Arg0objectSuperT, Arg0objectSuperU>>(0));
            data.EventData.TypedEventData.SetReturnData(Or<Arg0objectSuperT, Arg0objectSuperU>EventOverridden(), executionResult);
