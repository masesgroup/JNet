...
namespace Java.Util.Function
{
    ...
    public partial class IntBinaryOperator : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public IntBinaryOperator(params object[] args) : base(args)
        {
            ...
            _hasIntBinaryOperatorSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasIntBinaryOperatorSecondGate;
        ...
        /// <item><see cref="_hasIntBinaryOperatorSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIntBinaryOperatorSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="IntBinaryOperator"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="IntBinaryOperator"/> instead.</para>
    /// </remarks>
    ...
    public partial class IntBinaryOperator : Java.Util.Function.IIntBinaryOperator
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsInt = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsInt), typeof(int), typeof(int));
