...
namespace Java.Util.Function
{
    ...
    public partial class ToLongFunction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ToLongFunction(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasToLongFunctionSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public ToLongFunction(params object[] args) : base(args)
        {
            ...
            _hasToLongFunctionSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasToLongFunctionSecondGate;
        }
    ...
    public partial class ToLongFunction
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApplyAsLong = GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsLong), typeof(object));
    ...
    public partial class ToLongFunction<T> : Java.Util.Function.IToLongFunction<T>
    {
        ...
        {
            ApplyAsLongEventHandlerIndex = AddEventHandler("applyAsLong", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(ApplyAsLongEventHandler));
            _hasOverrideApplyAsLong = GetMethodIsOverridden(listenerRuntimeType, nameof(ApplyAsLong), typeof(T));
