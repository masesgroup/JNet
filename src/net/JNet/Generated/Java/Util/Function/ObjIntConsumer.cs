...
namespace Java.Util.Function
{
    ...
    public partial class ObjIntConsumer : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ObjIntConsumer(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasObjIntConsumerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public ObjIntConsumer(params object[] args) : base(args)
        {
            ...
            _hasObjIntConsumerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class ObjIntConsumer
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideAccept = GetMethodIsOverridden(listenerRuntimeType, nameof(Accept), typeof(object), typeof(int));
    ...
    public partial class ObjIntConsumer<T> : Java.Util.Function.IObjIntConsumer<T>
    {
        ...
        {
            AcceptEventHandlerIndex = AddEventHandler("accept", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(AcceptEventHandler));
            _hasOverrideAccept = GetMethodIsOverridden(listenerRuntimeType, nameof(Accept), typeof(T), typeof(int));
