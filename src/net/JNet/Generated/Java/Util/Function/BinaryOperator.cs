...
namespace Java.Util.Function
{
    ...
    public partial class BinaryOperator : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _BinaryOperatorRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _BinaryOperatorRuntimeType ?? GetType();
            var method = _BinaryOperatorRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasBinaryOperatorSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BinaryOperator<T> : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        global::System.Type _BinaryOperator<T>RuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _BinaryOperator<T>RuntimeType ?? GetType();
            var method = _BinaryOperator<T>RuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasBinaryOperator<T>SecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BinaryOperator<T> : Java.Util.Function.IBinaryOperator<T>
    {
        ...
        readonly bool _hasOverrideApply<R, U> = GetMethodIsOverridden(nameof(Apply<R, U>), typeof(T), typeof(U));
        ...
        readonly bool _hasOverrideAndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV> = GetMethodIsOverridden(nameof(AndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>), typeof(Java.Util.Function.Function<Arg0objectSuperR, Arg0ExtendsV>));
