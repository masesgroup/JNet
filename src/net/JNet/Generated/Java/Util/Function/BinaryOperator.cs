...
namespace Java.Util.Function
{
    ...
    public partial class BinaryOperator<T> : Java.Util.Function.IBinaryOperator<T>
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            _Apply<R, U>EventHandlerIndex = AddEventHandler("apply", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(Apply<R, U>EventHandler));
            ...
            _AndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandlerIndex = AddEventHandler("andThen", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(AndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandler));
        ...
        void Apply<R, U>EventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
        ...
        void AndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
