...
namespace Java.Util.Function
{
    ...
    public partial class BinaryOperator : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public BinaryOperator(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasBinaryOperatorSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public BinaryOperator(params object[] args) : base(args)
        {
            ...
            _hasBinaryOperatorSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class BinaryOperator<T> : Java.Util.Function.IBinaryOperator<T>
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideApply<R, U> = GetMethodIsOverridden(listenerRuntimeType, nameof(Apply<R, U>), typeof(T), typeof(U));
            ...
            _hasOverrideAndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV> = GetMethodIsOverridden(listenerRuntimeType, nameof(AndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>), typeof(Java.Util.Function.Function<Arg0objectSuperR, Arg0ExtendsV>));
        ...
        void Apply<R, U>EventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.EventData.TypedEventData.SetReturnData(_hasOverrideApply<R, U>, executionResult);
        }
        ...
        void AndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>EventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.EventData.TypedEventData.SetReturnData(_hasOverrideAndThen<U, V, Arg0objectSuperR, R, Arg0ExtendsV>, executionResult);
        }
