...
namespace Java.Util
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/java/util/WeakHashMap.html"/>
    /// </summary>
    public partial class WeakHashMap : Java.Util.AbstractMap
    {
        ...
        public WeakHashMap(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class WeakHashMap
    {
        ...
        /// </summary>
        public WeakHashMap() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        public WeakHashMap(int arg0) : base(JVMBridgeBase.InitializerInstance)
        {
