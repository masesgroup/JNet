...
namespace Java.Util
{
    ...
    public partial class Map
    {
        ...
        {
            return SExecuteWithSignature<Java.Util.Map>(LocalBridgeClazz, "ofEntries", "([Ljava/util/Map$Entry;)Ljava/util/Map;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
    ...
    public partial class Map<K, V> : Java.Util.IMap<K, V>
    {
        ...
        {
            return SExecuteWithSignature<Java.Util.Map<K, V>>(LocalBridgeClazz, "ofEntries", "([Ljava/util/Map$Entry;)Ljava/util/Map;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html#entry(java.lang.Object,java.lang.Object)"/>
        /// </summary>
