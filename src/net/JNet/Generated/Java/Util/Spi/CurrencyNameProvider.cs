...
namespace Java.Util.Spi
{
    ...
    public partial class CurrencyNameProvider
    {
        ...
        /// <summary>
        /// https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/spi/CurrencyNameProvider.html#getSymbol(java.lang.String,java.util.Locale)
        /// </summary>
        ...
        /// <summary>
        /// https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/spi/CurrencyNameProvider.html#getDisplayName(java.lang.String,java.util.Locale)
        /// </summary>
