...
namespace Java.Util
{
    ...
    public partial class Properties
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Enumeration>("propertyNames", "()Ljava/util/Enumeration;");
        }
        /// <summary>
        ...
        {
            return IExecuteWithSignature<Java.Util.Set>("stringPropertyNames", "()Ljava/util/Set;");
        }
        /// <summary>
