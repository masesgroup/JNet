...
namespace Java.Nio.File.Attribute
{
    ...
    public partial class AclEntryType
    {
        ...
        /// </summary>
        public static Java.Nio.File.Attribute.AclEntryType ALARM => LocalClazz.GetField<Java.Nio.File.Attribute.AclEntryType>("ALARM");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/attribute/AclEntryType.html#ALLOW"/>
        /// </summary>
        public static Java.Nio.File.Attribute.AclEntryType ALLOW => LocalClazz.GetField<Java.Nio.File.Attribute.AclEntryType>("ALLOW");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/attribute/AclEntryType.html#AUDIT"/>
        /// </summary>
        public static Java.Nio.File.Attribute.AclEntryType AUDIT => LocalClazz.GetField<Java.Nio.File.Attribute.AclEntryType>("AUDIT");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/attribute/AclEntryType.html#DENY"/>
        /// </summary>
        public static Java.Nio.File.Attribute.AclEntryType DENY => LocalClazz.GetField<Java.Nio.File.Attribute.AclEntryType>("DENY");
