...
namespace Java.Nio.File.Attribute
{
    ...
    /// </summary>
    public partial class FileAttribute : MASES.JCOBridge.C2JBridge.JVMBridgeCore<FileAttribute>
    {
    ...
    public partial class FileAttribute<T> : MASES.JCOBridge.C2JBridge.JVMBridgeCore<FileAttribute<T>>
    {
        const string _bridgeClassName = "java.nio.file.attribute.FileAttribute";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge
