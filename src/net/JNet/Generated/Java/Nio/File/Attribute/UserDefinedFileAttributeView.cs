...
namespace Java.Nio.File.Attribute
{
    ...
    public partial class UserDefinedFileAttributeView : Java.Nio.File.Attribute.FileAttributeView
    {
        ...
        public UserDefinedFileAttributeView(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/attribute/UserDefinedFileAttributeView.html"/>
    /// </summary>
