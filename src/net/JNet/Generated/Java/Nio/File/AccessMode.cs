...
namespace Java.Nio.File
{
    ...
    public partial class AccessMode
    {
        ...
        /// </summary>
        public static Java.Nio.File.AccessMode EXECUTE => LocalClazz.GetField<Java.Nio.File.AccessMode>("EXECUTE");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/AccessMode.html#READ"/>
        /// </summary>
        public static Java.Nio.File.AccessMode READ => LocalClazz.GetField<Java.Nio.File.AccessMode>("READ");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/AccessMode.html#WRITE"/>
        /// </summary>
        public static Java.Nio.File.AccessMode WRITE => LocalClazz.GetField<Java.Nio.File.AccessMode>("WRITE");
