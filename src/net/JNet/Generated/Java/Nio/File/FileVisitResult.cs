...
namespace Java.Nio.File
{
    ...
    public partial class FileVisitResult
    {
        ...
        /// </summary>
        public static Java.Nio.File.FileVisitResult CONTINUE => LocalClazz.GetField<Java.Nio.File.FileVisitResult>("CONTINUE");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/FileVisitResult.html#SKIP_SIBLINGS"/>
        /// </summary>
        public static Java.Nio.File.FileVisitResult SKIP_SIBLINGS => LocalClazz.GetField<Java.Nio.File.FileVisitResult>("SKIP_SIBLINGS");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/FileVisitResult.html#SKIP_SUBTREE"/>
        /// </summary>
        public static Java.Nio.File.FileVisitResult SKIP_SUBTREE => LocalClazz.GetField<Java.Nio.File.FileVisitResult>("SKIP_SUBTREE");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/nio/file/FileVisitResult.html#TERMINATE"/>
        /// </summary>
        public static Java.Nio.File.FileVisitResult TERMINATE => LocalClazz.GetField<Java.Nio.File.FileVisitResult>("TERMINATE");
