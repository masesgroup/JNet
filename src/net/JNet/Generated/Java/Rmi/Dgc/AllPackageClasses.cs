...
namespace Java.Rmi.Dgc
{
    ...
    public partial class DGC : Java.Rmi.Remote
    {
        ...
        /// </summary>
        [Obsolete("DGC class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public DGC() { }
        /// <summary>
