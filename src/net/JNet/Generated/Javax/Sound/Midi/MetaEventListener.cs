...
namespace Javax.Sound.Midi
{
    ...
    public partial class MetaEventListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public MetaEventListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasMetaEventListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasMetaEventListenerSecondGate;
        ...
        /// <item><see cref="_hasMetaEventListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasMetaEventListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="MetaEventListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="MetaEventListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class MetaEventListener : Javax.Sound.Midi.IMetaEventListener
    {
        ...
        {
            _MetaEventHandlerIndex = AddEventHandler("meta", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(MetaEventHandler));
            _hasOverrideMeta = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Meta), typeof(Javax.Sound.Midi.MetaMessage));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _MetaEventHandlerIndex) return MetaEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="Meta"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _MetaEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="Meta"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideMeta;
        ...
        void MetaEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!MetaEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = MetaEventOverridden();
        }
