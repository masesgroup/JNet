...
namespace Javax.Sound.Sampled
{
    ...
    public partial class LineListener : Java.Util.EventListener
    {
        ...
        public LineListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasLineListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public LineListener(params object[] args) : base(args)
        {
            ...
            _hasLineListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class LineListener : Javax.Sound.Sampled.ILineListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideUpdate = GetMethodIsOverridden(listenerRuntimeType, nameof(Update), typeof(Javax.Sound.Sampled.LineEvent));
        ...
        void UpdateEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.EventData.TypedEventData.HasOverride = _hasOverrideUpdate;
        }
