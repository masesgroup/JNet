...
namespace Javax.Sql
{
    ...
    public partial class PooledConnectionBuilder : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PooledConnectionBuilder>
    {
        ...
        public PooledConnectionBuilder(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/javax/sql/PooledConnectionBuilder.html"/>
    /// </summary>
