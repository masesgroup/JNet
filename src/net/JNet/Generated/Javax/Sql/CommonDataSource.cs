...
namespace Javax.Sql
{
    ...
    public partial class CommonDataSource : MASES.JCOBridge.C2JBridge.JVMBridgeBase<CommonDataSource>
    {
        ...
        public CommonDataSource(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/javax/sql/CommonDataSource.html"/>
    /// </summary>
