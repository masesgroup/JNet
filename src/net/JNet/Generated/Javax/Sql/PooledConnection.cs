...
namespace Javax.Sql
{
    ...
    public partial class PooledConnection : MASES.JCOBridge.C2JBridge.JVMBridgeBase<PooledConnection>
    {
        ...
        public PooledConnection(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql/javax/sql/PooledConnection.html"/>
    /// </summary>
