...
namespace Javax.Sql.Rowset
{
    ...
    #region IJoinRowSet
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/JoinRowSet.html"/>
    /// </summary>
    ...
    public partial class JoinRowSet : Javax.Sql.Rowset.IJoinRowSet
    {
        ...
        {
            get { return IExecuteWithSignature<Java.Util.Collection>("getRowSets", "()Ljava/util/Collection;"); }
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/JoinRowSet.html#getWhereClause()"/> 
        /// </summary>
