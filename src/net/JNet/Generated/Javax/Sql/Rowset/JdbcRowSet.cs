...
namespace Javax.Sql.Rowset
{
    ...
    #region IJdbcRowSet
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/JdbcRowSet.html"/>
    /// </summary>
