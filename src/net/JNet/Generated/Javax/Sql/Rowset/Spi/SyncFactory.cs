...
namespace Javax.Sql.Rowset.Spi
{
    ...
    public partial class SyncFactory
    {
        ...
        /// </summary>
        public static string ROWSET_SYNC_PROVIDER { get { if (!_ROWSET_SYNC_PROVIDERReady) { _ROWSET_SYNC_PROVIDERContent = SGetField<string>(LocalBridgeClazz, "ROWSET_SYNC_PROVIDER"); _ROWSET_SYNC_PROVIDERReady = true; } return _ROWSET_SYNC_PROVIDERContent; } }
        private static string _ROWSET_SYNC_PROVIDERContent = default;
        ...
        /// </summary>
        public static string ROWSET_SYNC_PROVIDER_VERSION { get { if (!_ROWSET_SYNC_PROVIDER_VERSIONReady) { _ROWSET_SYNC_PROVIDER_VERSIONContent = SGetField<string>(LocalBridgeClazz, "ROWSET_SYNC_PROVIDER_VERSION"); _ROWSET_SYNC_PROVIDER_VERSIONReady = true; } return _ROWSET_SYNC_PROVIDER_VERSIONContent; } }
        private static string _ROWSET_SYNC_PROVIDER_VERSIONContent = default;
        ...
        /// </summary>
        public static string ROWSET_SYNC_VENDOR { get { if (!_ROWSET_SYNC_VENDORReady) { _ROWSET_SYNC_VENDORContent = SGetField<string>(LocalBridgeClazz, "ROWSET_SYNC_VENDOR"); _ROWSET_SYNC_VENDORReady = true; } return _ROWSET_SYNC_VENDORContent; } }
        private static string _ROWSET_SYNC_VENDORContent = default;
