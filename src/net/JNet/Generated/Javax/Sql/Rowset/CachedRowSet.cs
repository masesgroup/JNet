...
namespace Javax.Sql.Rowset
{
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/CachedRowSet.html"/>
    /// </summary>
    public partial interface ICachedRowSet
    {
        ...
        /// <returns><see cref=""/></returns>
        /// <exception cref=""/>
        Java.Util.Collection ToCollection(int arg0);
        /// <summary>
        ...
        /// <returns><see cref=""/></returns>
        /// <exception cref=""/>
        Java.Util.Collection ToCollection(Java.Lang.String arg0);
        /// <summary>
    ...
    public partial class CachedRowSet : Javax.Sql.Rowset.ICachedRowSet
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Collection>("toCollection", "()Ljava/util/Collection;");
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/CachedRowSet.html#toCollection(int)"/>
        /// </summary>
        ...
        {
            return IExecuteWithSignature<Java.Util.Collection>("toCollection", "(I)Ljava/util/Collection;", arg0);
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/CachedRowSet.html#toCollection(java.lang.String)"/>
        /// </summary>
        ...
        {
            return IExecuteWithSignature<Java.Util.Collection>("toCollection", "(Ljava/lang/String;)Ljava/util/Collection;", arg0);
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.sql.rowset/javax/sql/rowset/CachedRowSet.html#createShared()"/>
        /// </summary>
