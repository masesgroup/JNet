...
namespace Javax.Management.Remote.Rmi
{
    ...
    #region IRMIServer
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.management.rmi/javax/management/remote/rmi/RMIServer.html"/>
    /// </summary>
