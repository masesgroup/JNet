...
namespace Javax.Management.Remote
{
    ...
    public partial class JMXConnectionNotification
    {
        ...
        /// </summary>
        public static string CLOSED { get { if (!_CLOSEDReady) { _CLOSEDContent = SGetField<string>(LocalBridgeClazz, "CLOSED"); _CLOSEDReady = true; } return _CLOSEDContent; } }
        private static string _CLOSEDContent = default;
        ...
        /// </summary>
        public static string FAILED { get { if (!_FAILEDReady) { _FAILEDContent = SGetField<string>(LocalBridgeClazz, "FAILED"); _FAILEDReady = true; } return _FAILEDContent; } }
        private static string _FAILEDContent = default;
        ...
        /// </summary>
        public static string NOTIFS_LOST { get { if (!_NOTIFS_LOSTReady) { _NOTIFS_LOSTContent = SGetField<string>(LocalBridgeClazz, "NOTIFS_LOST"); _NOTIFS_LOSTReady = true; } return _NOTIFS_LOSTContent; } }
        private static string _NOTIFS_LOSTContent = default;
        ...
        /// </summary>
        public static string OPENED { get { if (!_OPENEDReady) { _OPENEDContent = SGetField<string>(LocalBridgeClazz, "OPENED"); _OPENEDReady = true; } return _OPENEDContent; } }
        private static string _OPENEDContent = default;
