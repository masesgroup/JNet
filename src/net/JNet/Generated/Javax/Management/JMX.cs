...
namespace Javax.Management
{
    ...
    public partial class JMX
    {
        ...
        /// </summary>
        public static string DEFAULT_VALUE_FIELD { get { if (!_DEFAULT_VALUE_FIELDReady) { _DEFAULT_VALUE_FIELDContent = SGetField<string>(LocalBridgeClazz, "DEFAULT_VALUE_FIELD"); _DEFAULT_VALUE_FIELDReady = true; } return _DEFAULT_VALUE_FIELDContent; } }
        private static string _DEFAULT_VALUE_FIELDContent = default;
        ...
        /// </summary>
        public static string IMMUTABLE_INFO_FIELD { get { if (!_IMMUTABLE_INFO_FIELDReady) { _IMMUTABLE_INFO_FIELDContent = SGetField<string>(LocalBridgeClazz, "IMMUTABLE_INFO_FIELD"); _IMMUTABLE_INFO_FIELDReady = true; } return _IMMUTABLE_INFO_FIELDContent; } }
        private static string _IMMUTABLE_INFO_FIELDContent = default;
        ...
        /// </summary>
        public static string INTERFACE_CLASS_NAME_FIELD { get { if (!_INTERFACE_CLASS_NAME_FIELDReady) { _INTERFACE_CLASS_NAME_FIELDContent = SGetField<string>(LocalBridgeClazz, "INTERFACE_CLASS_NAME_FIELD"); _INTERFACE_CLASS_NAME_FIELDReady = true; } return _INTERFACE_CLASS_NAME_FIELDContent; } }
        private static string _INTERFACE_CLASS_NAME_FIELDContent = default;
        ...
        /// </summary>
        public static string LEGAL_VALUES_FIELD { get { if (!_LEGAL_VALUES_FIELDReady) { _LEGAL_VALUES_FIELDContent = SGetField<string>(LocalBridgeClazz, "LEGAL_VALUES_FIELD"); _LEGAL_VALUES_FIELDReady = true; } return _LEGAL_VALUES_FIELDContent; } }
        private static string _LEGAL_VALUES_FIELDContent = default;
        ...
        /// </summary>
        public static string MAX_VALUE_FIELD { get { if (!_MAX_VALUE_FIELDReady) { _MAX_VALUE_FIELDContent = SGetField<string>(LocalBridgeClazz, "MAX_VALUE_FIELD"); _MAX_VALUE_FIELDReady = true; } return _MAX_VALUE_FIELDContent; } }
        private static string _MAX_VALUE_FIELDContent = default;
        ...
        /// </summary>
        public static string MIN_VALUE_FIELD { get { if (!_MIN_VALUE_FIELDReady) { _MIN_VALUE_FIELDContent = SGetField<string>(LocalBridgeClazz, "MIN_VALUE_FIELD"); _MIN_VALUE_FIELDReady = true; } return _MIN_VALUE_FIELDContent; } }
        private static string _MIN_VALUE_FIELDContent = default;
        ...
        /// </summary>
        public static string MXBEAN_FIELD { get { if (!_MXBEAN_FIELDReady) { _MXBEAN_FIELDContent = SGetField<string>(LocalBridgeClazz, "MXBEAN_FIELD"); _MXBEAN_FIELDReady = true; } return _MXBEAN_FIELDContent; } }
        private static string _MXBEAN_FIELDContent = default;
        ...
        /// </summary>
        public static string OPEN_TYPE_FIELD { get { if (!_OPEN_TYPE_FIELDReady) { _OPEN_TYPE_FIELDContent = SGetField<string>(LocalBridgeClazz, "OPEN_TYPE_FIELD"); _OPEN_TYPE_FIELDReady = true; } return _OPEN_TYPE_FIELDContent; } }
        private static string _OPEN_TYPE_FIELDContent = default;
        ...
        /// </summary>
        public static string ORIGINAL_TYPE_FIELD { get { if (!_ORIGINAL_TYPE_FIELDReady) { _ORIGINAL_TYPE_FIELDContent = SGetField<string>(LocalBridgeClazz, "ORIGINAL_TYPE_FIELD"); _ORIGINAL_TYPE_FIELDReady = true; } return _ORIGINAL_TYPE_FIELDContent; } }
        private static string _ORIGINAL_TYPE_FIELDContent = default;
