...
namespace Javax.Management.Monitor
{
    ...
    public partial class MonitorNotification
    {
        ...
        /// </summary>
        public static string OBSERVED_ATTRIBUTE_ERROR { get { if (!_OBSERVED_ATTRIBUTE_ERRORReady) { _OBSERVED_ATTRIBUTE_ERRORContent = SGetField<string>(LocalBridgeClazz, "OBSERVED_ATTRIBUTE_ERROR"); _OBSERVED_ATTRIBUTE_ERRORReady = true; } return _OBSERVED_ATTRIBUTE_ERRORContent; } }
        private static string _OBSERVED_ATTRIBUTE_ERRORContent = default;
        ...
        /// </summary>
        public static string OBSERVED_ATTRIBUTE_TYPE_ERROR { get { if (!_OBSERVED_ATTRIBUTE_TYPE_ERRORReady) { _OBSERVED_ATTRIBUTE_TYPE_ERRORContent = SGetField<string>(LocalBridgeClazz, "OBSERVED_ATTRIBUTE_TYPE_ERROR"); _OBSERVED_ATTRIBUTE_TYPE_ERRORReady = true; } return _OBSERVED_ATTRIBUTE_TYPE_ERRORContent; } }
        private static string _OBSERVED_ATTRIBUTE_TYPE_ERRORContent = default;
        ...
        /// </summary>
        public static string OBSERVED_OBJECT_ERROR { get { if (!_OBSERVED_OBJECT_ERRORReady) { _OBSERVED_OBJECT_ERRORContent = SGetField<string>(LocalBridgeClazz, "OBSERVED_OBJECT_ERROR"); _OBSERVED_OBJECT_ERRORReady = true; } return _OBSERVED_OBJECT_ERRORContent; } }
        private static string _OBSERVED_OBJECT_ERRORContent = default;
        ...
        /// </summary>
        public static string RUNTIME_ERROR { get { if (!_RUNTIME_ERRORReady) { _RUNTIME_ERRORContent = SGetField<string>(LocalBridgeClazz, "RUNTIME_ERROR"); _RUNTIME_ERRORReady = true; } return _RUNTIME_ERRORContent; } }
        private static string _RUNTIME_ERRORContent = default;
        ...
        /// </summary>
        public static string STRING_TO_COMPARE_VALUE_DIFFERED { get { if (!_STRING_TO_COMPARE_VALUE_DIFFEREDReady) { _STRING_TO_COMPARE_VALUE_DIFFEREDContent = SGetField<string>(LocalBridgeClazz, "STRING_TO_COMPARE_VALUE_DIFFERED"); _STRING_TO_COMPARE_VALUE_DIFFEREDReady = true; } return _STRING_TO_COMPARE_VALUE_DIFFEREDContent; } }
        private static string _STRING_TO_COMPARE_VALUE_DIFFEREDContent = default;
        ...
        /// </summary>
        public static string STRING_TO_COMPARE_VALUE_MATCHED { get { if (!_STRING_TO_COMPARE_VALUE_MATCHEDReady) { _STRING_TO_COMPARE_VALUE_MATCHEDContent = SGetField<string>(LocalBridgeClazz, "STRING_TO_COMPARE_VALUE_MATCHED"); _STRING_TO_COMPARE_VALUE_MATCHEDReady = true; } return _STRING_TO_COMPARE_VALUE_MATCHEDContent; } }
        private static string _STRING_TO_COMPARE_VALUE_MATCHEDContent = default;
        ...
        /// </summary>
        public static string THRESHOLD_ERROR { get { if (!_THRESHOLD_ERRORReady) { _THRESHOLD_ERRORContent = SGetField<string>(LocalBridgeClazz, "THRESHOLD_ERROR"); _THRESHOLD_ERRORReady = true; } return _THRESHOLD_ERRORContent; } }
        private static string _THRESHOLD_ERRORContent = default;
        ...
        /// </summary>
        public static string THRESHOLD_HIGH_VALUE_EXCEEDED { get { if (!_THRESHOLD_HIGH_VALUE_EXCEEDEDReady) { _THRESHOLD_HIGH_VALUE_EXCEEDEDContent = SGetField<string>(LocalBridgeClazz, "THRESHOLD_HIGH_VALUE_EXCEEDED"); _THRESHOLD_HIGH_VALUE_EXCEEDEDReady = true; } return _THRESHOLD_HIGH_VALUE_EXCEEDEDContent; } }
        private static string _THRESHOLD_HIGH_VALUE_EXCEEDEDContent = default;
        ...
        /// </summary>
        public static string THRESHOLD_LOW_VALUE_EXCEEDED { get { if (!_THRESHOLD_LOW_VALUE_EXCEEDEDReady) { _THRESHOLD_LOW_VALUE_EXCEEDEDContent = SGetField<string>(LocalBridgeClazz, "THRESHOLD_LOW_VALUE_EXCEEDED"); _THRESHOLD_LOW_VALUE_EXCEEDEDReady = true; } return _THRESHOLD_LOW_VALUE_EXCEEDEDContent; } }
        private static string _THRESHOLD_LOW_VALUE_EXCEEDEDContent = default;
        ...
        /// </summary>
        public static string THRESHOLD_VALUE_EXCEEDED { get { if (!_THRESHOLD_VALUE_EXCEEDEDReady) { _THRESHOLD_VALUE_EXCEEDEDContent = SGetField<string>(LocalBridgeClazz, "THRESHOLD_VALUE_EXCEEDED"); _THRESHOLD_VALUE_EXCEEDEDReady = true; } return _THRESHOLD_VALUE_EXCEEDEDContent; } }
        private static string _THRESHOLD_VALUE_EXCEEDEDContent = default;
