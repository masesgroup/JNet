...
namespace Javax.Management.Loading
{
    ...
    #region IMLetMBean
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/loading/MLetMBean.html"/>
    /// </summary>
