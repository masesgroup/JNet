...
namespace Javax.Management
{
    ...
    public partial class NotificationFilter : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public NotificationFilter(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasNotificationFilterSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public NotificationFilter(params object[] args) : base(args)
        {
            ...
            _hasNotificationFilterSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class NotificationFilter : Javax.Management.INotificationFilter
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideIsNotificationEnabled = GetMethodIsOverridden(listenerRuntimeType, nameof(IsNotificationEnabled), typeof(Javax.Management.Notification));
