...
namespace Javax.Management
{
    ...
    public partial class NotificationFilter : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public NotificationFilter(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasNotificationFilterSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasNotificationFilterSecondGate;
        ...
        /// <item><see cref="_hasNotificationFilterSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasNotificationFilterSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="NotificationFilter"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="NotificationFilter"/> instead.</para>
    /// </remarks>
    ...
    public partial class NotificationFilter : Javax.Management.INotificationFilter
    {
        ...
        {
            _IsNotificationEnabledEventHandlerIndex = AddEventHandler("isNotificationEnabled", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(IsNotificationEnabledEventHandler));
            _hasOverrideIsNotificationEnabled = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(IsNotificationEnabled), typeof(Javax.Management.Notification));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _IsNotificationEnabledEventHandlerIndex) return IsNotificationEnabledEventOverridden();
        ...
        /// </summary>
        /// <remarks>Set <see cref="OnIsNotificationEnabledDispose"/> when the event handler returns a JVM-backed object
        ...
        public global::System.Action<bool> OnIsNotificationEnabledDispose { get; set; } = null;

        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="IsNotificationEnabled"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _IsNotificationEnabledEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="IsNotificationEnabled"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideIsNotificationEnabled;
        ...
        void IsNotificationEnabledEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!IsNotificationEnabledEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.SetReturnData(IsNotificationEnabledEventOverridden(), executionResult);
            OnIsNotificationEnabledDispose?.Invoke(executionResult);
        }
