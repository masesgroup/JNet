...
namespace Javax.Management.Timer
{
    ...
    #region ITimerMBean
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.management/javax/management/timer/TimerMBean.html"/>
    /// </summary>
