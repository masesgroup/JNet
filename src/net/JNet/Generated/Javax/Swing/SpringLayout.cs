...
namespace Javax.Swing
{
    ...
    public partial class SpringLayout
    {
        ...
        /// </summary>
        public static string BASELINE { get { if (!_BASELINEReady) { _BASELINEContent = SGetField<string>(LocalBridgeClazz, "BASELINE"); _BASELINEReady = true; } return _BASELINEContent; } }
        private static string _BASELINEContent = default;
        ...
        /// </summary>
        public static string EAST { get { if (!_EASTReady) { _EASTContent = SGetField<string>(LocalBridgeClazz, "EAST"); _EASTReady = true; } return _EASTContent; } }
        ...
        /// </summary>
        public static string HEIGHT { get { if (!_HEIGHTReady) { _HEIGHTContent = SGetField<string>(LocalBridgeClazz, "HEIGHT"); _HEIGHTReady = true; } return _HEIGHTContent; } }
        private static string _HEIGHTContent = default;
        ...
        /// </summary>
        public static string HORIZONTAL_CENTER { get { if (!_HORIZONTAL_CENTERReady) { _HORIZONTAL_CENTERContent = SGetField<string>(LocalBridgeClazz, "HORIZONTAL_CENTER"); _HORIZONTAL_CENTERReady = true; } return _HORIZONTAL_CENTERContent; } }
        private static string _HORIZONTAL_CENTERContent = default;
        ...
        /// </summary>
        public static string NORTH { get { if (!_NORTHReady) { _NORTHContent = SGetField<string>(LocalBridgeClazz, "NORTH"); _NORTHReady = true; } return _NORTHContent; } }
        ...
        /// </summary>
        public static string SOUTH { get { if (!_SOUTHReady) { _SOUTHContent = SGetField<string>(LocalBridgeClazz, "SOUTH"); _SOUTHReady = true; } return _SOUTHContent; } }
        ...
        /// </summary>
        public static string VERTICAL_CENTER { get { if (!_VERTICAL_CENTERReady) { _VERTICAL_CENTERContent = SGetField<string>(LocalBridgeClazz, "VERTICAL_CENTER"); _VERTICAL_CENTERReady = true; } return _VERTICAL_CENTERContent; } }
        private static string _VERTICAL_CENTERContent = default;
        ...
        /// </summary>
        public static string WEST { get { if (!_WESTReady) { _WESTContent = SGetField<string>(LocalBridgeClazz, "WEST"); _WESTReady = true; } return _WESTContent; } }
        ...
        /// </summary>
        public static string WIDTH { get { if (!_WIDTHReady) { _WIDTHContent = SGetField<string>(LocalBridgeClazz, "WIDTH"); _WIDTHReady = true; } return _WIDTHContent; } }
        private static string _WIDTHContent = default;
