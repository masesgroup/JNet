...
namespace Javax.Swing
{
    ...
    public partial class Action : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public Action(params object[] args) : base(args) { InitializeHandlers(); }

        global::System.Type _ActionRuntimeType = null;
        bool GetMethodIsOverridden(string methodName, params global::System.Type[] types)
        {
            _ActionRuntimeType ?? GetType();
            var method = _ActionRuntimeType.GetMethod(methodName, types);
            var methodOverridden = method.GetBaseDefinition().DeclaringType != method.DeclaringType;
            return methodOverridden;
        }

        readonly bool _hasActionSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class Action : Javax.Swing.IAction
    {
        ...
        readonly bool _hasOverrideIsEnabled = GetMethodIsOverridden(nameof(IsEnabled));
        ...
        readonly bool _hasOverrideGetValue = GetMethodIsOverridden(nameof(GetValue), typeof(Java.Lang.String));
        ...
        readonly bool _hasOverrideActionPerformed = GetMethodIsOverridden(nameof(ActionPerformed), typeof(Java.Awt.EventNs.ActionEvent));
        ...
        readonly bool _hasOverrideAddPropertyChangeListener = GetMethodIsOverridden(nameof(AddPropertyChangeListener), typeof(Java.Beans.PropertyChangeListener));
        ...
        readonly bool _hasOverridePutValue = GetMethodIsOverridden(nameof(PutValue), typeof(Java.Lang.String), typeof(object));
        ...
        readonly bool _hasOverrideRemovePropertyChangeListener = GetMethodIsOverridden(nameof(RemovePropertyChangeListener), typeof(Java.Beans.PropertyChangeListener));
        ...
        readonly bool _hasOverrideSetEnabled = GetMethodIsOverridden(nameof(SetEnabled), typeof(bool));
