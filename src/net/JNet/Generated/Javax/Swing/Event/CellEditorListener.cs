...
namespace Javax.Swing.Event
{
    ...
    public partial class CellEditorListener : Javax.Swing.Event.ICellEditorListener
    {
        ...
        {
            _EditingCanceledEventHandlerIndex = AddEventHandler("editingCanceled", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(EditingCanceledEventHandler));
            ...
            _EditingStoppedEventHandlerIndex = AddEventHandler("editingStopped", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(EditingStoppedEventHandler));
        ...
        void EditingCanceledEventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
            ...
            data.EventData.TypedEventData.HasOverride = EditingCanceledEventOverridden();
        }
        ...
        void EditingStoppedEventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Swing.Event.ChangeEvent>(0));
            data.EventData.TypedEventData.HasOverride = EditingStoppedEventOverridden();
        }
