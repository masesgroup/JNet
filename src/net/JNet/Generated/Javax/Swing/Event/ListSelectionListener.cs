...
namespace Javax.Swing.Event
{
    ...
    public partial class ListSelectionListener : Java.Util.EventListener
    {
        ...
        /// <item><see cref="_hasListSelectionListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        /// </list>
        /// </remarks>
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ListSelectionListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ListSelectionListener"/> instead.</para>
    /// </remarks>
