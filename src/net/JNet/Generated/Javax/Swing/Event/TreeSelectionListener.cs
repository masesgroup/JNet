...
namespace Javax.Swing.Event
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/TreeSelectionListener.html"/>
    /// </summary>
    public partial class TreeSelectionListener : Java.Util.EventListener
    {
        ...
        public TreeSelectionListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public TreeSelectionListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasTreeSelectionListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasTreeSelectionListenerSecondGate;
        ...
        /// <item><see cref="_hasTreeSelectionListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasTreeSelectionListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="TreeSelectionListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="TreeSelectionListener"/> instead.</para>
    /// </remarks>
    public partial class TreeSelectionListenerDirect : TreeSelectionListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public TreeSelectionListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public TreeSelectionListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.javax.swing.event.TreeSelectionListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/TreeSelectionListener.html"/>
    /// </summary>
    public partial interface ITreeSelectionListener
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/TreeSelectionListener.html#valueChanged-javax.swing.event.TreeSelectionEvent-"/>
        /// </summary>
    ...
    public partial class TreeSelectionListener : Javax.Swing.Event.ITreeSelectionListener
    {
        ...
        {
            _ValueChangedEventHandlerIndex = AddEventHandler("valueChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ValueChangedEventHandler));
            _hasOverrideValueChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ValueChanged), typeof(Javax.Swing.Event.TreeSelectionEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _ValueChangedEventHandlerIndex) return ValueChangedEventOverridden();

            return false; // no one can manage event, continues to caller
        }

        /// <summary>
        /// Handler for <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/TreeSelectionListener.html#valueChanged-javax.swing.event.TreeSelectionEvent-"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="ValueChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _ValueChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="ValueChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        ...
        void ValueChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!ValueChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = ValueChangedEventOverridden();
        }
