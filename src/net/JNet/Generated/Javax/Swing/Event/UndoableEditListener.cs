...
namespace Javax.Swing.Event
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/UndoableEditListener.html"/>
    /// </summary>
    public partial class UndoableEditListener : Java.Util.EventListener
    {
        ...
        public UndoableEditListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public UndoableEditListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasUndoableEditListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasUndoableEditListenerSecondGate;
        ...
        /// <item><see cref="_hasUndoableEditListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasUndoableEditListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="UndoableEditListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="UndoableEditListener"/> instead.</para>
    /// </remarks>
    public partial class UndoableEditListenerDirect : UndoableEditListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public UndoableEditListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public UndoableEditListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.javax.swing.event.UndoableEditListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/UndoableEditListener.html"/>
    /// </summary>
    public partial interface IUndoableEditListener
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/UndoableEditListener.html#undoableEditHappened-javax.swing.event.UndoableEditEvent-"/>
        /// </summary>
    ...
    public partial class UndoableEditListener : Javax.Swing.Event.IUndoableEditListener
    {
        ...
        {
            _UndoableEditHappenedEventHandlerIndex = AddEventHandler("undoableEditHappened", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(UndoableEditHappenedEventHandler));
            _hasOverrideUndoableEditHappened = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(UndoableEditHappened), typeof(Javax.Swing.Event.UndoableEditEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _UndoableEditHappenedEventHandlerIndex) return UndoableEditHappenedEventOverridden();

            return false; // no one can manage event, continues to caller
        }

        /// <summary>
        /// Handler for <see href="https://docs.oracle.com/javase/8/docs/api/javax/swing/event/UndoableEditListener.html#undoableEditHappened-javax.swing.event.UndoableEditEvent-"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="UndoableEditHappened"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _UndoableEditHappenedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="UndoableEditHappened"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideUndoableEditHappened;
        ...
        bool UndoableEditHappenedEventOverridden() => _hasOverrideUndoableEditHappened || OnUndoableEditHappened != null;

        void UndoableEditHappenedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!UndoableEditHappenedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = UndoableEditHappenedEventOverridden();
        }
