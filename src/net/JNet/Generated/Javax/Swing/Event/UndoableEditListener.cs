...
namespace Javax.Swing.Event
{
    ...
    public partial class UndoableEditListener : Java.Util.EventListener
    {
        ...
        public UndoableEditListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasUndoableEditListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public UndoableEditListener(params object[] args) : base(args)
        {
            ...
            _hasUndoableEditListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class UndoableEditListener : Javax.Swing.Event.IUndoableEditListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideUndoableEditHappened = GetMethodIsOverridden(listenerRuntimeType, nameof(UndoableEditHappened), typeof(Javax.Swing.Event.UndoableEditEvent));
        ...
        {
            if (!UndoableEditHappenedEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
            {
            ...
            data.EventData.TypedEventData.HasOverride = _hasOverrideUndoableEditHappened;
        }
