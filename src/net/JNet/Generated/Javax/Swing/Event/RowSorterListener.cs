...
namespace Javax.Swing.Event
{
    ...
    public partial class RowSorterListener : Java.Util.EventListener
    {
        ...
        public RowSorterListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasRowSorterListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public RowSorterListener(params object[] args) : base(args)
        {
            ...
            _hasRowSorterListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class RowSorterListener : Javax.Swing.Event.IRowSorterListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideSorterChanged = GetMethodIsOverridden(listenerRuntimeType, nameof(SorterChanged), typeof(Javax.Swing.Event.RowSorterEvent));
        ...
        {
            if (!SorterChangedEventOverridden()) // can be omitted however it is a protection against an user override of ListenerShallManageEvent
            {
            ...
            data.EventData.TypedEventData.HasOverride = _hasOverrideSorterChanged;
        }
