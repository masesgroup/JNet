...
namespace Javax.Swing.Event
{
    ...
    public partial class HyperlinkListener : Java.Util.EventListener
    {
        ...
        public HyperlinkListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public HyperlinkListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasHyperlinkListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasHyperlinkListenerSecondGate;
        ...
        /// <item><see cref="_hasHyperlinkListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasHyperlinkListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="HyperlinkListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="HyperlinkListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class HyperlinkListener : Javax.Swing.Event.IHyperlinkListener
    {
        ...
        {
            _HyperlinkUpdateEventHandlerIndex = AddEventHandler("hyperlinkUpdate", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(HyperlinkUpdateEventHandler));
            _hasOverrideHyperlinkUpdate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(HyperlinkUpdate), typeof(Javax.Swing.Event.HyperlinkEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _HyperlinkUpdateEventHandlerIndex) return HyperlinkUpdateEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="HyperlinkUpdate"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _HyperlinkUpdateEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="HyperlinkUpdate"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideHyperlinkUpdate;
        ...
        void HyperlinkUpdateEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!HyperlinkUpdateEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = HyperlinkUpdateEventOverridden();
        }
