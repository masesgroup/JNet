...
namespace Javax.Swing.Event
{
    ...
    public partial class TableModelListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public TableModelListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasTableModelListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// <item><see cref="_hasTableModelListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasTableModelListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="TableModelListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="TableModelListener"/> instead.</para>
    /// </remarks>
    ...
    public partial class TableModelListener : Javax.Swing.Event.ITableModelListener
    {
        ...
        {
            _TableChangedEventHandlerIndex = AddEventHandler("tableChanged", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(TableChangedEventHandler));
            _hasOverrideTableChanged = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(TableChanged), typeof(Javax.Swing.Event.TableModelEvent));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _TableChangedEventHandlerIndex) return TableChangedEventOverridden();
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="TableChanged"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _TableChangedEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="TableChanged"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideTableChanged;
        ...
        void TableChangedEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!TableChangedEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = TableChangedEventOverridden();
        }
