...
namespace Javax.Swing.Text
{
    ...
    public partial class PlainDocument
    {
        ...
        /// </summary>
        public static string lineLimitAttribute { get { if (!_lineLimitAttributeReady) { _lineLimitAttributeContent = SGetField<string>(LocalBridgeClazz, "lineLimitAttribute"); _lineLimitAttributeReady = true; } return _lineLimitAttributeContent; } }
        private static string _lineLimitAttributeContent = default;
        ...
        /// </summary>
        public static string tabSizeAttribute { get { if (!_tabSizeAttributeReady) { _tabSizeAttributeContent = SGetField<string>(LocalBridgeClazz, "tabSizeAttribute"); _tabSizeAttributeReady = true; } return _tabSizeAttributeContent; } }
        private static string _tabSizeAttributeContent = default;
