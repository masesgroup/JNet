...
namespace Javax.Swing.Text
{
    ...
    public partial class StyleContext
    {
        ...
        /// </summary>
        public static string DEFAULT_STYLE { get { if (!_DEFAULT_STYLEReady) { _DEFAULT_STYLEContent = SGetField<string>(LocalBridgeClazz, "DEFAULT_STYLE"); _DEFAULT_STYLEReady = true; } return _DEFAULT_STYLEContent; } }
        private static string _DEFAULT_STYLEContent = default;
