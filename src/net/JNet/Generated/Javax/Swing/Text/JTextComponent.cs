...
namespace Javax.Swing.Text
{
    ...
    public partial class JTextComponent
    {
        ...
        /// </summary>
        public static string DEFAULT_KEYMAP { get { if (!_DEFAULT_KEYMAPReady) { _DEFAULT_KEYMAPContent = SGetField<string>(LocalBridgeClazz, "DEFAULT_KEYMAP"); _DEFAULT_KEYMAPReady = true; } return _DEFAULT_KEYMAPContent; } }
        private static string _DEFAULT_KEYMAPContent = default;
        ...
        /// </summary>
        public static string FOCUS_ACCELERATOR_KEY { get { if (!_FOCUS_ACCELERATOR_KEYReady) { _FOCUS_ACCELERATOR_KEYContent = SGetField<string>(LocalBridgeClazz, "FOCUS_ACCELERATOR_KEY"); _FOCUS_ACCELERATOR_KEYReady = true; } return _FOCUS_ACCELERATOR_KEYContent; } }
        private static string _FOCUS_ACCELERATOR_KEYContent = default;
