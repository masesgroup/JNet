...
namespace Javax.Swing
{
    ...
    public partial class JSplitPane
    {
        ...
        /// </summary>
        public static string CONTINUOUS_LAYOUT_PROPERTY => LocalClazz.GetField<string>("CONTINUOUS_LAYOUT_PROPERTY");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JSplitPane.html#DIVIDER"/>
        /// </summary>
        public static string DIVIDER => LocalClazz.GetField<string>("DIVIDER");
        /// <summary>
        ...
        /// </summary>
        public static string DIVIDER_LOCATION_PROPERTY => LocalClazz.GetField<string>("DIVIDER_LOCATION_PROPERTY");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JSplitPane.html#DIVIDER_SIZE_PROPERTY"/>
        /// </summary>
        public static string DIVIDER_SIZE_PROPERTY => LocalClazz.GetField<string>("DIVIDER_SIZE_PROPERTY");
        /// <summary>
        ...
        /// </summary>
        public static string LAST_DIVIDER_LOCATION_PROPERTY => LocalClazz.GetField<string>("LAST_DIVIDER_LOCATION_PROPERTY");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JSplitPane.html#LEFT"/>
        /// </summary>
        public static string LEFT => LocalClazz.GetField<string>("LEFT");
        /// <summary>
        ...
        /// </summary>
        public static string ONE_TOUCH_EXPANDABLE_PROPERTY => LocalClazz.GetField<string>("ONE_TOUCH_EXPANDABLE_PROPERTY");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JSplitPane.html#ORIENTATION_PROPERTY"/>
        /// </summary>
        public static string ORIENTATION_PROPERTY => LocalClazz.GetField<string>("ORIENTATION_PROPERTY");
        /// <summary>
        ...
        /// </summary>
        public static string RESIZE_WEIGHT_PROPERTY => LocalClazz.GetField<string>("RESIZE_WEIGHT_PROPERTY");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JSplitPane.html#RIGHT"/>
        /// </summary>
        public static string RIGHT => LocalClazz.GetField<string>("RIGHT");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JSplitPane.html#TOP"/>
        /// </summary>
        public static string TOP => LocalClazz.GetField<string>("TOP");
