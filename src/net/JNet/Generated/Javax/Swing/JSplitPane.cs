...
namespace Javax.Swing
{
    ...
    public partial class JSplitPane
    {
        ...
        /// </summary>
        public static string BOTTOM { get { if (!_BOTTOMReady) { _BOTTOMContent = SGetField<string>(LocalBridgeClazz, "BOTTOM"); _BOTTOMReady = true; } return _BOTTOMContent; } }
        private static string _BOTTOMContent = default;
        ...
        /// </summary>
        public static string CONTINUOUS_LAYOUT_PROPERTY { get { if (!_CONTINUOUS_LAYOUT_PROPERTYReady) { _CONTINUOUS_LAYOUT_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "CONTINUOUS_LAYOUT_PROPERTY"); _CONTINUOUS_LAYOUT_PROPERTYReady = true; } return _CONTINUOUS_LAYOUT_PROPERTYContent; } }
        private static string _CONTINUOUS_LAYOUT_PROPERTYContent = default;
        ...
        /// </summary>
        public static string DIVIDER { get { if (!_DIVIDERReady) { _DIVIDERContent = SGetField<string>(LocalBridgeClazz, "DIVIDER"); _DIVIDERReady = true; } return _DIVIDERContent; } }
        private static string _DIVIDERContent = default;
        ...
        /// </summary>
        public static string DIVIDER_LOCATION_PROPERTY { get { if (!_DIVIDER_LOCATION_PROPERTYReady) { _DIVIDER_LOCATION_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "DIVIDER_LOCATION_PROPERTY"); _DIVIDER_LOCATION_PROPERTYReady = true; } return _DIVIDER_LOCATION_PROPERTYContent; } }
        private static string _DIVIDER_LOCATION_PROPERTYContent = default;
        ...
        /// </summary>
        public static string DIVIDER_SIZE_PROPERTY { get { if (!_DIVIDER_SIZE_PROPERTYReady) { _DIVIDER_SIZE_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "DIVIDER_SIZE_PROPERTY"); _DIVIDER_SIZE_PROPERTYReady = true; } return _DIVIDER_SIZE_PROPERTYContent; } }
        private static string _DIVIDER_SIZE_PROPERTYContent = default;
        ...
        /// </summary>
        public static string LAST_DIVIDER_LOCATION_PROPERTY { get { if (!_LAST_DIVIDER_LOCATION_PROPERTYReady) { _LAST_DIVIDER_LOCATION_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "LAST_DIVIDER_LOCATION_PROPERTY"); _LAST_DIVIDER_LOCATION_PROPERTYReady = true; } return _LAST_DIVIDER_LOCATION_PROPERTYContent; } }
        private static string _LAST_DIVIDER_LOCATION_PROPERTYContent = default;
        ...
        /// </summary>
        public static string LEFT { get { if (!_LEFTReady) { _LEFTContent = SGetField<string>(LocalBridgeClazz, "LEFT"); _LEFTReady = true; } return _LEFTContent; } }
        private static string _LEFTContent = default;
        ...
        /// </summary>
        public static string ONE_TOUCH_EXPANDABLE_PROPERTY { get { if (!_ONE_TOUCH_EXPANDABLE_PROPERTYReady) { _ONE_TOUCH_EXPANDABLE_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "ONE_TOUCH_EXPANDABLE_PROPERTY"); _ONE_TOUCH_EXPANDABLE_PROPERTYReady = true; } return _ONE_TOUCH_EXPANDABLE_PROPERTYContent; } }
        private static string _ONE_TOUCH_EXPANDABLE_PROPERTYContent = default;
        ...
        /// </summary>
        public static string ORIENTATION_PROPERTY { get { if (!_ORIENTATION_PROPERTYReady) { _ORIENTATION_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "ORIENTATION_PROPERTY"); _ORIENTATION_PROPERTYReady = true; } return _ORIENTATION_PROPERTYContent; } }
        private static string _ORIENTATION_PROPERTYContent = default;
        ...
        /// </summary>
        public static string RESIZE_WEIGHT_PROPERTY { get { if (!_RESIZE_WEIGHT_PROPERTYReady) { _RESIZE_WEIGHT_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "RESIZE_WEIGHT_PROPERTY"); _RESIZE_WEIGHT_PROPERTYReady = true; } return _RESIZE_WEIGHT_PROPERTYContent; } }
        private static string _RESIZE_WEIGHT_PROPERTYContent = default;
        ...
        /// </summary>
        public static string RIGHT { get { if (!_RIGHTReady) { _RIGHTContent = SGetField<string>(LocalBridgeClazz, "RIGHT"); _RIGHTReady = true; } return _RIGHTContent; } }
        private static string _RIGHTContent = default;
        ...
        /// </summary>
        public static string TOP { get { if (!_TOPReady) { _TOPContent = SGetField<string>(LocalBridgeClazz, "TOP"); _TOPReady = true; } return _TOPContent; } }
        private static string _TOPContent = default;
