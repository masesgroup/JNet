...
namespace Javax.Swing
{
    ...
    public partial class AbstractButton
    {
        ...
        /// </summary>
        public static string BORDER_PAINTED_CHANGED_PROPERTY { get { if (!_BORDER_PAINTED_CHANGED_PROPERTYReady) { _BORDER_PAINTED_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "BORDER_PAINTED_CHANGED_PROPERTY"); _BORDER_PAINTED_CHANGED_PROPERTYReady = true; } return _BORDER_PAINTED_CHANGED_PROPERTYContent; } }
        private static string _BORDER_PAINTED_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string CONTENT_AREA_FILLED_CHANGED_PROPERTY { get { if (!_CONTENT_AREA_FILLED_CHANGED_PROPERTYReady) { _CONTENT_AREA_FILLED_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "CONTENT_AREA_FILLED_CHANGED_PROPERTY"); _CONTENT_AREA_FILLED_CHANGED_PROPERTYReady = true; } return _CONTENT_AREA_FILLED_CHANGED_PROPERTYContent; } }
        private static string _CONTENT_AREA_FILLED_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string DISABLED_ICON_CHANGED_PROPERTY { get { if (!_DISABLED_ICON_CHANGED_PROPERTYReady) { _DISABLED_ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "DISABLED_ICON_CHANGED_PROPERTY"); _DISABLED_ICON_CHANGED_PROPERTYReady = true; } return _DISABLED_ICON_CHANGED_PROPERTYContent; } }
        private static string _DISABLED_ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string DISABLED_SELECTED_ICON_CHANGED_PROPERTY { get { if (!_DISABLED_SELECTED_ICON_CHANGED_PROPERTYReady) { _DISABLED_SELECTED_ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "DISABLED_SELECTED_ICON_CHANGED_PROPERTY"); _DISABLED_SELECTED_ICON_CHANGED_PROPERTYReady = true; } return _DISABLED_SELECTED_ICON_CHANGED_PROPERTYContent; } }
        private static string _DISABLED_SELECTED_ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string FOCUS_PAINTED_CHANGED_PROPERTY { get { if (!_FOCUS_PAINTED_CHANGED_PROPERTYReady) { _FOCUS_PAINTED_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "FOCUS_PAINTED_CHANGED_PROPERTY"); _FOCUS_PAINTED_CHANGED_PROPERTYReady = true; } return _FOCUS_PAINTED_CHANGED_PROPERTYContent; } }
        private static string _FOCUS_PAINTED_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string HORIZONTAL_ALIGNMENT_CHANGED_PROPERTY { get { if (!_HORIZONTAL_ALIGNMENT_CHANGED_PROPERTYReady) { _HORIZONTAL_ALIGNMENT_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "HORIZONTAL_ALIGNMENT_CHANGED_PROPERTY"); _HORIZONTAL_ALIGNMENT_CHANGED_PROPERTYReady = true; } return _HORIZONTAL_ALIGNMENT_CHANGED_PROPERTYContent; } }
        private static string _HORIZONTAL_ALIGNMENT_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTY { get { if (!_HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTYReady) { _HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTY"); _HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTYReady = true; } return _HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTYContent; } }
        private static string _HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string ICON_CHANGED_PROPERTY { get { if (!_ICON_CHANGED_PROPERTYReady) { _ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "ICON_CHANGED_PROPERTY"); _ICON_CHANGED_PROPERTYReady = true; } return _ICON_CHANGED_PROPERTYContent; } }
        private static string _ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string MARGIN_CHANGED_PROPERTY { get { if (!_MARGIN_CHANGED_PROPERTYReady) { _MARGIN_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "MARGIN_CHANGED_PROPERTY"); _MARGIN_CHANGED_PROPERTYReady = true; } return _MARGIN_CHANGED_PROPERTYContent; } }
        private static string _MARGIN_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string MNEMONIC_CHANGED_PROPERTY { get { if (!_MNEMONIC_CHANGED_PROPERTYReady) { _MNEMONIC_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "MNEMONIC_CHANGED_PROPERTY"); _MNEMONIC_CHANGED_PROPERTYReady = true; } return _MNEMONIC_CHANGED_PROPERTYContent; } }
        private static string _MNEMONIC_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string MODEL_CHANGED_PROPERTY { get { if (!_MODEL_CHANGED_PROPERTYReady) { _MODEL_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "MODEL_CHANGED_PROPERTY"); _MODEL_CHANGED_PROPERTYReady = true; } return _MODEL_CHANGED_PROPERTYContent; } }
        private static string _MODEL_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string PRESSED_ICON_CHANGED_PROPERTY { get { if (!_PRESSED_ICON_CHANGED_PROPERTYReady) { _PRESSED_ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "PRESSED_ICON_CHANGED_PROPERTY"); _PRESSED_ICON_CHANGED_PROPERTYReady = true; } return _PRESSED_ICON_CHANGED_PROPERTYContent; } }
        private static string _PRESSED_ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string ROLLOVER_ENABLED_CHANGED_PROPERTY { get { if (!_ROLLOVER_ENABLED_CHANGED_PROPERTYReady) { _ROLLOVER_ENABLED_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "ROLLOVER_ENABLED_CHANGED_PROPERTY"); _ROLLOVER_ENABLED_CHANGED_PROPERTYReady = true; } return _ROLLOVER_ENABLED_CHANGED_PROPERTYContent; } }
        private static string _ROLLOVER_ENABLED_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string ROLLOVER_ICON_CHANGED_PROPERTY { get { if (!_ROLLOVER_ICON_CHANGED_PROPERTYReady) { _ROLLOVER_ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "ROLLOVER_ICON_CHANGED_PROPERTY"); _ROLLOVER_ICON_CHANGED_PROPERTYReady = true; } return _ROLLOVER_ICON_CHANGED_PROPERTYContent; } }
        private static string _ROLLOVER_ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string ROLLOVER_SELECTED_ICON_CHANGED_PROPERTY { get { if (!_ROLLOVER_SELECTED_ICON_CHANGED_PROPERTYReady) { _ROLLOVER_SELECTED_ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "ROLLOVER_SELECTED_ICON_CHANGED_PROPERTY"); _ROLLOVER_SELECTED_ICON_CHANGED_PROPERTYReady = true; } return _ROLLOVER_SELECTED_ICON_CHANGED_PROPERTYContent; } }
        private static string _ROLLOVER_SELECTED_ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string SELECTED_ICON_CHANGED_PROPERTY { get { if (!_SELECTED_ICON_CHANGED_PROPERTYReady) { _SELECTED_ICON_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "SELECTED_ICON_CHANGED_PROPERTY"); _SELECTED_ICON_CHANGED_PROPERTYReady = true; } return _SELECTED_ICON_CHANGED_PROPERTYContent; } }
        private static string _SELECTED_ICON_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string TEXT_CHANGED_PROPERTY { get { if (!_TEXT_CHANGED_PROPERTYReady) { _TEXT_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "TEXT_CHANGED_PROPERTY"); _TEXT_CHANGED_PROPERTYReady = true; } return _TEXT_CHANGED_PROPERTYContent; } }
        private static string _TEXT_CHANGED_PROPERTYContent = default;
        ...
        /// </summary>
        public static string VERTICAL_TEXT_POSITION_CHANGED_PROPERTY { get { if (!_VERTICAL_TEXT_POSITION_CHANGED_PROPERTYReady) { _VERTICAL_TEXT_POSITION_CHANGED_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "VERTICAL_TEXT_POSITION_CHANGED_PROPERTY"); _VERTICAL_TEXT_POSITION_CHANGED_PROPERTYReady = true; } return _VERTICAL_TEXT_POSITION_CHANGED_PROPERTYContent; } }
        private static string _VERTICAL_TEXT_POSITION_CHANGED_PROPERTYContent = default;
