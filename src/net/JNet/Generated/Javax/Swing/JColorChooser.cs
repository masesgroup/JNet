...
namespace Javax.Swing
{
    ...
    public partial class JColorChooser
    {
        ...
        /// </summary>
        public static string CHOOSER_PANELS_PROPERTY { get { if (!_CHOOSER_PANELS_PROPERTYReady) { _CHOOSER_PANELS_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "CHOOSER_PANELS_PROPERTY"); _CHOOSER_PANELS_PROPERTYReady = true; } return _CHOOSER_PANELS_PROPERTYContent; } }
        private static string _CHOOSER_PANELS_PROPERTYContent = default;
        ...
        /// </summary>
        public static string PREVIEW_PANEL_PROPERTY { get { if (!_PREVIEW_PANEL_PROPERTYReady) { _PREVIEW_PANEL_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "PREVIEW_PANEL_PROPERTY"); _PREVIEW_PANEL_PROPERTYReady = true; } return _PREVIEW_PANEL_PROPERTYContent; } }
        private static string _PREVIEW_PANEL_PROPERTYContent = default;
        ...
        /// </summary>
        public static string SELECTION_MODEL_PROPERTY { get { if (!_SELECTION_MODEL_PROPERTYReady) { _SELECTION_MODEL_PROPERTYContent = SGetField<string>(LocalBridgeClazz, "SELECTION_MODEL_PROPERTY"); _SELECTION_MODEL_PROPERTYReady = true; } return _SELECTION_MODEL_PROPERTYContent; } }
        private static string _SELECTION_MODEL_PROPERTYContent = default;
