...
namespace Javax.Swing
{
    ...
    public partial class JComponent
    {
        ...
        /// </summary>
        public static string TOOL_TIP_TEXT_KEY { get { if (!_TOOL_TIP_TEXT_KEYReady) { _TOOL_TIP_TEXT_KEYContent = SGetField<string>(LocalBridgeClazz, "TOOL_TIP_TEXT_KEY"); _TOOL_TIP_TEXT_KEYReady = true; } return _TOOL_TIP_TEXT_KEYContent; } }
        private static string _TOOL_TIP_TEXT_KEYContent = default;
