...
namespace Javax.Swing.Plaf.Nimbus
{
    ...
    public partial class NimbusStyle
    {
        ...
        /// </summary>
        public static string LARGE_KEY { get { if (!_LARGE_KEYReady) { _LARGE_KEYContent = SGetField<string>(LocalBridgeClazz, "LARGE_KEY"); _LARGE_KEYReady = true; } return _LARGE_KEYContent; } }
        private static string _LARGE_KEYContent = default;
        ...
        /// </summary>
        public static string MINI_KEY { get { if (!_MINI_KEYReady) { _MINI_KEYContent = SGetField<string>(LocalBridgeClazz, "MINI_KEY"); _MINI_KEYReady = true; } return _MINI_KEYContent; } }
        private static string _MINI_KEYContent = default;
        ...
        /// </summary>
        public static string SMALL_KEY { get { if (!_SMALL_KEYReady) { _SMALL_KEYContent = SGetField<string>(LocalBridgeClazz, "SMALL_KEY"); _SMALL_KEYReady = true; } return _SMALL_KEYContent; } }
        private static string _SMALL_KEYContent = default;
