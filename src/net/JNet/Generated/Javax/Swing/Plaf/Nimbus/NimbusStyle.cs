...
namespace Javax.Swing.Plaf.Nimbus
{
    ...
    public partial class NimbusStyle
    {
        ...
        /// </summary>
        public static double LARGE_SCALE => LocalClazz.GetField<double>("LARGE_SCALE");
        /// <summary>
        ...
        /// </summary>
        public static double MINI_SCALE => LocalClazz.GetField<double>("MINI_SCALE");
        /// <summary>
        ...
        /// </summary>
        public static double SMALL_SCALE => LocalClazz.GetField<double>("SMALL_SCALE");
        /// <summary>
        ...
        /// </summary>
        public static string LARGE_KEY => LocalClazz.GetField<string>("LARGE_KEY");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/plaf/nimbus/NimbusStyle.html#MINI_KEY"/>
        /// </summary>
        public static string MINI_KEY => LocalClazz.GetField<string>("MINI_KEY");
        /// <summary>
        ...
        /// </summary>
        public static string SMALL_KEY => LocalClazz.GetField<string>("SMALL_KEY");
