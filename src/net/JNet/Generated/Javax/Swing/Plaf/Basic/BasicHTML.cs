...
namespace Javax.Swing.Plaf.Basic
{
    ...
    public partial class BasicHTML
    {
        ...
        /// </summary>
        public static string documentBaseKey { get { if (!_documentBaseKeyReady) { _documentBaseKeyContent = SGetField<string>(LocalBridgeClazz, "documentBaseKey"); _documentBaseKeyReady = true; } return _documentBaseKeyContent; } }
        private static string _documentBaseKeyContent = default;
        ...
        /// </summary>
        public static string propertyKey { get { if (!_propertyKeyReady) { _propertyKeyContent = SGetField<string>(LocalBridgeClazz, "propertyKey"); _propertyKeyReady = true; } return _propertyKeyContent; } }
        private static string _propertyKeyContent = default;
