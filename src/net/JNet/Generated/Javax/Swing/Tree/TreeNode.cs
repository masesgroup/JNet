...
namespace Javax.Swing.Tree
{
    ...
    #region ITreeNode
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/tree/TreeNode.html"/>
    /// </summary>
    public partial interface ITreeNode
    {
        ...
        /// </summary>
        /// <typeparam name="ReturnExtendsJavax_Swing_Tree_TreeNode"><see cref=""/></typeparam>
        /// <returns><see cref=""/></returns>
        Java.Util.Enumeration Children() where ReturnExtendsJavax_Swing_Tree_TreeNode : Javax.Swing.Tree.TreeNode;
        /// <summary>
    ...
    public partial class TreeNode : Javax.Swing.Tree.ITreeNode
    {
        ...
        /// <typeparam name="ReturnExtendsJavax_Swing_Tree_TreeNode"><see cref=""/></typeparam>
        /// <returns><see cref=""/></returns>
        public Java.Util.Enumeration Children() where ReturnExtendsJavax_Swing_Tree_TreeNode : Javax.Swing.Tree.TreeNode
        {
