...
namespace Javax.Swing
{
    ...
    public partial class JTabbedPane
    {
        ...
        /// </summary>
        public static int SCROLL_TAB_LAYOUT => LocalClazz.GetField<int>("SCROLL_TAB_LAYOUT");
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/swing/JTabbedPane.html#WRAP_TAB_LAYOUT"/>
        /// </summary>
        public static int WRAP_TAB_LAYOUT => LocalClazz.GetField<int>("WRAP_TAB_LAYOUT");
