...
namespace Javax.Script
{
    ...
    public partial class ScriptEngineFactory : Javax.Script.IScriptEngineFactory
    {
        ...
        {
            return IExecuteWithSignature<Java.Lang.String>("getProgram", "([Ljava/lang/String;)Ljava/lang/String;"MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg0));
        }
