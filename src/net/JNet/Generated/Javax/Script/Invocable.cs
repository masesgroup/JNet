...
namespace Javax.Script
{
    ...
    #region IInvocable
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.scripting/javax/script/Invocable.html"/>
    /// </summary>
