...
namespace Javax.Security.Sasl
{
    ...
    public partial class RealmChoiceCallback
    {
        #region Constructors
        /// <summary>
        /// https://docs.oracle.com/en/java/javase/11/docs/api/java.security.sasl/javax/security/sasl/RealmChoiceCallback.html#<init>(java.lang.String,java.lang.String[],int,boolean)
        /// </summary>
