...
namespace Javax.Security.Auth.Spi
{
    ...
    #region ILoginModule
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/security/auth/spi/LoginModule.html"/>
    /// </summary>
