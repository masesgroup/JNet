...
namespace Javax.Print.Event
{
    ...
    public partial class PrintServiceAttributeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public PrintServiceAttributeListener(params object[] args) : base(args) { InitializeHandlers(); _hasPrintServiceAttributeListenerSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
