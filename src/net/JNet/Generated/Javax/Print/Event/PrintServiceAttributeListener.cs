...
namespace Javax.Print.Event
{
    ...
    public partial class PrintServiceAttributeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public PrintServiceAttributeListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); }
        /// <summary>
        /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
        /// </summary>
        public PrintServiceAttributeListener(params object[] args) : base(args) { InitializeHandlers(); _ListenerRuntimeType = GetType(); }
        ...
        bool _hasPrintServiceAttributeListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        /// <inheritdoc/>
    ...
    public partial class PrintServiceAttributeListener : Javax.Print.Event.IPrintServiceAttributeListener
    {
        ...
        bool _hasOverrideAttributeUpdate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(AttributeUpdate), typeof(Javax.Print.Event.PrintServiceAttributeEvent));
