...
namespace Javax.Print.Event
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/print/event/PrintServiceAttributeListener.html"/>
    /// </summary>
    public partial class PrintServiceAttributeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public PrintServiceAttributeListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasPrintServiceAttributeListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasPrintServiceAttributeListenerSecondGate;
        ...
        /// <item><see cref="_hasPrintServiceAttributeListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasPrintServiceAttributeListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="PrintServiceAttributeListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="PrintServiceAttributeListener"/> instead.</para>
    /// </remarks>
    public partial class PrintServiceAttributeListenerDirect : PrintServiceAttributeListener
    {
        ...
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public PrintServiceAttributeListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.javax.print.event.PrintServiceAttributeListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/javax/print/event/PrintServiceAttributeListener.html"/>
    /// </summary>
    public partial interface IPrintServiceAttributeListener
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/print/event/PrintServiceAttributeListener.html#attributeUpdate-javax.print.event.PrintServiceAttributeEvent-"/>
        /// </summary>
    ...
    public partial class PrintServiceAttributeListener : Javax.Print.Event.IPrintServiceAttributeListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideAttributeUpdate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(AttributeUpdate), typeof(Javax.Print.Event.PrintServiceAttributeEvent));
        ...
        /// <summary>
        /// Handler for <see href="https://docs.oracle.com/javase/8/docs/api/javax/print/event/PrintServiceAttributeListener.html#attributeUpdate-javax.print.event.PrintServiceAttributeEvent-"/>
        /// </summary>
        /// <remarks>
