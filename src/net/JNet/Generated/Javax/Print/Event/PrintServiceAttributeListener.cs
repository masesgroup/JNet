...
namespace Javax.Print.Event
{
    ...
    public partial class PrintServiceAttributeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("PrintServiceAttributeListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
