...
namespace Javax.Print.Event
{
    ...
    public partial class PrintJobListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("PrintJobListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public PrintJobListener(params object[] args) { }
