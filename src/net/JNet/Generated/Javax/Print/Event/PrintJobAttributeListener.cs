...
namespace Javax.Print.Event
{
    ...
    public partial class PrintJobAttributeListener : Javax.Print.Event.IPrintJobAttributeListener
    {
        ...
        {
            _AttributeUpdateEventHandlerIndex = AddEventHandler("attributeUpdate", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(AttributeUpdateEventHandler));
