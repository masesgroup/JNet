...
namespace Javax.Print.Event
{
    ...
    public partial class PrintJobAttributeListener : Javax.Print.Event.IPrintJobAttributeListener
    {
        ...
        {
            AttributeUpdateEventHandlerIndex = AddEventHandler("attributeUpdate", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(AttributeUpdateEventHandler));
        ...
        {
            if (eventIndex == AttributeUpdateEventHandlerIndex) return AttributeUpdateEventOverridden();
        ...
        int AttributeUpdateEventHandlerIndex = 0;
