...
namespace Javax.Print.Event
{
    ...
    public partial class PrintJobAdapter : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("PrintJobAdapter class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public PrintJobAdapter(params object[] args) { }
