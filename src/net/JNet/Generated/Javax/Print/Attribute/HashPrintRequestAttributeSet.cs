...
namespace Javax.Print.Attribute
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/print/attribute/HashPrintRequestAttributeSet.html"/>
    /// </summary>
    public partial class HashPrintRequestAttributeSet : Javax.Print.Attribute.HashAttributeSet
    {
        ...
        public HashPrintRequestAttributeSet(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
    ...
    public partial class HashPrintRequestAttributeSet
    {
        ...
        /// </summary>
        public HashPrintRequestAttributeSet() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        ...
        /// HPA initializer (Help to be completed)
        /// </summary>
        public static ALLPACKAGE_CLASSES_STUB_CLASS_PLACEHOLDER New(Javax.Print.Attribute.PrintRequestAttribute arg0)
        {
        ...
        /// HPA initializer (Help to be completed)
        /// </summary>
        public static ALLPACKAGE_CLASSES_STUB_CLASS_PLACEHOLDER New(Javax.Print.Attribute.PrintRequestAttributeSet arg0)
        {
            return JVMBridgeBase.New<ALLPACKAGE_CLASSES_STUB_CLASS_PLACEHOLDER>(arg0);
        }
