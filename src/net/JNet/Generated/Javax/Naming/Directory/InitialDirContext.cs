...
namespace Javax.Naming.Directory
{
    ...
    public partial class InitialDirContext
    {
        #region Constructors
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.naming/javax/naming/directory/InitialDirContext.html#%3Cinit%3E(java.util.Hashtable%3C?, ?%3E)"/>
        /// </summary>
