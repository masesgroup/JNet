...
namespace Javax.Naming.Ldap
{
    ...
    public partial class LdapContext : Javax.Naming.Ldap.ILdapContext
    {
        ...
        /// </summary>
        public static string CONTROL_FACTORIES { get { if (!_CONTROL_FACTORIESReady) { _CONTROL_FACTORIESContent = SGetField<string>(LocalBridgeClazz, "CONTROL_FACTORIES"); _CONTROL_FACTORIESReady = true; } return _CONTROL_FACTORIESContent; } }
        private static string _CONTROL_FACTORIESContent = default;
