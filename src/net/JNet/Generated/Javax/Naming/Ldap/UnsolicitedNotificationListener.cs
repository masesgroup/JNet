...
namespace Javax.Naming.Ldap
{
    ...
    public partial class UnsolicitedNotificationListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasUnsolicitedNotificationListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    public partial class UnsolicitedNotificationListener : Javax.Naming.Ldap.IUnsolicitedNotificationListener
    {
        ...
        {
            _NamingExceptionThrownEventHandlerIndex = AddEventHandler("namingExceptionThrown", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(NamingExceptionThrownEventHandler));
            ...
            _NotificationReceivedEventHandlerIndex = AddEventHandler("notificationReceived", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(NotificationReceivedEventHandler));
        ...
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            ...
            if (eventIndex == _NotificationReceivedEventHandlerIndex) return NotificationReceivedEventOverridden();
        ...
        void NamingExceptionThrownEventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
        ...
        int _NotificationReceivedEventHandlerIndex = 0;
        ...
        void NotificationReceivedEventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
