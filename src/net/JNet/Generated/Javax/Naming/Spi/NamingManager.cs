...
namespace Javax.Naming.Spi
{
    ...
    public partial class NamingManager
    {
        ...
        /// </summary>
        public static string CPE { get { if (!_CPEReady) { _CPEContent = SGetField<string>(LocalBridgeClazz, "CPE"); _CPEReady = true; } return _CPEContent; } }
        private static string _CPEContent = default;
