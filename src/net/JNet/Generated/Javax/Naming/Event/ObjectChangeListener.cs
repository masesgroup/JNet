...
namespace Javax.Naming.Event
{
    ...
    public partial class ObjectChangeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasObjectChangeListenerSecondGate;
        }
    ...
    public partial class ObjectChangeListener : Javax.Naming.Event.IObjectChangeListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            ObjectChangedEventHandlerIndex = AddEventHandler("objectChanged", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(ObjectChangedEventHandler));
        ...
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            ...
            if (eventIndex == ObjectChangedEventHandlerIndex) return ObjectChangedEventOverridden();
        ...
        int ObjectChangedEventHandlerIndex = 0;
