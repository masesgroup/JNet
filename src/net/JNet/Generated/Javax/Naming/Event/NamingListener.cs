...
namespace Javax.Naming.Event
{
    ...
    public partial class NamingListener : Java.Util.EventListener
    {
        ...
        public NamingListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); }
        /// <summary>
        /// Generic constructor: it is useful for JCOBridge when there is a derived class which needs to pass arguments to the highest JVMBridgeBase class
        /// </summary>
        public NamingListener(params object[] args) : base(args) { InitializeHandlers(); _ListenerRuntimeType = GetType(); }
        ...
        bool _hasNamingListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        /// <inheritdoc/>
