...
namespace Javax.Naming.Event
{
    ...
    public partial class NamingListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("NamingListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public NamingListener(params object[] args) { }
