...
namespace Javax.Naming.Event
{
    ...
    public partial class NamingListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public NamingListener(params object[] args) : base(args) { InitializeHandlers(); _hasNamingListenerSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
