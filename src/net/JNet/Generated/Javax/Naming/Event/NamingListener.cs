...
namespace Javax.Naming.Event
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/naming/event/NamingListener.html"/>
    /// </summary>
    public partial class NamingListener : Java.Util.EventListener
    {
        ...
        public NamingListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public NamingListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasNamingListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasNamingListenerSecondGate;
        ...
        /// <item><see cref="_hasNamingListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasNamingListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="NamingListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="NamingListener"/> instead.</para>
    /// </remarks>
    public partial class NamingListenerDirect : NamingListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public NamingListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public NamingListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.javax.naming.event.NamingListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/javax/naming/event/NamingListener.html"/>
    /// </summary>
