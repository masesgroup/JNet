...
namespace Javax.Naming.Event
{
    ...
    public partial class NamingListener : Java.Util.EventListener
    {
        ...
        public NamingListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasNamingListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public NamingListener(params object[] args) : base(args)
        {
            ...
            _hasNamingListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
