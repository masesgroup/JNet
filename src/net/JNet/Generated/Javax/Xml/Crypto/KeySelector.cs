...
namespace Javax.Xml.Crypto
{
    ...
    public partial class KeySelector
    {
        ...
        public partial class Purpose
        {
            ...
            /// </summary>
            public static Javax.Xml.Crypto.KeySelector.Purpose DECRYPT => LocalClazz.GetField<Javax.Xml.Crypto.KeySelector.Purpose>("DECRYPT");
            /// <summary>
            ...
            /// </summary>
            public static Javax.Xml.Crypto.KeySelector.Purpose ENCRYPT => LocalClazz.GetField<Javax.Xml.Crypto.KeySelector.Purpose>("ENCRYPT");
            /// <summary>
            /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.xml.crypto/javax/xml/crypto/KeySelector.Purpose.html#SIGN"/>
            /// </summary>
            public static Javax.Xml.Crypto.KeySelector.Purpose SIGN => LocalClazz.GetField<Javax.Xml.Crypto.KeySelector.Purpose>("SIGN");
            /// <summary>
            ...
            /// </summary>
            public static Javax.Xml.Crypto.KeySelector.Purpose VERIFY => LocalClazz.GetField<Javax.Xml.Crypto.KeySelector.Purpose>("VERIFY");
