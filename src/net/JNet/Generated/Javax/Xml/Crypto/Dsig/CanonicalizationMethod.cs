...
namespace Javax.Xml.Crypto.Dsig
{
    ...
    public partial class CanonicalizationMethod : Javax.Xml.Crypto.Dsig.ICanonicalizationMethod
    {
        ...
        /// </summary>
        public static string EXCLUSIVE { get { if (!_EXCLUSIVEReady) { _EXCLUSIVEContent = SGetField<string>(LocalBridgeClazz, "EXCLUSIVE"); _EXCLUSIVEReady = true; } return _EXCLUSIVEContent; } }
        private static string _EXCLUSIVEContent = default;
        ...
        /// </summary>
        public static string EXCLUSIVE_WITH_COMMENTS { get { if (!_EXCLUSIVE_WITH_COMMENTSReady) { _EXCLUSIVE_WITH_COMMENTSContent = SGetField<string>(LocalBridgeClazz, "EXCLUSIVE_WITH_COMMENTS"); _EXCLUSIVE_WITH_COMMENTSReady = true; } return _EXCLUSIVE_WITH_COMMENTSContent; } }
        private static string _EXCLUSIVE_WITH_COMMENTSContent = default;
        ...
        /// </summary>
        public static string INCLUSIVE { get { if (!_INCLUSIVEReady) { _INCLUSIVEContent = SGetField<string>(LocalBridgeClazz, "INCLUSIVE"); _INCLUSIVEReady = true; } return _INCLUSIVEContent; } }
        private static string _INCLUSIVEContent = default;
        ...
        /// </summary>
        public static string INCLUSIVE_WITH_COMMENTS { get { if (!_INCLUSIVE_WITH_COMMENTSReady) { _INCLUSIVE_WITH_COMMENTSContent = SGetField<string>(LocalBridgeClazz, "INCLUSIVE_WITH_COMMENTS"); _INCLUSIVE_WITH_COMMENTSReady = true; } return _INCLUSIVE_WITH_COMMENTSContent; } }
        private static string _INCLUSIVE_WITH_COMMENTSContent = default;
