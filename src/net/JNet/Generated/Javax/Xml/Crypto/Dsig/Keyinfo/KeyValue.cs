...
namespace Javax.Xml.Crypto.Dsig.Keyinfo
{
    ...
    public partial class KeyValue : Javax.Xml.Crypto.Dsig.Keyinfo.IKeyValue
    {
        ...
        /// </summary>
        public static string DSA_TYPE { get { if (!_DSA_TYPEReady) { _DSA_TYPEContent = SGetField<string>(LocalBridgeClazz, "DSA_TYPE"); _DSA_TYPEReady = true; } return _DSA_TYPEContent; } }
        private static string _DSA_TYPEContent = default;
        ...
        /// </summary>
        public static string RSA_TYPE { get { if (!_RSA_TYPEReady) { _RSA_TYPEContent = SGetField<string>(LocalBridgeClazz, "RSA_TYPE"); _RSA_TYPEReady = true; } return _RSA_TYPEContent; } }
        private static string _RSA_TYPEContent = default;
