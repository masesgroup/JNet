...
namespace Javax.Xml.Crypto.Dsig.Keyinfo
{
    #region IKeyValue
    /// <summary>
    /// .NET interface for <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.xml.crypto/javax/xml/crypto/dsig/keyinfo/KeyValue.html"/>
    /// </summary>
    ...
    public partial class KeyValue : Javax.Xml.Crypto.Dsig.Keyinfo.IKeyValue
    {
        ...
        /// </summary>
        public static string DSA_TYPE { get { return SGetField<string>(LocalBridgeClazz, "DSA_TYPE"); } }
        /// <summary>
        ...
        /// </summary>
        public static string RSA_TYPE { get { return SGetField<string>(LocalBridgeClazz, "RSA_TYPE"); } }
