...
namespace Javax.Xml.Catalog
{
    ...
    public partial class Catalog : MASES.JCOBridge.C2JBridge.JVMBridgeBase<Catalog>
    {
        ...
        public Catalog(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region ICatalog
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.xml/javax/xml/catalog/Catalog.html"/>
    /// </summary>
    public partial interface ICatalog
    {
        ...
        /// </summary>
        /// <returns><see cref=""/></returns>
        Java.Util.Stream.Stream Catalogs();
    ...
    public partial class Catalog : Javax.Xml.Catalog.ICatalog
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Stream.Stream>("catalogs", "()Ljava/util/stream/Stream;");
        }
