...
namespace Javax.Xml.Catalog
{
    ...
    public partial class CatalogManager
    {
        ...
        {
            if (arg1.Length == 0) return SExecute<Javax.Xml.Catalog.Catalog>(LocalClazz, "catalog", arg0); else return SExecute<Javax.Xml.Catalog.Catalog>(LocalClazz, "catalog", arg0, arg1);
        }
        /// <summary>
        ...
        {
            return SExecute<Javax.Xml.Catalog.CatalogResolver>(LocalClazz, "catalogResolver", arg0);
        }
        /// <summary>
