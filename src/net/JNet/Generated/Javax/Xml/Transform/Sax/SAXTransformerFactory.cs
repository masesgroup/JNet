...
namespace Javax.Xml.Transform.Sax
{
    ...
    public partial class SAXTransformerFactory
    {
        ...
        /// </summary>
        public static string FEATURE_XMLFILTER { get { if (!_FEATURE_XMLFILTERReady) { _FEATURE_XMLFILTERContent = SGetField<string>(LocalBridgeClazz, "FEATURE_XMLFILTER"); _FEATURE_XMLFILTERReady = true; } return _FEATURE_XMLFILTERContent; } }
        private static string _FEATURE_XMLFILTERContent = default;
