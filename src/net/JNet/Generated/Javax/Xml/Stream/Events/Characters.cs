...
namespace Javax.Xml.Stream.Events
{
    ...
    #region ICharacters
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.xml/javax/xml/stream/events/Characters.html"/>
    /// </summary>
