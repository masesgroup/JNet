...
namespace Javax.Xml.Namespace
{
    ...
    public partial class NamespaceContext : MASES.JCOBridge.C2JBridge.JVMBridgeBase<NamespaceContext>
    {
        ...
        public NamespaceContext(IJVMBridgeCore parent) : base(parent) { }
        /// <summary>
    ...
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.xml/javax/xml/namespace/NamespaceContext.html"/>
    /// </summary>
