...
namespace Javax.Annotation.Processing
{
    ...
    #region ICompletion
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.compiler/javax/annotation/processing/Completion.html"/>
    /// </summary>
