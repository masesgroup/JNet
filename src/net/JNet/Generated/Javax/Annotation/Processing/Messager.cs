...
namespace Javax.Annotation.Processing
{
    ...
    #region IMessager
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.compiler/javax/annotation/processing/Messager.html"/>
    /// </summary>
