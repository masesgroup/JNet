...
namespace Javax.Imageio.Spi
{
    ...
    public partial class ImageReaderSpi
    {
        ...
        public static Java.Lang.Class[] STANDARD_INPUT_TYPE { get { if (!_STANDARD_INPUT_TYPEReady) { _STANDARD_INPUT_TYPEContent = SGetFieldArray<Java.Lang.Class>(LocalBridgeClazz, "STANDARD_INPUT_TYPE"); _STANDARD_INPUT_TYPEReady = true; } return _STANDARD_INPUT_TYPEContent; } }
        private static Java.Lang.Class[] _STANDARD_INPUT_TYPEContent = default;
        private static bool _STANDARD_INPUT_TYPEReady = false; // this is used because in case of generics 
