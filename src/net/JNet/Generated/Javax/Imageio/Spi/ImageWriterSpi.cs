...
namespace Javax.Imageio.Spi
{
    ...
    public partial class ImageWriterSpi
    {
        ...
        public static Java.Lang.Class[] STANDARD_OUTPUT_TYPE { get { if (!_STANDARD_OUTPUT_TYPEReady) { _STANDARD_OUTPUT_TYPEContent = SGetFieldArray<Java.Lang.Class>(LocalBridgeClazz, "STANDARD_OUTPUT_TYPE"); _STANDARD_OUTPUT_TYPEReady = true; } return _STANDARD_OUTPUT_TYPEContent; } }
        private static Java.Lang.Class[] _STANDARD_OUTPUT_TYPEContent = default;
        private static bool _STANDARD_OUTPUT_TYPEReady = false; // this is used because in case of generics 
