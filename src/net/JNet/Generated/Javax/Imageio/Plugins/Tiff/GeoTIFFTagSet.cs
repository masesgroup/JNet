...
namespace Javax.Imageio.Plugins.Tiff
{
    ...
    public partial class GeoTIFFTagSet
    {
        ...
        /// </summary>
        public static int TAG_GEO_ASCII_PARAMS => LocalClazz.GetField<int>("TAG_GEO_ASCII_PARAMS");
        /// <summary>
        ...
        /// </summary>
        public static int TAG_GEO_DOUBLE_PARAMS => LocalClazz.GetField<int>("TAG_GEO_DOUBLE_PARAMS");
        /// <summary>
        ...
        /// </summary>
        public static int TAG_GEO_KEY_DIRECTORY => LocalClazz.GetField<int>("TAG_GEO_KEY_DIRECTORY");
        /// <summary>
        ...
        /// </summary>
        public static int TAG_MODEL_PIXEL_SCALE => LocalClazz.GetField<int>("TAG_MODEL_PIXEL_SCALE");
        /// <summary>
        ...
        /// </summary>
        public static int TAG_MODEL_TIE_POINT => LocalClazz.GetField<int>("TAG_MODEL_TIE_POINT");
        /// <summary>
        ...
        /// </summary>
        public static int TAG_MODEL_TRANSFORMATION => LocalClazz.GetField<int>("TAG_MODEL_TRANSFORMATION");
