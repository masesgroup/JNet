...
namespace Javax.Imageio.Stream
{
    ...
    public partial class ImageInputStreamImpl : Javax.Imageio.Stream.ImageInputStream
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("ImageInputStreamImpl class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
    ...
    public partial class ImageOutputStream : MASES.JCOBridge.C2JBridge.JVMBridgeBase<ImageOutputStream>
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("ImageOutputStream class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
    ...
    public partial class ImageOutputStreamImpl : Javax.Imageio.Stream.ImageInputStreamImpl
    {
        ...
        /// Default constructor: even if the corresponding Java class does not have one, it is mandatory for JCOBridge
        /// </summary>
        [Obsolete("ImageOutputStreamImpl class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
