...
namespace Javax.Imageio.Event
{
    ...
    public partial class IIOWriteProgressListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("IIOWriteProgressListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public IIOWriteProgressListener(params object[] args) { }
