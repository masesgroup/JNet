...
namespace Javax.Imageio.Event
{
    ...
    public partial class IIOWriteWarningListener : Java.Util.EventListener
    {
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIIOWriteWarningListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    public partial class IIOWriteWarningListener : Javax.Imageio.Event.IIIOWriteWarningListener
    {
        ...
        {
            _WarningOccurredEventHandlerIndex = AddEventHandler("warningOccurred", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(WarningOccurredEventHandler));
        ...
        {
            if (eventIndex == _WarningOccurredEventHandlerIndex) return WarningOccurredEventOverridden();
        ...
        int _WarningOccurredEventHandlerIndex = 0;
        ...
        void WarningOccurredEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.HasOverride = WarningOccurredEventOverridden();
        }
