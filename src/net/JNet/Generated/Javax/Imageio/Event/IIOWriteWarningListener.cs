...
namespace Javax.Imageio.Event
{
    ...
    public partial class IIOWriteWarningListener : Javax.Imageio.Event.IIIOWriteWarningListener
    {
        ...
        {
            _WarningOccurredEventHandlerIndex = AddEventHandler("warningOccurred", new global::System.EventHandler<CLRListenerEventArgs<JNetEventData>>(WarningOccurredEventHandler));
        ...
        void WarningOccurredEventHandler(object sender, CLRListenerEventArgs<JNetEventData> data)
        {
