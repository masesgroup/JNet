...
namespace Javax.Imageio.Event
{
    ...
    public partial class IIOWriteWarningListener : Java.Util.EventListener
    {
        ...
        public IIOWriteWarningListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { _ListenerRuntimeType = GetType(); _hasIIOWriteWarningListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
        /// <summary>
        ...
        public IIOWriteWarningListener(params object[] args) : base(args)
        {
            ...
            _hasIIOWriteWarningListenerSecondGate = GetMethodIsOverridden(_ListenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
    ...
    public partial class IIOWriteWarningListener : Javax.Imageio.Event.IIIOWriteWarningListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideWarningOccurred = GetMethodIsOverridden(listenerRuntimeType, nameof(WarningOccurred), typeof(Javax.Imageio.ImageWriter), typeof(int), typeof(Java.Lang.String));
        ...
        void WarningOccurredEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.EventData.TypedEventData.HasOverride = _hasOverrideWarningOccurred;
        }
