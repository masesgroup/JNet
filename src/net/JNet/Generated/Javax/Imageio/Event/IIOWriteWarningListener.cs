...
namespace Javax.Imageio.Event
{
    ...
    public partial class IIOWriteWarningListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        public IIOWriteWarningListener(params object[] args) : base(args) { InitializeHandlers(); _hasIIOWriteWarningListenerSecondGate = GetMethodIsOverridden(nameof(ListenerShallManageEvent), typeof(int), typeof(object)); }
