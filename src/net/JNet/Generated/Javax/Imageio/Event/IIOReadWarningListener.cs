...
namespace Javax.Imageio.Event
{
    ...
    /// <summary>
    /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/imageio/event/IIOReadWarningListener.html"/>
    /// </summary>
    public partial class IIOReadWarningListener : Java.Util.EventListener
    {
        ...
        public IIOReadWarningListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public IIOReadWarningListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasIIOReadWarningListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasIIOReadWarningListenerSecondGate;
        ...
        /// <item><see cref="_hasIIOReadWarningListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasIIOReadWarningListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="IIOReadWarningListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="IIOReadWarningListener"/> instead.</para>
    /// </remarks>
    public partial class IIOReadWarningListenerDirect : IIOReadWarningListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public IIOReadWarningListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public IIOReadWarningListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.jnet.generated.javax.imageio.event.IIOReadWarningListener implementing <see href="https://docs.oracle.com/javase/8/docs/api/javax/imageio/event/IIOReadWarningListener.html"/>
    /// </summary>
    public partial interface IIIOReadWarningListener
    {
        #region Instance methods
        /// <summary>
        /// <see href="https://docs.oracle.com/javase/8/docs/api/javax/imageio/event/IIOReadWarningListener.html#warningOccurred-javax.imageio.ImageReader-java.lang.String-"/>
        /// </summary>
    ...
    public partial class IIOReadWarningListener : Javax.Imageio.Event.IIIOReadWarningListener
    {
        ...
        protected virtual void InitializeHandlers(global::System.Type listenerRuntimeType)
        {
            ...
            _hasOverrideWarningOccurred = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(WarningOccurred), typeof(Javax.Imageio.ImageReader), typeof(Java.Lang.String));
        ...
        /// <summary>
        /// Handler for <see href="https://docs.oracle.com/javase/8/docs/api/javax/imageio/event/IIOReadWarningListener.html#warningOccurred-javax.imageio.ImageReader-java.lang.String-"/>
        /// </summary>
        /// <remarks>
