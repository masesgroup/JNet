...
namespace Javax.Imageio.Event
{
    ...
    public partial class IIOReadWarningListener : Java.Util.EventListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("IIOReadWarningListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public IIOReadWarningListener(params object[] args) { }
