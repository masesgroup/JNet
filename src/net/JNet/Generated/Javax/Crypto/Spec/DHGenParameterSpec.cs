...
{
    #region DHGenParameterSpec declaration
    /// <summary>
    ...
    public partial class DHGenParameterSpec : Java.Security.Spec.AlgorithmParameterSpec
    {
        ...
        public DHGenParameterSpec(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        /// <summary>
    ...
    #region DHGenParameterSpec implementation
    public partial class DHGenParameterSpec
    {
        #region Constructors
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/crypto/spec/DHGenParameterSpec.html#%3Cinit%3E(int,int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        /// <param name="arg1"><see cref="int"/></param>
        public DHGenParameterSpec(int arg0, int arg1)
            : base(arg0, arg1)
        {
        }
        ...
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/crypto/spec/DHGenParameterSpec.html#getExponentSize()"/> 
        /// </summary>
