...
namespace Javax.Crypto.Interfaces
{
    ...
    #region IDHPublicKey
    /// <summary>
    /// .NET interface for  to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/crypto/interfaces/DHPublicKey.html"/>
    /// </summary>
