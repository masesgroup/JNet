...
namespace Javax.Crypto.Interfaces
{
    ...
    #region IDHKey
    /// <summary>
    /// .NET interface skeleton to be manually developed following <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/javax/crypto/interfaces/DHKey.html"/>
    /// </summary>
