...
namespace Javax.Lang.Model
{
    ...
    public partial class AnnotatedConstruct : MASES.JCOBridge.C2JBridge.JVMBridgeBase<AnnotatedConstruct>
    {
        ...
        /// </summary>
        [Obsolete("AnnotatedConstruct class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
