...
namespace Java.Nio
{
    public partial class ShortBuffer
    {
        ...
        /// <summary>
        /// Returns a <see cref="JCOBridgeSharedBufferStream{T}"/> with a capacity defined by <paramref name="capacity"/>, to be passed to <see cref="From(JCOBridgeSharedBufferStream{short})"/>.
        /// </summary>
        /// <param name="capacity">The number of elements of <see langword="short"/> type; the measure will be computed using <see langword="sizeof"/> over <see langword="short"/>.</param>
        ...
        /// <see cref="ShortBuffer"/> created by <see cref="From(JCOBridgeSharedBufferStream{short})"/>, i.e. when the JVM Garbage Collector retires the associated <see cref="ShortBuffer"/>.
        /// </remarks>
        public static JCOBridgeSharedBufferStream<short> Rent(long capacity)
        {
