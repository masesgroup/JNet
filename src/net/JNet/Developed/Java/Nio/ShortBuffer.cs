...
namespace Java.Nio
{
    public partial class ShortBuffer
    {
        ...
        /// <returns>A new instance of <see cref="JCOBridgeDirectBuffer{T}"/> holding the memory of <paramref name="stream"/> shared with the <see cref="ShortBuffer"/>.</returns>
        /// <remarks>
        ...
        public static JCOBridgeDirectBuffer<short> From(JCOBridgeSharedBufferStream<short> stream)
        {
