...
namespace Java.Nio
{
    public partial class FloatBuffer
    {
        ...
        /// <summary>
        /// Returns a <see cref="JCOBridgeSharedBufferStream{T}"/> with a capacity defined by <paramref name="capacity"/>, to be passed to <see cref="From(JCOBridgeSharedBufferStream{float})"/>.
        /// </summary>
        /// <param name="capacity">The number of elements of <see langword="float"/> type; the measure will be computed using <see langword="sizeof"/> over <see langword="float"/>.</param>
        ...
        /// <see cref="FloatBuffer"/> created by <see cref="From(JCOBridgeSharedBufferStream{float})"/>, i.e. when the JVM Garbage Collector retires the associated <see cref="FloatBuffer"/>.
        /// </remarks>
        public static JCOBridgeSharedBufferStream<float> Rent(long capacity)
        {
