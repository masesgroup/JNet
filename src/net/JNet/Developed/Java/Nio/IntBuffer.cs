...
namespace Java.Nio
{
    public partial class IntBuffer
    {
        ...
        /// <returns>A new instance of <see cref="JCOBridgeDirectBuffer{T}"/> holding the memory of <paramref name="stream"/> shared with the <see cref="IntBuffer"/>.</returns>
        /// <remarks>
        ...
        public static JCOBridgeDirectBuffer<int> From(JCOBridgeSharedBufferStream<int> stream)
        {
