...
namespace Java.Util.Function
{
    ...
    /// <summary>
    /// Listener for Java LongSupplier <see href="https://docs.oracle.com/javase/8/docs/api/java/util/function/LongSupplier.html"/>. Extends <see cref="MASES.JCOBridge.C2JBridge.JVMBridgeListener"/>
    /// </summary>
