        ...
        static string AnalyzeMethods(this Class classDefinition, ICollection<Class> classDefinitions, IList<Method> prefilteredMethods, bool isGeneric, bool isNested, bool staticMethods)
        {
            ...
            foreach (var prop in properties.ToArray())
            {
                ...
                if (setMethod != null)
                {
                    ...
                    string setExecStub = AllPackageClasses.ClassStub.PropertyStub.SET_EXECUTION_FORMAT;
                    if (returnType.EndsWith(SpecialNames.ArrayTypeTrailer)) setExecStub = AllPackageClasses.ClassStub.PropertyStub.SET_ARRAY_EXECUTION_FORMAT;
