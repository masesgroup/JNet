...
namespace MASES.JNet.PowerShell.Cmdlet.JMX
{
    ...
    public class RemoveNotificationListenerCmdletCommand : JNetPSCmdlet<JNetPSCore>
    {
        ...
        protected override void ProcessCommand()
        {
            ...
            {
                Connector.MBeanServerConnection.RemoveNotificationListener(ObjectName, Listener);
            }
            else
            {
                Connector.MBeanServerConnection.RemoveNotificationListener(ObjectName, Listener, Filter, Handback);
            }
        }
    }
}
