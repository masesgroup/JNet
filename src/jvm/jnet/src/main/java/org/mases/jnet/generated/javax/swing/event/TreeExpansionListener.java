...
public final class TreeExpansionListener implements org.mases.jcobridge.IJCListener, javax.swing.event.TreeExpansionListener {
    ...
    int _treeCollapsedIndex = 0;
    //@Override
    public void treeCollapsed(javax.swing.event.TreeExpansionEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_treeCollapsedIndex <= 0) _treeCollapsedIndex = getEventIndex("treeCollapsed");
        raiseEvent(_treeCollapsedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _treeExpandedIndex = 0;
    //@Override
    public void treeExpanded(javax.swing.event.TreeExpansionEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_treeExpandedIndex <= 0) _treeExpandedIndex = getEventIndex("treeExpanded");
        raiseEvent(_treeExpandedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
