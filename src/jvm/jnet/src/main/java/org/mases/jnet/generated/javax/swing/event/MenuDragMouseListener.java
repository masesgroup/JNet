...
public final class MenuDragMouseListener implements org.mases.jcobridge.IJCListener, javax.swing.event.MenuDragMouseListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void menuDragMouseDragged(javax.swing.event.MenuDragMouseEvent arg0) {
        ...
        raiseEventConcurrent(_menuDragMouseDraggedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuDragMouseEntered(javax.swing.event.MenuDragMouseEvent arg0) {
        ...
        raiseEventConcurrent(_menuDragMouseEnteredIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuDragMouseExited(javax.swing.event.MenuDragMouseEvent arg0) {
        ...
        raiseEventConcurrent(_menuDragMouseExitedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuDragMouseReleased(javax.swing.event.MenuDragMouseEvent arg0) {
        ...
        raiseEventConcurrent(_menuDragMouseReleasedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
