...
public final class InputMethodListener implements org.mases.jcobridge.IJCListener, java.awt.event.InputMethodListener {
    ...
    int _caretPositionChangedIndex = 0;
    //@Override
    public void caretPositionChanged(java.awt.event.InputMethodEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_caretPositionChangedIndex <= 0) _caretPositionChangedIndex = getEventIndex("caretPositionChanged");
        raiseEvent(_caretPositionChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _inputMethodTextChangedIndex = 0;
    //@Override
    public void inputMethodTextChanged(java.awt.event.InputMethodEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_inputMethodTextChangedIndex <= 0) _inputMethodTextChangedIndex = getEventIndex("inputMethodTextChanged");
        raiseEvent(_inputMethodTextChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
