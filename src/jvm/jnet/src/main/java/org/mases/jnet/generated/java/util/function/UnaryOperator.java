...
public final class UnaryOperator implements org.mases.jcobridge.IJCListener, java.util.function.UnaryOperator {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public java.util.function.Function andThen(java.util.function.Function arg0) {
        ...
        raiseEventConcurrent(_andThenIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.UnaryOperator.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.Function)retVal;
    }
    ...
    public java.util.function.Function compose(java.util.function.Function arg0) {
        ...
        raiseEventConcurrent(_composeIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.UnaryOperator.super.compose(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.Function)retVal;
    }
