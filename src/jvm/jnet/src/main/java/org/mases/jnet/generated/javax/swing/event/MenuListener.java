...
public final class MenuListener implements org.mases.jcobridge.IJCListener, javax.swing.event.MenuListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void menuCanceled(javax.swing.event.MenuEvent arg0) {
        ...
        raiseEventConcurrent(_menuCanceledIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuDeselected(javax.swing.event.MenuEvent arg0) {
        ...
        raiseEventConcurrent(_menuDeselectedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuSelected(javax.swing.event.MenuEvent arg0) {
        ...
        raiseEventConcurrent(_menuSelectedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
