...
public final class PrintServiceAttributeListener implements org.mases.jcobridge.IJCListener, javax.print.event.PrintServiceAttributeListener {
    ...
    int _attributeUpdateIndex = 0;
    //@Override
    public void attributeUpdate(javax.print.event.PrintServiceAttributeEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_attributeUpdateIndex <= 0) _attributeUpdateIndex = getEventIndex("attributeUpdate");
        raiseEvent(_attributeUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
