...
public final class PrintServiceAttributeListener implements org.mases.jcobridge.IJCListener, javax.print.event.PrintServiceAttributeListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void attributeUpdate(javax.print.event.PrintServiceAttributeEvent arg0) {
        ...
        raiseEventConcurrent(_attributeUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
