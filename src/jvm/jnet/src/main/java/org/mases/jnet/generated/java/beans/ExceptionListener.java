...
public final class ExceptionListener implements org.mases.jcobridge.IJCListener, java.beans.ExceptionListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void exceptionThrown(java.lang.Exception arg0) {
        ...
        raiseEventConcurrent(_exceptionThrownIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
