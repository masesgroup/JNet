...
public final class ExceptionListener implements org.mases.jcobridge.IJCListener, java.beans.ExceptionListener {
    ...
    int _exceptionThrownIndex = 0;
    //@Override
    public void exceptionThrown(java.lang.Exception arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_exceptionThrownIndex <= 0) _exceptionThrownIndex = getEventIndex("exceptionThrown");
        raiseEvent(_exceptionThrownIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
