...
public final class FlavorListener implements org.mases.jcobridge.IJCListener, java.awt.datatransfer.FlavorListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void flavorsChanged(java.awt.datatransfer.FlavorEvent arg0) {
        ...
        raiseEventConcurrent(_flavorsChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
