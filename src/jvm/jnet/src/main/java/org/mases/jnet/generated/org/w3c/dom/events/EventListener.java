...
public final class EventListener implements org.mases.jcobridge.IJCListener, org.w3c.dom.events.EventListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void handleEvent(org.w3c.dom.events.Event arg0) {
        ...
        raiseEventConcurrent(_handleEventIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
