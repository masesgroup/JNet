...
public final class EventListener implements org.mases.jcobridge.IJCListener, org.w3c.dom.events.EventListener {
    ...
    int _handleEventIndex = 0;
    //@Override
    public void handleEvent(org.w3c.dom.events.Event arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_handleEventIndex <= 0) _handleEventIndex = getEventIndex("handleEvent");
        raiseEvent(_handleEventIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
