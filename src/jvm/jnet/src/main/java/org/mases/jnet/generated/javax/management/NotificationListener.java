...
public final class NotificationListener implements org.mases.jcobridge.IJCListener, javax.management.NotificationListener {
    ...
    int _handleNotificationIndex = 0;
    //@Override
    public void handleNotification(javax.management.Notification arg0, java.lang.Object arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_handleNotificationIndex <= 0) _handleNotificationIndex = getEventIndex("handleNotification");
        raiseEvent(_handleNotificationIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
