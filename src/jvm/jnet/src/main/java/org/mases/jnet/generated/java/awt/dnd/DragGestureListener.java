...
public final class DragGestureListener implements org.mases.jcobridge.IJCListener, java.awt.dnd.DragGestureListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void dragGestureRecognized(java.awt.dnd.DragGestureEvent arg0) {
        ...
        raiseEventConcurrent(_dragGestureRecognizedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
