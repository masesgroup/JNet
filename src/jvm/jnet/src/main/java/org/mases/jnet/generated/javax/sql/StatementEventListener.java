...
public final class StatementEventListener implements org.mases.jcobridge.IJCListener, javax.sql.StatementEventListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void statementClosed(javax.sql.StatementEvent arg0) {
        ...
        raiseEventConcurrent(_statementClosedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void statementErrorOccurred(javax.sql.StatementEvent arg0) {
        ...
        raiseEventConcurrent(_statementErrorOccurredIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
