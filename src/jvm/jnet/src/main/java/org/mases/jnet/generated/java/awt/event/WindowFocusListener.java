...
public final class WindowFocusListener implements org.mases.jcobridge.IJCListener, java.awt.event.WindowFocusListener {
    ...
    public void windowGainedFocus(java.awt.event.WindowEvent arg0) {
        ...
        raiseEvent(_windowGainedFocusIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void windowLostFocus(java.awt.event.WindowEvent arg0) {
        ...
        raiseEvent(_windowLostFocusIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
