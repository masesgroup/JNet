...
public final class AdjustmentListener implements org.mases.jcobridge.IJCListener, java.awt.event.AdjustmentListener {
    ...
    int _adjustmentValueChangedIndex = 0;
    //@Override
    public void adjustmentValueChanged(java.awt.event.AdjustmentEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_adjustmentValueChangedIndex <= 0) _adjustmentValueChangedIndex = getEventIndex("adjustmentValueChanged");
        raiseEvent(_adjustmentValueChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
