...
public final class AdjustmentListener implements org.mases.jcobridge.IJCListener, java.awt.event.AdjustmentListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void adjustmentValueChanged(java.awt.event.AdjustmentEvent arg0) {
        ...
        raiseEventConcurrent(_adjustmentValueChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
