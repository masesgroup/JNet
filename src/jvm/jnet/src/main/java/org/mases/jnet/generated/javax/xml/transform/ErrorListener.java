...
public final class ErrorListener implements org.mases.jcobridge.IJCListener, javax.xml.transform.ErrorListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void error(javax.xml.transform.TransformerException arg0) throws javax.xml.transform.TransformerException {
        ...
        raiseEventConcurrent(_errorIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void fatalError(javax.xml.transform.TransformerException arg0) throws javax.xml.transform.TransformerException {
        ...
        raiseEventConcurrent(_fatalErrorIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _warningIndex = 0;
    //@Override
    public void warning(javax.xml.transform.TransformerException arg0) throws javax.xml.transform.TransformerException {
        ...
        raiseEventConcurrent(_warningIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
