...
public final class AWTEventListener implements org.mases.jcobridge.IJCListener, java.awt.event.AWTEventListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void eventDispatched(java.awt.AWTEvent arg0) {
        ...
        raiseEventConcurrent(_eventDispatchedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
