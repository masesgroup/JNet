...
public final class AWTEventListener implements org.mases.jcobridge.IJCListener, java.awt.event.AWTEventListener {
    ...
    int _eventDispatchedIndex = 0;
    //@Override
    public void eventDispatched(java.awt.AWTEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_eventDispatchedIndex <= 0) _eventDispatchedIndex = getEventIndex("eventDispatched");
        raiseEvent(_eventDispatchedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
