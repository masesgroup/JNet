...
public final class MouseWheelListener implements org.mases.jcobridge.IJCListener, java.awt.event.MouseWheelListener {
    ...
    public void mouseWheelMoved(java.awt.event.MouseWheelEvent arg0) {
        ...
        raiseEvent(_mouseWheelMovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
