...
public final class BeanContextMembershipListener implements org.mases.jcobridge.IJCListener, java.beans.beancontext.BeanContextMembershipListener {
    ...
    int _childrenAddedIndex = 0;
    //@Override
    public void childrenAdded(java.beans.beancontext.BeanContextMembershipEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_childrenAddedIndex <= 0) _childrenAddedIndex = getEventIndex("childrenAdded");
        raiseEvent(_childrenAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _childrenRemovedIndex = 0;
    //@Override
    public void childrenRemoved(java.beans.beancontext.BeanContextMembershipEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_childrenRemovedIndex <= 0) _childrenRemovedIndex = getEventIndex("childrenRemoved");
        raiseEvent(_childrenRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
