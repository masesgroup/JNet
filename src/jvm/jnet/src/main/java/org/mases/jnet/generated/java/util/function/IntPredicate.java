   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public java.util.function.IntPredicate and(java.util.function.IntPredicate arg0) {
        ...
        if (!eventDataExchange.getHasOverride()) {
            retVal = java.util.function.IntPredicate.super.and(arg0);
        } else {
            retVal = eventDataExchange.getReturnData();
        }
        return (java.util.function.IntPredicate)retVal;
    }
    ...
    public java.util.function.IntPredicate negate() {
        ...
        Object retVal;
        if (!eventDataExchange.getHasOverride()) {
            retVal = java.util.function.IntPredicate.super.negate();
        } else {
            retVal = eventDataExchange.getReturnData();
        }
        return (java.util.function.IntPredicate)retVal;
    ...
    public java.util.function.IntPredicate or(java.util.function.IntPredicate arg0) {
        ...
        Object retVal;
        if (!eventDataExchange.getHasOverride()) {
            retVal = java.util.function.IntPredicate.super.or(arg0);
        } else {
            retVal = eventDataExchange.getReturnData();
        }
        return (java.util.function.IntPredicate)retVal;
