...
public final class ControllerEventListener implements org.mases.jcobridge.IJCListener, javax.sound.midi.ControllerEventListener {
    ...
    public void controlChange(javax.sound.midi.ShortMessage arg0) {
        ...
        raiseEvent(_controlChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
