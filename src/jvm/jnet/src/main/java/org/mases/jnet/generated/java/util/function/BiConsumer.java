...
public final class BiConsumer implements org.mases.jcobridge.IJCListener, java.util.function.BiConsumer {
    ...
    public void accept(java.lang.Object arg0, java.lang.Object arg1) {
        ...
        raiseEvent(_acceptIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _andThenIndex = 0;
    //@Override
    public java.util.function.BiConsumer andThen(java.util.function.BiConsumer arg0) {
        ...
        raiseEvent(_andThenIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.BiConsumer.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.BiConsumer)retVal;
    }
