...
public final class BiConsumer implements org.mases.jcobridge.IJCListener, java.util.function.BiConsumer {
    ...
    public void accept(java.lang.Object arg0, java.lang.Object arg1) {
        ...
        raiseEvent(0, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    //@Override
    public java.util.function.BiConsumer andThen(java.util.function.BiConsumer arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(1, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.BiConsumer.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.BiConsumer)retVal;
    }
    //@Override
