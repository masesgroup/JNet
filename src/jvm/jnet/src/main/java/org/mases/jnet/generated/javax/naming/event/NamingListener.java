...
public final class NamingListener implements org.mases.jcobridge.IJCListener, javax.naming.event.NamingListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void namingExceptionThrown(javax.naming.event.NamingExceptionEvent arg0) {
        ...
        raiseEventConcurrent(_namingExceptionThrownIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
