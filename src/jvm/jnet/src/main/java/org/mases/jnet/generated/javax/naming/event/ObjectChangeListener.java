...
public final class ObjectChangeListener implements org.mases.jcobridge.IJCListener, javax.naming.event.ObjectChangeListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void objectChanged(javax.naming.event.NamingEvent arg0) {
        ...
        raiseEventConcurrent(_objectChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
