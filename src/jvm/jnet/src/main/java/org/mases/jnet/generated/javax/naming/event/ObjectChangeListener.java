...
public final class ObjectChangeListener implements org.mases.jcobridge.IJCListener, javax.naming.event.ObjectChangeListener {
    ...
    int _objectChangedIndex = 0;
    //@Override
    public void objectChanged(javax.naming.event.NamingEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_objectChangedIndex <= 0) _objectChangedIndex = getEventIndex("objectChanged");
        raiseEvent(_objectChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
