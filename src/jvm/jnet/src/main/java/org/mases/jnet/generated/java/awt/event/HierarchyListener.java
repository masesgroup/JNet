...
public final class HierarchyListener implements org.mases.jcobridge.IJCListener, java.awt.event.HierarchyListener {
    ...
    int _hierarchyChangedIndex = 0;
    //@Override
    public void hierarchyChanged(java.awt.event.HierarchyEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_hierarchyChangedIndex <= 0) _hierarchyChangedIndex = getEventIndex("hierarchyChanged");
        raiseEvent(_hierarchyChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
