...
public final class HierarchyListener implements org.mases.jcobridge.IJCListener, java.awt.event.HierarchyListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void hierarchyChanged(java.awt.event.HierarchyEvent arg0) {
        ...
        raiseEventConcurrent(_hierarchyChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
