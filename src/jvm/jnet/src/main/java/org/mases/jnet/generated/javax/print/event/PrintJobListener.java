...
public final class PrintJobListener implements org.mases.jcobridge.IJCListener, javax.print.event.PrintJobListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void printDataTransferCompleted(javax.print.event.PrintJobEvent arg0) {
        ...
        raiseEventConcurrent(_printDataTransferCompletedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void printJobCanceled(javax.print.event.PrintJobEvent arg0) {
        ...
        raiseEventConcurrent(_printJobCanceledIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void printJobCompleted(javax.print.event.PrintJobEvent arg0) {
        ...
        raiseEventConcurrent(_printJobCompletedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void printJobFailed(javax.print.event.PrintJobEvent arg0) {
        ...
        raiseEventConcurrent(_printJobFailedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void printJobNoMoreEvents(javax.print.event.PrintJobEvent arg0) {
        ...
        raiseEventConcurrent(_printJobNoMoreEventsIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void printJobRequiresAttention(javax.print.event.PrintJobEvent arg0) {
        ...
        raiseEventConcurrent(_printJobRequiresAttentionIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
