...
public final class CaretListener implements org.mases.jcobridge.IJCListener, javax.swing.event.CaretListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void caretUpdate(javax.swing.event.CaretEvent arg0) {
        ...
        raiseEventConcurrent(_caretUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
