...
public final class CaretListener implements org.mases.jcobridge.IJCListener, javax.swing.event.CaretListener {
    ...
    int _caretUpdateIndex = 0;
    //@Override
    public void caretUpdate(javax.swing.event.CaretEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_caretUpdateIndex <= 0) _caretUpdateIndex = getEventIndex("caretUpdate");
        raiseEvent(_caretUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
