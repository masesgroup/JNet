...
public final class ContainerListener implements org.mases.jcobridge.IJCListener, java.awt.event.ContainerListener {
    ...
    public void componentAdded(java.awt.event.ContainerEvent arg0) {
        ...
        raiseEvent(_componentAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void componentRemoved(java.awt.event.ContainerEvent arg0) {
        ...
        raiseEvent(_componentRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
