...
public final class VetoableChangeListener implements org.mases.jcobridge.IJCListener, java.beans.VetoableChangeListener {
    ...
    public void vetoableChange(java.beans.PropertyChangeEvent arg0) throws java.beans.PropertyVetoException {
        ...
        if (_vetoableChangeIndex <= 0) _vetoableChangeIndex = getEventIndex("vetoableChange");
        raiseEvent(_vetoableChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
