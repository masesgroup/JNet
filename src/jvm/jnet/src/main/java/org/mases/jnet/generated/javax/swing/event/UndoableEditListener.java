...
public final class UndoableEditListener implements org.mases.jcobridge.IJCListener, javax.swing.event.UndoableEditListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void undoableEditHappened(javax.swing.event.UndoableEditEvent arg0) {
        ...
        raiseEventConcurrent(_undoableEditHappenedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
