...
public final class UndoableEditListener implements org.mases.jcobridge.IJCListener, javax.swing.event.UndoableEditListener {
    ...
    int _undoableEditHappenedIndex = 0;
    //@Override
    public void undoableEditHappened(javax.swing.event.UndoableEditEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_undoableEditHappenedIndex <= 0) _undoableEditHappenedIndex = getEventIndex("undoableEditHappened");
        raiseEvent(_undoableEditHappenedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
