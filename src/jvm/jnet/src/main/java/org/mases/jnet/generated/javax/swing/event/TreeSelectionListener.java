...
public final class TreeSelectionListener implements org.mases.jcobridge.IJCListener, javax.swing.event.TreeSelectionListener {
    ...
    int _valueChangedIndex = 0;
    //@Override
    public void valueChanged(javax.swing.event.TreeSelectionEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_valueChangedIndex <= 0) _valueChangedIndex = getEventIndex("valueChanged");
        raiseEvent(_valueChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
