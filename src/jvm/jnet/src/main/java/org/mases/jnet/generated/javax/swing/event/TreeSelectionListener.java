...
public final class TreeSelectionListener implements org.mases.jcobridge.IJCListener, javax.swing.event.TreeSelectionListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void valueChanged(javax.swing.event.TreeSelectionEvent arg0) {
        ...
        raiseEventConcurrent(_valueChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
