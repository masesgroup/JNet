...
public final class MetaEventListener implements org.mases.jcobridge.IJCListener, javax.sound.midi.MetaEventListener {
    ...
    public void meta(javax.sound.midi.MetaMessage arg0) {
        ...
        if (_metaIndex <= 0) _metaIndex = getEventIndex("meta");
        raiseEvent(_metaIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
