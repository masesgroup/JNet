...
public final class FocusListener implements org.mases.jcobridge.IJCListener, java.awt.event.FocusListener {
    ...
    public void focusGained(java.awt.event.FocusEvent arg0) {
        ...
        raiseEvent(_focusGainedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void focusLost(java.awt.event.FocusEvent arg0) {
        ...
        raiseEvent(_focusLostIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
