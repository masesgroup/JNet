...
public final class DoubleUnaryOperator implements org.mases.jcobridge.IJCListener, java.util.function.DoubleUnaryOperator {
    ...
    public double applyAsDouble(double arg0) {
        ...
        raiseEvent(0, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (double)retVal;
    }
    //@Override
    public java.util.function.DoubleUnaryOperator andThen(java.util.function.DoubleUnaryOperator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(1, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.DoubleUnaryOperator.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.DoubleUnaryOperator)retVal;
    }
    //@Override
    ...
    public java.util.function.DoubleUnaryOperator compose(java.util.function.DoubleUnaryOperator arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(2, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.DoubleUnaryOperator.super.compose(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.DoubleUnaryOperator)retVal;
    }
    //@Override
