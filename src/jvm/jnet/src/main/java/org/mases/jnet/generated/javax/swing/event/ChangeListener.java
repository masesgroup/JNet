...
public final class ChangeListener implements org.mases.jcobridge.IJCListener, javax.swing.event.ChangeListener {
    ...
    int _stateChangedIndex = 0;
    //@Override
    public void stateChanged(javax.swing.event.ChangeEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_stateChangedIndex <= 0) _stateChangedIndex = getEventIndex("stateChanged");
        raiseEvent(_stateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
