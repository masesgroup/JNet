...
public final class LineListener implements org.mases.jcobridge.IJCListener, javax.sound.sampled.LineListener {
    ...
    public void update(javax.sound.sampled.LineEvent arg0) {
        ...
        if (_updateIndex <= 0) _updateIndex = getEventIndex("update");
        raiseEvent(_updateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
