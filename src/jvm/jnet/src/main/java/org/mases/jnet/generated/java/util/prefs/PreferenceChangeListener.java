...
public final class PreferenceChangeListener implements org.mases.jcobridge.IJCListener, java.util.prefs.PreferenceChangeListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void preferenceChange(java.util.prefs.PreferenceChangeEvent arg0) {
        ...
        raiseEventConcurrent(_preferenceChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
