...
public final class DragSourceListener implements org.mases.jcobridge.IJCListener, java.awt.dnd.DragSourceListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void dragDropEnd(java.awt.dnd.DragSourceDropEvent arg0) {
        ...
        raiseEventConcurrent(_dragDropEndIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void dragEnter(java.awt.dnd.DragSourceDragEvent arg0) {
        ...
        raiseEventConcurrent(_dragEnterIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void dragExit(java.awt.dnd.DragSourceEvent arg0) {
        ...
        raiseEventConcurrent(_dragExitIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void dragOver(java.awt.dnd.DragSourceDragEvent arg0) {
        ...
        raiseEventConcurrent(_dragOverIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void dropActionChanged(java.awt.dnd.DragSourceDragEvent arg0) {
        ...
        raiseEventConcurrent(_dropActionChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
