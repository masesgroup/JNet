...
public final class TableModelListener implements org.mases.jcobridge.IJCListener, javax.swing.event.TableModelListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void tableChanged(javax.swing.event.TableModelEvent arg0) {
        ...
        raiseEventConcurrent(_tableChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
