...
public final class HandshakeCompletedListener implements org.mases.jcobridge.IJCListener, javax.net.ssl.HandshakeCompletedListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void handshakeCompleted(javax.net.ssl.HandshakeCompletedEvent arg0) {
        ...
        raiseEventConcurrent(_handshakeCompletedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
