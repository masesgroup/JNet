...
public final class RowSorterListener implements org.mases.jcobridge.IJCListener, javax.swing.event.RowSorterListener {
    ...
    int _sorterChangedIndex = 0;
    //@Override
    public void sorterChanged(javax.swing.event.RowSorterEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_sorterChangedIndex <= 0) _sorterChangedIndex = getEventIndex("sorterChanged");
        raiseEvent(_sorterChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
