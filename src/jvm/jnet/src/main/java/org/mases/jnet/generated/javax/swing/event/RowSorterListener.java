...
public final class RowSorterListener implements org.mases.jcobridge.IJCListener, javax.swing.event.RowSorterListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void sorterChanged(javax.swing.event.RowSorterEvent arg0) {
        ...
        raiseEventConcurrent(_sorterChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
