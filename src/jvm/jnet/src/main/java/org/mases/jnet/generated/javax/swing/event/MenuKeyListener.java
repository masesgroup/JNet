...
public final class MenuKeyListener implements org.mases.jcobridge.IJCListener, javax.swing.event.MenuKeyListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void menuKeyPressed(javax.swing.event.MenuKeyEvent arg0) {
        ...
        raiseEventConcurrent(_menuKeyPressedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuKeyReleased(javax.swing.event.MenuKeyEvent arg0) {
        ...
        raiseEventConcurrent(_menuKeyReleasedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void menuKeyTyped(javax.swing.event.MenuKeyEvent arg0) {
        ...
        raiseEventConcurrent(_menuKeyTypedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
