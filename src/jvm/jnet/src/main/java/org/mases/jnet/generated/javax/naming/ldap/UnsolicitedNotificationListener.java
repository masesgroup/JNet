...
public final class UnsolicitedNotificationListener implements org.mases.jcobridge.IJCListener, javax.naming.ldap.UnsolicitedNotificationListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void notificationReceived(javax.naming.ldap.UnsolicitedNotificationEvent arg0) {
        ...
        raiseEventConcurrent(_notificationReceivedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
