...
public final class UnsolicitedNotificationListener implements org.mases.jcobridge.IJCListener, javax.naming.ldap.UnsolicitedNotificationListener {
    ...
    int _notificationReceivedIndex = 0;
    //@Override
    public void notificationReceived(javax.naming.ldap.UnsolicitedNotificationEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_notificationReceivedIndex <= 0) _notificationReceivedIndex = getEventIndex("notificationReceived");
        raiseEvent(_notificationReceivedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
