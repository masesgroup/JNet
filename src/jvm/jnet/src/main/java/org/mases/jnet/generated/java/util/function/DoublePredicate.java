...
public final class DoublePredicate implements org.mases.jcobridge.IJCListener, java.util.function.DoublePredicate {
    ...
    public java.util.function.DoublePredicate and(java.util.function.DoublePredicate arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(1, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.DoublePredicate.super.and(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.DoublePredicate)retVal;
    }
    //@Override
    ...
    public java.util.function.DoublePredicate negate() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(2, eventDataExchange); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.DoublePredicate.super.negate(); else retVal = eventDataExchange.getReturnData(); return (java.util.function.DoublePredicate)retVal;
    }
    //@Override
    ...
    public java.util.function.DoublePredicate or(java.util.function.DoublePredicate arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(3, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.DoublePredicate.super.or(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.DoublePredicate)retVal;
    }
    //@Override
