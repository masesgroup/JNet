...
public final class TreeModelListener implements org.mases.jcobridge.IJCListener, javax.swing.event.TreeModelListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void treeNodesChanged(javax.swing.event.TreeModelEvent arg0) {
        ...
        raiseEventConcurrent(_treeNodesChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void treeNodesInserted(javax.swing.event.TreeModelEvent arg0) {
        ...
        raiseEventConcurrent(_treeNodesInsertedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void treeNodesRemoved(javax.swing.event.TreeModelEvent arg0) {
        ...
        raiseEventConcurrent(_treeNodesRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void treeStructureChanged(javax.swing.event.TreeModelEvent arg0) {
        ...
        raiseEventConcurrent(_treeStructureChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
