...
public final class SSLSessionBindingListener implements org.mases.jcobridge.IJCListener, javax.net.ssl.SSLSessionBindingListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void valueBound(javax.net.ssl.SSLSessionBindingEvent arg0) {
        ...
        raiseEventConcurrent(_valueBoundIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void valueUnbound(javax.net.ssl.SSLSessionBindingEvent arg0) {
        ...
        raiseEventConcurrent(_valueUnboundIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
