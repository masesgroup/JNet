...
public final class CellEditorListener implements org.mases.jcobridge.IJCListener, javax.swing.event.CellEditorListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void editingCanceled(javax.swing.event.ChangeEvent arg0) {
        ...
        raiseEventConcurrent(_editingCanceledIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void editingStopped(javax.swing.event.ChangeEvent arg0) {
        ...
        raiseEventConcurrent(_editingStoppedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
