...
public final class DropTargetAdapter extends java.awt.dnd.DropTargetAdapter implements org.mases.jcobridge.IJCListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void drop(java.awt.dnd.DropTargetDropEvent arg0) {
        ...
        raiseEventConcurrent(_dropIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
