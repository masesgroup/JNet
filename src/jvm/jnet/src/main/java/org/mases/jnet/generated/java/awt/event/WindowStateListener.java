...
public final class WindowStateListener implements org.mases.jcobridge.IJCListener, java.awt.event.WindowStateListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void windowStateChanged(java.awt.event.WindowEvent arg0) {
        ...
        raiseEventConcurrent(_windowStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
