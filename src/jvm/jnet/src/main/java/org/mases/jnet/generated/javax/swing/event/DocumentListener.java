...
public final class DocumentListener implements org.mases.jcobridge.IJCListener, javax.swing.event.DocumentListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void changedUpdate(javax.swing.event.DocumentEvent arg0) {
        ...
        raiseEventConcurrent(_changedUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void insertUpdate(javax.swing.event.DocumentEvent arg0) {
        ...
        raiseEventConcurrent(_insertUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void removeUpdate(javax.swing.event.DocumentEvent arg0) {
        ...
        raiseEventConcurrent(_removeUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
