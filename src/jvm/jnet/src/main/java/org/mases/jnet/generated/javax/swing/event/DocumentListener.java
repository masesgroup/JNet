...
public final class DocumentListener implements org.mases.jcobridge.IJCListener, javax.swing.event.DocumentListener {
    ...
    int _changedUpdateIndex = 0;
    //@Override
    public void changedUpdate(javax.swing.event.DocumentEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_changedUpdateIndex <= 0) _changedUpdateIndex = getEventIndex("changedUpdate");
        raiseEvent(_changedUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _insertUpdateIndex = 0;
    //@Override
    public void insertUpdate(javax.swing.event.DocumentEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_insertUpdateIndex <= 0) _insertUpdateIndex = getEventIndex("insertUpdate");
        raiseEvent(_insertUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _removeUpdateIndex = 0;
    //@Override
    public void removeUpdate(javax.swing.event.DocumentEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_removeUpdateIndex <= 0) _removeUpdateIndex = getEventIndex("removeUpdate");
        raiseEvent(_removeUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
