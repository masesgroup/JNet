...
public final class BeanContextServicesListener implements org.mases.jcobridge.IJCListener, java.beans.beancontext.BeanContextServicesListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void serviceAvailable(java.beans.beancontext.BeanContextServiceAvailableEvent arg0) {
        ...
        raiseEventConcurrent(_serviceAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
