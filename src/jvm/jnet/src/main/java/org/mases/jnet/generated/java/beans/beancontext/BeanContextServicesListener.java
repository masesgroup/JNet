...
public final class BeanContextServicesListener implements org.mases.jcobridge.IJCListener, java.beans.beancontext.BeanContextServicesListener {
    ...
    int _serviceAvailableIndex = 0;
    //@Override
    public void serviceAvailable(java.beans.beancontext.BeanContextServiceAvailableEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_serviceAvailableIndex <= 0) _serviceAvailableIndex = getEventIndex("serviceAvailable");
        raiseEvent(_serviceAvailableIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
