...
public final class ConnectionEventListener implements org.mases.jcobridge.IJCListener, javax.sql.ConnectionEventListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void connectionClosed(javax.sql.ConnectionEvent arg0) {
        ...
        raiseEventConcurrent(_connectionClosedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void connectionErrorOccurred(javax.sql.ConnectionEvent arg0) {
        ...
        raiseEventConcurrent(_connectionErrorOccurredIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
