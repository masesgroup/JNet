...
public final class AncestorListener implements org.mases.jcobridge.IJCListener, javax.swing.event.AncestorListener {
    ...
    int _ancestorAddedIndex = 0;
    //@Override
    public void ancestorAdded(javax.swing.event.AncestorEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_ancestorAddedIndex <= 0) _ancestorAddedIndex = getEventIndex("ancestorAdded");
        raiseEvent(_ancestorAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void ancestorMoved(javax.swing.event.AncestorEvent arg0) {
        ...
        raiseEvent(_ancestorMovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _ancestorRemovedIndex = 0;
    //@Override
    public void ancestorRemoved(javax.swing.event.AncestorEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_ancestorRemovedIndex <= 0) _ancestorRemovedIndex = getEventIndex("ancestorRemoved");
        raiseEvent(_ancestorRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
