...
public final class LongPredicate implements org.mases.jcobridge.IJCListener, java.util.function.LongPredicate {
    ...
    public java.util.function.LongPredicate and(java.util.function.LongPredicate arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(1, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.LongPredicate.super.and(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.LongPredicate)retVal;
    }
    //@Override
    ...
    public java.util.function.LongPredicate negate() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(2, eventDataExchange); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.LongPredicate.super.negate(); else retVal = eventDataExchange.getReturnData(); return (java.util.function.LongPredicate)retVal;
    }
    //@Override
    ...
    public java.util.function.LongPredicate or(java.util.function.LongPredicate arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(3, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.LongPredicate.super.or(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.LongPredicate)retVal;
    }
    //@Override
