...
public final class HyperlinkListener implements org.mases.jcobridge.IJCListener, javax.swing.event.HyperlinkListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void hyperlinkUpdate(javax.swing.event.HyperlinkEvent arg0) {
        ...
        raiseEventConcurrent(_hyperlinkUpdateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
