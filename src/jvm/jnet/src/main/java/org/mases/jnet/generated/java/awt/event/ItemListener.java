...
public final class ItemListener implements org.mases.jcobridge.IJCListener, java.awt.event.ItemListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void itemStateChanged(java.awt.event.ItemEvent arg0) {
        ...
        raiseEventConcurrent(_itemStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
