...
public final class ItemListener implements org.mases.jcobridge.IJCListener, java.awt.event.ItemListener {
    ...
    int _itemStateChangedIndex = 0;
    //@Override
    public void itemStateChanged(java.awt.event.ItemEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_itemStateChangedIndex <= 0) _itemStateChangedIndex = getEventIndex("itemStateChanged");
        raiseEvent(_itemStateChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
