...
public final class HierarchyBoundsListener implements org.mases.jcobridge.IJCListener, java.awt.event.HierarchyBoundsListener {
    ...
    public void ancestorResized(java.awt.event.HierarchyEvent arg0) {
        ...
        raiseEvent(_ancestorResizedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
