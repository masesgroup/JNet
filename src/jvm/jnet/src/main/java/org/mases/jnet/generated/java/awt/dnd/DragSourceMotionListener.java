...
public final class DragSourceMotionListener implements org.mases.jcobridge.IJCListener, java.awt.dnd.DragSourceMotionListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void dragMouseMoved(java.awt.dnd.DragSourceDragEvent arg0) {
        ...
        raiseEventConcurrent(_dragMouseMovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
