...
public final class Runnable implements org.mases.jcobridge.IJCListener, java.lang.Runnable {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void run() {
        ...
        raiseEventConcurrent(_runIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
