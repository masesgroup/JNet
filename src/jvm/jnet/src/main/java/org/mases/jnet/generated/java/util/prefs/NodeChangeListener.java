...
public final class NodeChangeListener implements org.mases.jcobridge.IJCListener, java.util.prefs.NodeChangeListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void childAdded(java.util.prefs.NodeChangeEvent arg0) {
        ...
        raiseEventConcurrent(_childAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void childRemoved(java.util.prefs.NodeChangeEvent arg0) {
        ...
        raiseEventConcurrent(_childRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
