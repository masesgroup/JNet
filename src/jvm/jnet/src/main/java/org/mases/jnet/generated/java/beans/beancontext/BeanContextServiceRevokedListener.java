...
public final class BeanContextServiceRevokedListener implements org.mases.jcobridge.IJCListener, java.beans.beancontext.BeanContextServiceRevokedListener {
    ...
    int _serviceRevokedIndex = 0;
    //@Override
    public void serviceRevoked(java.beans.beancontext.BeanContextServiceRevokedEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_serviceRevokedIndex <= 0) _serviceRevokedIndex = getEventIndex("serviceRevoked");
        raiseEvent(_serviceRevokedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
