...
public final class LongConsumer implements org.mases.jcobridge.IJCListener, java.util.function.LongConsumer {
    ...
    public java.util.function.LongConsumer andThen(java.util.function.LongConsumer arg0) {
        ...
        raiseEvent(_andThenIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.LongConsumer.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.LongConsumer)retVal;
    }
