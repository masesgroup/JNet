...
public final class ObjLongConsumer implements org.mases.jcobridge.IJCListener, java.util.function.ObjLongConsumer {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void accept(java.lang.Object arg0, long arg1) {
        ...
        raiseEventConcurrent(_acceptIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
