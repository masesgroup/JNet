...
public final class TextListener implements org.mases.jcobridge.IJCListener, java.awt.event.TextListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void textValueChanged(java.awt.event.TextEvent arg0) {
        ...
        raiseEventConcurrent(_textValueChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
