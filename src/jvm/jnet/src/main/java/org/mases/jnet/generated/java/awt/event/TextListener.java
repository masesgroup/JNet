...
public final class TextListener implements org.mases.jcobridge.IJCListener, java.awt.event.TextListener {
    ...
    int _textValueChangedIndex = 0;
    //@Override
    public void textValueChanged(java.awt.event.TextEvent arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_textValueChangedIndex <= 0) _textValueChangedIndex = getEventIndex("textValueChanged");
        raiseEvent(_textValueChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
