...
public final class NamespaceChangeListener implements org.mases.jcobridge.IJCListener, javax.naming.event.NamespaceChangeListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void objectAdded(javax.naming.event.NamingEvent arg0) {
        ...
        raiseEventConcurrent(_objectAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void objectRemoved(javax.naming.event.NamingEvent arg0) {
        ...
        raiseEventConcurrent(_objectRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void objectRenamed(javax.naming.event.NamingEvent arg0) {
        ...
        raiseEventConcurrent(_objectRenamedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
