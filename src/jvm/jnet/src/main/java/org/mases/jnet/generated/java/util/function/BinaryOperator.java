...
public final class BinaryOperator implements org.mases.jcobridge.IJCListener, java.util.function.BinaryOperator {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public java.lang.Object apply(java.lang.Object arg0, java.lang.Object arg1) {
        ...
        raiseEventConcurrent(_applyIndex, eventDataExchange, arg0, arg1);
    ...
    public java.util.function.BiFunction andThen(java.util.function.Function arg0) {
        ...
        if (!eventDataExchange.getHasOverride()) {
            retVal = java.util.function.BinaryOperator.super.andThen(arg0);
        } else {
            retVal = eventDataExchange.getReturnData();
        }
        return (java.util.function.BiFunction)retVal;
    }
