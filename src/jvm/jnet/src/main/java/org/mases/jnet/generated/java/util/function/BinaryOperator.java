...
public final class BinaryOperator implements org.mases.jcobridge.IJCListener, java.util.function.BinaryOperator {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public java.util.function.BiFunction andThen(java.util.function.Function arg0) {
        ...
        raiseEventConcurrent(_andThenIndex, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.BinaryOperator.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.BiFunction)retVal;
    }
