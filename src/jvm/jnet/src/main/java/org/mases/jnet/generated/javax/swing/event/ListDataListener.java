...
public final class ListDataListener implements org.mases.jcobridge.IJCListener, javax.swing.event.ListDataListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void contentsChanged(javax.swing.event.ListDataEvent arg0) {
        ...
        raiseEventConcurrent(_contentsChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void intervalAdded(javax.swing.event.ListDataEvent arg0) {
        ...
        raiseEventConcurrent(_intervalAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void intervalRemoved(javax.swing.event.ListDataEvent arg0) {
        ...
        raiseEventConcurrent(_intervalRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
