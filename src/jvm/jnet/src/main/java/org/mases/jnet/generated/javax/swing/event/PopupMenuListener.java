...
public final class PopupMenuListener implements org.mases.jcobridge.IJCListener, javax.swing.event.PopupMenuListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void popupMenuCanceled(javax.swing.event.PopupMenuEvent arg0) {
        ...
        raiseEventConcurrent(_popupMenuCanceledIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent arg0) {
        ...
        raiseEventConcurrent(_popupMenuWillBecomeInvisibleIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent arg0) {
        ...
        raiseEventConcurrent(_popupMenuWillBecomeVisibleIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
