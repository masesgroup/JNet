...
public final class RowSetListener implements org.mases.jcobridge.IJCListener, javax.sql.RowSetListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void cursorMoved(javax.sql.RowSetEvent arg0) {
        ...
        raiseEventConcurrent(_cursorMovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void rowChanged(javax.sql.RowSetEvent arg0) {
        ...
        raiseEventConcurrent(_rowChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void rowSetChanged(javax.sql.RowSetEvent arg0) {
        ...
        raiseEventConcurrent(_rowSetChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
