...
public final class TableColumnModelListener implements org.mases.jcobridge.IJCListener, javax.swing.event.TableColumnModelListener {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void columnAdded(javax.swing.event.TableColumnModelEvent arg0) {
        ...
        raiseEventConcurrent(_columnAddedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void columnMarginChanged(javax.swing.event.ChangeEvent arg0) {
        ...
        raiseEventConcurrent(_columnMarginChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void columnMoved(javax.swing.event.TableColumnModelEvent arg0) {
        ...
        raiseEventConcurrent(_columnMovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void columnRemoved(javax.swing.event.TableColumnModelEvent arg0) {
        ...
        raiseEventConcurrent(_columnRemovedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    ...
    public void columnSelectionChanged(javax.swing.event.ListSelectionEvent arg0) {
        ...
        raiseEventConcurrent(_columnSelectionChangedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
