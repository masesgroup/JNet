...
public final class DoubleConsumer implements org.mases.jcobridge.IJCListener, java.util.function.DoubleConsumer {
    ...
    public java.util.function.DoubleConsumer andThen(java.util.function.DoubleConsumer arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        raiseEvent(1, eventDataExchange, arg0); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = java.util.function.DoubleConsumer.super.andThen(arg0); else retVal = eventDataExchange.getReturnData(); return (java.util.function.DoubleConsumer)retVal;
    }
    //@Override
