...
public final class DoubleConsumer implements org.mases.jcobridge.IJCListener, java.util.function.DoubleConsumer {
   ...
   public void setReturnData(long callId, Object retData) {
    ...
    public void accept(double arg0) {
        ...
        raiseEventConcurrent(_acceptIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _andThenIndex = 0;
    //@Override
