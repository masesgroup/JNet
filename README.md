...
The repository code and releases may contains bugs, the release cycle depends from critical discovered issues and/or enhancement requested from this or other projects.
